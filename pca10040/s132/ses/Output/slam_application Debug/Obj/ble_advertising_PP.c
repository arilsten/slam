...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 2

# 1 "../../../../../../components/ble/common/ble_advdata.h" 1
# 55 "../../../../../../components/ble/common/ble_advdata.h"
...
# 43 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 2
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.h" 1
# 62 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.h"
# 1 "../../../../../../components/softdevice/s132/headers/ble_gattc.h" 1
# 63 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.h" 2
# 85 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.h"
typedef enum
{
    BLE_ADV_MODE_IDLE,
...
# 121 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.h" 3 4
   _Bool 
# 121 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.h"
...
# 58 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
static 
# 58 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
      _Bool 
# 58 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
           whitelist_has_entries(ble_advertising_t * const p_advertising)
{
...
# 68 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
      _Bool 
# 68 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
           addr_is_valid(uint8_t const * const p_addr)
{
...
# 113 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
    ...
    if (p_ble_evt->evt.gap_evt.conn_handle == p_advertising->current_slave_link_conn_handle &&
        p_advertising->adv_modes_config.ble_adv_on_disconnect_disabled == 
# 116 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                                                         0
# 116 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                                              )
    {
       ...
       if ((ret != ((0x0) + 0)) && (p_advertising->error_handler != 
# 119 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                                                   0
# 119 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                                       ))
...
static void on_terminated(ble_advertising_t * const p_advertising, ble_evt_t const * p_ble_evt)
{
    ...
    if ( p_ble_evt->evt.gap_evt.params.adv_set_terminated.reason == 0x01
        ||p_ble_evt->evt.gap_evt.params.adv_set_terminated.reason == 0x02)
    {
...
# 176 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
   _Bool 
# 176 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
        peer_addr_is_valid = addr_is_valid(p_advertising->peer_address.addr);
...
# 229 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
    ...
    p_adv_params->properties.type = 0x02;
    p_adv_params->duration = (128);
                                        ...
                                        ble_gap_adv_params_t * p_adv_params)
{
    ...
    {
        p_adv_params->properties.type = 0x07;
    }
    else
    {

        p_adv_params->properties.type = 0x03;
...
# 280 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
      _Bool 
# 280 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
           use_whitelist(ble_advertising_t * const p_advertising)
{
                                    ...
                                    ble_gap_adv_params_t * p_adv_params)
{
    ...
    if (p_advertising->adv_modes_config.ble_adv_extended_enabled)
    {
        p_advertising->adv_params.properties.type = 0x06;
    }
    else
    {

        p_advertising->adv_params.properties.type = 0x01;
    ...
    {
        p_adv_params->filter_policy = 0x02;


        ret = flags_set(p_advertising, (0x04));
        do { uint32_t _err_code = (uint32_t) (ret); if (_err_code != ((0x0) + 0)) { return _err_code; } } while(0);
...
# 414 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
      _Bool 
# 414 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
           config_is_valid(ble_adv_modes_config_t const * const p_config)
{
    if ((p_config->ble_adv_directed_high_duty_enabled == 
# 416 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                                        1
# 416 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                            ) &&
        (p_config->ble_adv_extended_enabled == 
# 417 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                              1
# 417 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                  ))
...
# 419 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
    ...
    else if ( p_config->ble_adv_primary_phy == 0x04 ||
              p_config->ble_adv_secondary_phy == 0x04)
    {
        return 
# 425 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
              0
...
# 446 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
    ...
    {
        p_advertising->adv_handle = (0xFF);
    }
    p_advertising->adv_data.adv_data.p_data = p_advertising->enc_advdata;
    p_advertising->adv_data.adv_data.len = (31);
...
# 476 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                              )
    {
        ...
        p_advertising->adv_data.scan_rsp_data.len = (31);
...
# 488 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
    ...
    p_advertising->adv_params.primary_phy = 0x01;
    p_advertising->adv_params.duration = p_advertising->adv_modes_config.ble_adv_fast_timeout;
    p_advertising->adv_params.properties.type = 0x01;
    p_advertising->adv_params.p_peer_addr = 
# 498 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                               0
# 498 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                   ;
    p_advertising->adv_params.filter_policy = 0x00;
    p_advertising->adv_params.interval = p_advertising->adv_modes_config.ble_adv_fast_interval;

    ret = sd_ble_gap_adv_set_configure(&p_advertising->adv_handle, 
# 502 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                                                  0
# 502 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                                      , &p_advertising->adv_params);
    do { uint32_t _err_code = (uint32_t) (ret); if (_err_code != ((0x0) + 0)) { return _err_code; } } while(0);

    p_advertising->initialized = 
# 505 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                1
# 505 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                    ;
...
# 517 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
      _Bool 
# 517 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
           phy_is_valid(uint32_t const * const p_phy)
{
    if ((*p_phy) == 0x01 ||
        (*p_phy) == 0x02
...
# 550 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
   ...
   memset(&p_advertising->peer_address, 0, sizeof(p_advertising->peer_address));
    ...
    {
        if (p_advertising->evt_handler != 
# 561 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                         0
# 561 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                             )
        {
            p_advertising->peer_addr_reply_expected = 
# 563 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                                     1
# 563 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                         ;
...
# 575 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
        ...
        (!p_advertising->whitelist_temporarily_disabled))
    {
        p_advertising->whitelist_in_use = 
# 580 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                                 0
# 580 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                      ;
        p_advertising->whitelist_reply_expected = 
# 581 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c" 3 4
                                                 1
# 581 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
                                                     ;
...
# 586 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
    ...
    if (p_advertising->adv_modes_config.ble_adv_extended_enabled)
    {
        ...
        {
            p_advertising->adv_params.secondary_phy = 0x01;
        }
    }
    p_advertising->adv_params.filter_policy = 0x00;
...
# 767 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_advertising\\ble_advertising.c"
    ...
    ret = flags_set(p_advertising, ((0x02) | (0x04)));
    do { uint32_t _err_code = (uint32_t) (ret); if (_err_code != ((0x0) + 0)) { return _err_code; } } while(0);
