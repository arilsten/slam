...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c" 2
...
# 1 "../../../../../../components/libraries/util/sdk_errors.h" 1
# 45 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.h" 2
...
static 
# 58 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c" 3 4
      _Bool 
# 58 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
...
# 66 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
                                     ;
    m_current_sc_store_peer_id = 0xFFFF;


    ((void)(m_current_sc_store_peer_id));
}
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
...
# 94 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
    ...
    err_code = pdb_raw_store(m_current_sc_store_peer_id, &peer_data, 
# 98 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c" 3 4
                                                                    0
# 98 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
                                                                        );
    while ((m_current_sc_store_peer_id != 0xFFFF) && (err_code != ((0x0) + 17)))
    {
...
{
    if (m_current_sc_store_peer_id != 0xFFFF)
    {
...
# 174 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
                    ...
                    if (err_code_release != ((0x0) + 0))
                    {
                        err_code = ((0x0) + 3);
                    }
                }
            }
            else if (err_code == ((0x0) + 7))
            {
...
# 208 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
    ...
    uint32_t sys_attr_flags = ((((1 << 0)) | ((1 << 1))));
    
# 211 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c" 3 4
   _Bool 
# 211 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
                        all_attributes_applied = 
# 211 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c" 3 4
                                                 1
# 211 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
                                                     ;
    ...
    do
    {
        ...
        else if (err_code == ((0x0) + 8))
        {
            err_code = ((0x0) + 0);
        }
        else if (err_code == ((0x0) + 11))
        {
            all_attributes_applied = 
# 241 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c" 3 4
                                    0
...
{
    (void)(m_module_initialized);
    m_current_sc_store_peer_id = pdb_next_peer_id_get(0xFFFF);
    service_changed_pending_set();
}
...
ret_code_t gscm_service_changed_ind_send(uint16_t conn_handle)
{
    ...
    do
    {
        ...
        if (err_code == ((0x3000)+0x003))
        {
            start_handle += 1;
        }
    } while (err_code == ((0x3000)+0x003));
...
# 337 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
    ...
    (void) pdb_raw_store(peer_id, &peer_data, 
# 343 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c" 3 4
                                             0
# 343 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatts_cache_manager.c"
                                                 );
