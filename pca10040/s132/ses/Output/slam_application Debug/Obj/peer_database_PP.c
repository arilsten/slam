...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 2
...
# 49 "../../../../../../components/softdevice/s132/headers/ble_gap.h"
# 1 "../../../../../../components/softdevice/s132/headers/nrf_svc.h" 1
# 50 "../../../../../../components/softdevice/s132/headers/ble_gap.h" 2
# 1 "../../../../../../components/softdevice/s132/headers/nrf_error.h" 1
# 51 "../../../../../../components/softdevice/s132/headers/ble_gap.h" 2
...
# 55 "../../../../../../components/softdevice/s132/headers/ble_gap.h" 2
...
# 51 "../../../../../../components/ble/common/ble_gatt_db.h"
# 1 "../../../../../../components/softdevice/s132/headers/ble.h" 1
# 56 "../../../../../../components/softdevice/s132/headers/ble.h"
# 1 "../../../../../../components/softdevice/s132/headers/ble_gap.h" 1
...
# 611 "../../../../../../components/softdevice/s132/headers/ble.h"
 ;
# 52 "../../../../../../components/ble/common/ble_gatt_db.h" 2
# 1 "../../../../../../components/softdevice/s132/headers/ble_gattc.h" 1
...
# 48 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 2
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_buffer.h" 1
# 46 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_buffer.h"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_mutex.h" 1
# 72 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_mutex.h"
void pm_mutex_init(uint8_t * p_mutex, uint16_t mutex_size);
# 83 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_mutex.h"

# 83 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_mutex.h" 3 4
_Bool 
# 83 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_mutex.h"
    pm_mutex_lock(uint8_t * p_mutex, uint16_t mutex_bit_id);
# 94 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_mutex.h"
...
_Bool 
# 113 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_mutex.h"
    pm_mutex_lock_status_get(uint8_t * p_mutex, uint16_t mutex_bit_id);
# 47 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_buffer.h" 2
# 87 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\pm_buffer.h"
typedef struct
{
    uint8_t * p_memory;
...
static 
# 107 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
      _Bool 
# 107 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
                          m_module_initialized;
static pm_buffer_t m_write_buffer;
static pdb_buffer_record_t m_write_buffer_records[2];
static 
# 110 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
      _Bool 
# 110 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
...
{
    p_record->peer_id = 0xFFFF;
    p_record->data_id = PM_PEER_DATA_ID_INVALID;
    p_record->buffer_block_id = 0xFF;
    p_record->store_busy = 
# 123 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
                                0
# 123 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
...
{
    return write_buffer_record_find(0xFFFF, PM_PEER_DATA_ID_INVALID);
}
# 215 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
...
{
    for (uint32_t i = 0; i < (sizeof(m_evt_handlers) / sizeof(m_evt_handlers[0])); i++)
    {
...
{
    uint16_t n_bytes = n_bufs * (sizeof(pm_peer_data_bonding_t));
    p_peer_data->data_id = data_id;

    p_peer_data->p_all_data = (pm_peer_data_bonding_t *)p_buffer_memory;
    p_peer_data->length_words = (((n_bytes) + 3) >> 2);
}
...
static void write_buf_length_words_set(pm_peer_data_const_t * p_peer_data)
{
    switch (p_peer_data->data_id)
    {
        case PM_PEER_DATA_ID_BONDING:
            p_peer_data->length_words = (((sizeof(pm_peer_data_bonding_t)) + 3) >> 2);
            break;
        case PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING:
            p_peer_data->length_words = (((sizeof(
# 301 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
                                       _Bool
# 301 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
                                       )) + 3) >> 2);
        ...
        case PM_PEER_DATA_ID_PEER_RANK:
            p_peer_data->length_words = (((sizeof(uint32_t)) + 3) >> 2);
            break;
        case PM_PEER_DATA_ID_GATT_LOCAL:
            p_peer_data->length_words = ((((p_peer_data->p_local_gatt_db->len) + __builtin_offsetof (pm_peer_data_local_gatt_db_t, data)) + 3) >> 2);
            break;
        default:
...
# 338 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
    ...
    {
        case ((0x0) + 0):
            p_write_buffer_record->store_busy = 
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
                                                     0
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
                                                          ;
            p_write_buffer_record->store_flash_full = 
# 359 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
                                                     0
# 359 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
                                                          ;
...
# 395 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
      _Bool 
# 395 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
           write_buf_store_in_event(pdb_buffer_record_t * p_write_buffer_record)
{
    ret_code_t err_code;
    pm_evt_t event;
    ...
    if (err_code != ((0x0) + 0))
    {
        event.conn_handle = 0xFFFF;
        event.peer_id = p_write_buffer_record->peer_id;

        if (err_code == (((0x0) + 0x0080) + 0x0006))
        {
...
# 431 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
static void reattempt_previous_operations(
# 431 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
                                         _Bool 
# 431 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
                                              retry_flash_full)
...
# 447 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
           _Bool 
# 447 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
                success = write_buf_store_in_event(&m_write_buffer_records[i]);
...
# 491 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
                                                ))
            {
                ...
                p_write_buffer_record->store_token = 0;
                p_write_buffer_record->store_busy = 
# 495 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
                                                    1
# 495 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
...
ret_code_t pdb_init()
{
    ...
    do { __attribute__((aligned(4))) static uint8_t buffer_memory[(2) * ((sizeof(pm_peer_data_bonding_t)))]; static uint8_t mutex_memory[((7 + (2)) >> 3)]; ret = pm_buffer_init((&m_write_buffer), buffer_memory, (2) * ((sizeof(pm_peer_data_bonding_t))), mutex_memory, ((7 + (2)) >> 3), (2), ((sizeof(pm_peer_data_bonding_t)))); } while (0);
...
ret_code_t pdb_peer_free(pm_peer_id_t peer_id)
{
    ret_code_t err_code_in = ((0x0) + 0);
    ret_code_t err_code_out = ((0x0) + 0);
...
# 598 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
    ...
    return pds_peer_data_read(peer_id, data_id, (pm_peer_data_t*)p_peer_data, 
# 601 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c" 3 4
                                                                             0
# 601 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
                                                                                 );
...
# 613 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
    ...
    do { if (((data_id) != PM_PEER_DATA_ID_BONDING) && ((data_id) != PM_PEER_DATA_ID_GATT_LOCAL)) { return ((0x0) + 7); } } while (0);
...
# 633 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
    ...
    if (p_write_buffer_record->buffer_block_id == 0xFF)
    {
...
# 661 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
    ...
    {
        p_peer_data->p_local_gatt_db->len = (((p_peer_data->length_words) * (4)) - __builtin_offsetof (pm_peer_data_local_gatt_db_t, data));
    }
...
# 684 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_database.c"
    ...
    if (p_write_buffer_record->prepare_token != (0))
    {
...
{
    (void)(m_module_initialized);
    return pds_peer_data_store(peer_id, p_peer_data, (0), p_store_token);
}
