...
# 55 "../../../../../../components/libraries/experimental_log/nrf_log.h"
...
extern nrf_queue_t * __start_nrf_queue; extern void * __stop_nrf_queue;
# 117 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
static inline size_t nrf_queue_next_idx(nrf_queue_t const * p_queue, size_t idx)
{
    if (1) { if (p_queue != 
# 119 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 119 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)119, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
...
static inline size_t queue_utilization_get(nrf_queue_t const * p_queue)
{
...
# 138 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 138 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)138, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    size_t front = p_queue->p_cb->front;
    size_t back = p_queue->p_cb->back;
...
ret_code_t nrf_queue_push(nrf_queue_t const * p_queue, void const * p_element)
{
    ret_code_t status = ((0x0) + 0);

    if (1) { if (p_queue != 
# 149 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 149 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)149, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    if (1) { if (p_element != 
# 150 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 150 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)150, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
...
# 153 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   _Bool 
# 153 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
        is_full = nrf_queue_is_full(p_queue);
    ...
    if (!is_full || (p_queue->mode == NRF_QUEUE_MODE_OVERFLOW))
    {
        ...
        if (is_full)
        {
            ...
            if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_WARNING) | (p_queue->p_log)->module_id << 16), "Queue full. Overwriting oldest element."); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | (p_queue->p_log)->module_id << 16), "pushed element 0x%08X, status:%d", (uint32_t)(p_element), (uint32_t)(status)); } };
    return status;
}
...
# 217 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 217 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)217, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    if (1) { if (p_element != 
# 218 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 218 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)218, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    ...
    app_util_critical_region_exit(__CR_NESTED); };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (p_queue->p_log)->module_id << 16), "%s element 0x%08X, status:%d", (uint32_t)(just_peek ? "peeked" : "popped"), (uint32_t)(p_element), (uint32_t)(status)); } }
                                                                                            ;
    return status;
}
# 277 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
...
# 327 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 327 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)327, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    if (1) { if (p_data != 
# 328 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 328 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)328, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    if (1) { if (element_count <= p_queue->size) { } else { assert_nrf_callback((uint16_t)329, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (p_queue->p_log)->module_id << 16), "Write %d elements (start address: 0x%08X), status:%d", (uint32_t)(element_count), (uint32_t)(p_data), (uint32_t)(status)); } }
                                                                     ;
    return status;
}
...
# 360 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 360 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)360, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    if (1) { if (p_data != 
# 361 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 361 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)361, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    ...
    {
        element_count = ((element_count) < (p_queue->size) ? (element_count) : (p_queue->size));
    }
    else
    {
        size_t available = nrf_queue_available_get(p_queue);
        element_count = ((element_count) < (available) ? (element_count) : (available));
    }
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (p_queue->p_log)->module_id << 16), "Put in %d elements (start address: 0x%08X), requested :%d", (uint32_t)(element_count), (uint32_t)(p_data), (uint32_t)(req_element_count)); } }
                                                                                ;
...
# 439 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 439 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)439, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    if (1) { if (p_data != 
# 440 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 440 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)440, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (p_queue->p_log)->module_id << 16), "Read %d elements (start address: 0x%08X), status :%d", (uint32_t)(element_count), (uint32_t)(p_data), (uint32_t)(status)); } }
                                                                     ;
    return status;
}
...
# 469 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 469 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)469, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    if (1) { if (p_data != 
# 470 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 470 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)470, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    ...
    size_t utilization = queue_utilization_get(p_queue);
    element_count = ((element_count) < (utilization) ? (element_count) : (utilization));

    queue_read(p_queue, p_data, element_count);

    app_util_critical_region_exit(__CR_NESTED); };

    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (p_queue->p_log)->module_id << 16), "Out %d elements (start address: 0x%08X), requested :%d", (uint32_t)(element_count), (uint32_t)(p_data), (uint32_t)(req_element_count)); } }
                                                                                ;
    return element_count;
}
...
# 495 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 495 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)495, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (p_queue->p_log)->module_id << 16), "Reset"); } };
}
...
# 509 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 509 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)509, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
...
# 522 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 522 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)522, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
    size_t front = p_queue->p_cb->front;
    size_t back = p_queue->p_cb->back;
    return (front == back);
}
...
# 530 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 530 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)530, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
...
# 536 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 536 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)536, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
...
# 542 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c" 3 4
   0
# 542 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"
   ) { } else { assert_nrf_callback((uint16_t)542, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\queue\\nrf_queue.c"); } };
