...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 2
...
# 1 "../../../../../../components/libraries/util/sdk_errors.h" 1
# 46 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.h" 2
...
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_id.h" 1
...
# 88 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_id.h" 3 4
_Bool 
# 88 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_id.h"
    peer_id_delete(pm_peer_id_t peer_id);
...
_Bool 
# 106 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_id.h"
    peer_id_is_deleted(pm_peer_id_t peer_id);
# 116 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_id.h"

# 116 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_id.h" 3 4
_Bool 
# 116 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_id.h"
    peer_id_is_allocated(pm_peer_id_t peer_id);
# 132 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_id.h"
...
static 
# 75 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 3 4
      _Bool 
# 75 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
...
{
    return (uint16_t)(peer_id + ( (0xC000)));
}
...
{
    return (pm_peer_id_t)(file_id + (-(0xC000)));
}
...
{
    return (uint16_t)(peer_data_id + ( (0xC000)));
}
...
{
    return (pm_peer_data_id_t)(record_key + (-(0xC000)));
}
...
# 123 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 3 4
      _Bool 
# 123 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
           file_id_within_pm_range(uint16_t file_id)
{
    return (((0xC000) <= file_id)
         && (file_id <= (0xFFFE)));
}
...
# 131 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 3 4
      _Bool 
# 131 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
           record_key_within_pm_range(uint16_t record_key)
{
    return (((0xC000) <= record_key)
         && (record_key <= (0xFFFE)));
}
...
# 138 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 3 4
      _Bool 
# 138 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
           peer_data_id_is_valid(pm_peer_data_id_t data_id)
{
...
# 182 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
    ...
    peer_id = peer_id_get_next_deleted(0xFFFF);

    while ( (peer_id != 0xFFFF)
                                 ...
                                 fds_record_desc_t * const p_desc)
{
    ...
    (void)(peer_id < 256);
    (void)(peer_data_id_is_valid(data_id));
    (void)(p_desc != 
# 221 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 3 4
   0
# 221 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
        ...
        case FDS_EVT_DEL_RECORD:
                ...
                || record_key_within_pm_range(p_fds_evt->write.record_key))
            {
                ...
                if (p_fds_evt->result == FDS_SUCCESS)
                {
                    ...
                    pds_evt.params.peer_data_update_succeeded.flash_changed = 
# 289 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 3 4
                                                                             1
# 289 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
                                                                                 ;
        ...
        case FDS_EVT_DEL_FILE:
            if ( file_id_within_pm_range(p_fds_evt->del.file_id)
                && (p_fds_evt->del.record_key == (0x0000)))
            {
                if (p_fds_evt->result == FDS_SUCCESS)
                {
...
# 378 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
    ...
    do { if (((peer_id >= 256))) { return ((0x0) + 7); } } while (0);
    do { if (!(peer_data_id_is_valid(data_id))) { return ((0x0) + 7); } } while (0);
...
# 448 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
    ...
    if (fds_record_find_by_key(rec_key, &rec_desc, &m_fds_ftok) != ((0x0) + 0))
    {
        return 
# 456 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 3 4
              0
...
# 487 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
    ...
    (void)(p_prepare_token != 
# 488 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c" 3 4
   0
# 488 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\peer_data_storage.c"
   );

    do { if (!(peer_data_id_is_valid(p_peer_data->data_id))) { return ((0x0) + 7); } } while (0);
...
{
    (void)(m_module_initialized);
    return peer_id_allocate(0xFFFF);
}
