...
# 92 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"
        ...
        default:
            do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 3)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 129, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } while (0); } } while (0);
            return;
    }
}
...
static ret_code_t block_dev_sdc_init(nrf_block_dev_t const * p_blk_dev,
                                     ...
                                     void const * p_context)
{
    if (1) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)139, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
    nrf_block_dev_sdc_work_t * p_work = p_sdc_dev->p_work;

    if (p_sdc_dev->sdc_bdev_config.block_size != 512)
    {
    ...
    if (err_code == ((0x0) + 0))
    {
        if (!ev_handler)
        {
            ...
            sdc_wait();
            err_code = ((m_last_result == SDC_SUCCESS) ? ((0x0) + 0) : ((0x0) + 13));
        }
    }
...
{
    if (1) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)195, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
    nrf_block_dev_sdc_work_t * p_work = p_sdc_dev->p_work;
...
static ret_code_t block_dev_sdc_read_req(nrf_block_dev_t const * p_blk_dev,
                                         nrf_block_req_t const * p_blk)
{
    if (1) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)239, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    if (1) { if (p_blk) { } else { assert_nrf_callback((uint16_t)240, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
    nrf_block_dev_sdc_work_t * p_work = p_sdc_dev->p_work;
    ...
    if ((p_work->ev_handler) && (err_code != ((0x0) + 0)))
    {
...
static ret_code_t block_dev_sdc_write_req(nrf_block_dev_t const * p_blk_dev,
                                         nrf_block_req_t const * p_blk)
{
    if (1) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)289, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    if (1) { if (p_blk) { } else { assert_nrf_callback((uint16_t)290, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
    nrf_block_dev_sdc_work_t * p_work = p_sdc_dev->p_work;
...
{
    if (1) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)374, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
