...
# 51 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 2
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs/nrfx_prs.h" 1
...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_TWI_logs_data_dynamic;
...
const nrf_log_module_const_data_t m_nrf_log_TWI_logs_data_const __attribute__ ((section("." "log_const_data_TWI"))) __attribute__((used)) = { .p_module_name = "TWI", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_TWI_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_TWI"))) __attribute__((used));
# 55 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 2
# 88 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
typedef struct
{
...
nrfx_err_t nrfx_twi_init(nrfx_twi_t const * p_instance,
                         ...
                         void * p_context)
{
    if (1) { if (p_config) { } else { assert_nrf_callback((uint16_t)137, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"); } };
    if (1) { if (p_config->scl != p_config->sda) { } else { assert_nrf_callback((uint16_t)138, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"); } };
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
    ...
    if (nrfx_prs_acquire(p_instance->p_twi,
            irq_handlers[p_instance->drv_inst_idx]) != ((0x0) + 0))
    {
        err_code = ((0x0) + 17);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
# 175 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
    ...
    if (p_cb->handler)
    {
        _NRFX_IRQ_PRIORITY_SET(nrfx_get_irq_number(p_instance->p_twi), p_config->interrupt_priority)
                                         ;
        _NRFX_IRQ_ENABLE(nrfx_get_irq_number(p_instance->p_twi));
    }

    p_cb->state = NRFX_DRV_STATE_INITIALIZED;

    err_code = ((0x0) + 0);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}
...
{
    twi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)207, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"); } };

    if (p_cb->handler)
    {
        _NRFX_IRQ_DISABLE(nrfx_get_irq_number(p_instance->p_twi));
    }
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Instance uninitialized: %d.", (uint32_t)(p_instance->drv_inst_idx)); } };
}

void nrfx_twi_enable(nrfx_twi_t const * p_instance)
{
    twi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)232, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"); } };

    NRF_TWI_Type * p_twi = p_instance->p_twi;
    nrf_twi_enable(p_twi);

    p_cb->state = NRFX_DRV_STATE_POWERED_ON;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Instance enabled: %d.", (uint32_t)(p_instance->drv_inst_idx)); } };
}

void nrfx_twi_disable(nrfx_twi_t const * p_instance)
{
    twi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)244, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"); } };
    ...
    p_cb->state = NRFX_DRV_STATE_INITIALIZED;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Instance disabled: %d.", (uint32_t)(p_instance->drv_inst_idx)); } };
}
...
# 255 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 3 4
      _Bool 
# 255 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
           twi_send_byte(NRF_TWI_Type * p_twi,
                          uint8_t const * p_data,
                          uint8_t length,
...
# 305 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 3 4
      _Bool 
# 305 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
           twi_transfer(NRF_TWI_Type * p_twi,
...
# 312 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 3 4
   _Bool 
# 312 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
        do_stop_check = ((*p_error) || ((*p_bytes_transferred) == length));
    ...
    {
        nrf_twi_event_clear(p_twi, NRF_TWI_EVENT_ERROR);
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "TWI: Event: %s.", (uint32_t)((NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_STOPPED ? "NRF_TWI_EVENT_STOPPED" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_RXDREADY ? "NRF_TWI_EVENT_RXDREADY" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_TXDSENT ? "NRF_TWI_EVENT_TXDSENT" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_ERROR ? "NRF_TWI_EVENT_ERROR" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_BB ? "NRF_TWI_EVENT_BB" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_SUSPENDED ? "NRF_TWI_EVENT_SUSPENDED" : "UNKNOWN ERROR")))))))); } };
        nrf_twi_task_trigger(p_twi, NRF_TWI_TASK_STOP);
        *p_error = 
# 325 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 3 4
                  1
# 325 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
    ...
    else
    {
        ...
        {
            nrf_twi_event_clear(p_twi, NRF_TWI_EVENT_TXDSENT);
            if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "TWI: Event: %s.", (uint32_t)((NRF_TWI_EVENT_TXDSENT == NRF_TWI_EVENT_STOPPED ? "NRF_TWI_EVENT_STOPPED" : (NRF_TWI_EVENT_TXDSENT == NRF_TWI_EVENT_RXDREADY ? "NRF_TWI_EVENT_RXDREADY" : (NRF_TWI_EVENT_TXDSENT == NRF_TWI_EVENT_TXDSENT ? "NRF_TWI_EVENT_TXDSENT" : (NRF_TWI_EVENT_TXDSENT == NRF_TWI_EVENT_ERROR ? "NRF_TWI_EVENT_ERROR" : (NRF_TWI_EVENT_TXDSENT == NRF_TWI_EVENT_BB ? "NRF_TWI_EVENT_BB" : (NRF_TWI_EVENT_TXDSENT == NRF_TWI_EVENT_SUSPENDED ? "NRF_TWI_EVENT_SUSPENDED" : "UNKNOWN ERROR")))))))); } };
...
# 344 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
        ...
        {
            nrf_twi_event_clear(p_twi, NRF_TWI_EVENT_RXDREADY);
            if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "TWI: Event: %s.", (uint32_t)((NRF_TWI_EVENT_RXDREADY == NRF_TWI_EVENT_STOPPED ? "NRF_TWI_EVENT_STOPPED" : (NRF_TWI_EVENT_RXDREADY == NRF_TWI_EVENT_RXDREADY ? "NRF_TWI_EVENT_RXDREADY" : (NRF_TWI_EVENT_RXDREADY == NRF_TWI_EVENT_TXDSENT ? "NRF_TWI_EVENT_TXDSENT" : (NRF_TWI_EVENT_RXDREADY == NRF_TWI_EVENT_ERROR ? "NRF_TWI_EVENT_ERROR" : (NRF_TWI_EVENT_RXDREADY == NRF_TWI_EVENT_BB ? "NRF_TWI_EVENT_BB" : (NRF_TWI_EVENT_RXDREADY == NRF_TWI_EVENT_SUSPENDED ? "NRF_TWI_EVENT_SUSPENDED" : "UNKNOWN ERROR")))))))); } };
            if (nrf_twi_event_check(p_twi, NRF_TWI_EVENT_ERROR))
            {
                if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "TWI: Event: %s.", (uint32_t)((NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_STOPPED ? "NRF_TWI_EVENT_STOPPED" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_RXDREADY ? "NRF_TWI_EVENT_RXDREADY" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_TXDSENT ? "NRF_TWI_EVENT_TXDSENT" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_ERROR ? "NRF_TWI_EVENT_ERROR" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_BB ? "NRF_TWI_EVENT_BB" : (NRF_TWI_EVENT_ERROR == NRF_TWI_EVENT_SUSPENDED ? "NRF_TWI_EVENT_SUSPENDED" : "UNKNOWN ERROR")))))))); } };
                nrf_twi_event_clear(p_twi, NRF_TWI_EVENT_ERROR);
...
# 357 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
    ...
    if (do_stop_check && nrf_twi_event_check(p_twi, NRF_TWI_EVENT_STOPPED))
    {
        ...
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "TWI: Event: %s.", (uint32_t)((NRF_TWI_EVENT_STOPPED == NRF_TWI_EVENT_STOPPED ? "NRF_TWI_EVENT_STOPPED" : (NRF_TWI_EVENT_STOPPED == NRF_TWI_EVENT_RXDREADY ? "NRF_TWI_EVENT_RXDREADY" : (NRF_TWI_EVENT_STOPPED == NRF_TWI_EVENT_TXDSENT ? "NRF_TWI_EVENT_TXDSENT" : (NRF_TWI_EVENT_STOPPED == NRF_TWI_EVENT_ERROR ? "NRF_TWI_EVENT_ERROR" : (NRF_TWI_EVENT_STOPPED == NRF_TWI_EVENT_BB ? "NRF_TWI_EVENT_BB" : (NRF_TWI_EVENT_STOPPED == NRF_TWI_EVENT_SUSPENDED ? "NRF_TWI_EVENT_SUSPENDED" : "UNKNOWN ERROR")))))))); } };
        return 
# 370 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 3 4
              0
# 370 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
...
static inline nrfx_err_t twi_xfer(twi_control_block_t * p_cb,
                                    NRF_TWI_Type * p_twi,
                                    nrfx_twi_xfer_desc_t const * p_xfer_desc,
                                    uint32_t flags)
{
                         ...
                         uint32_t flags)
{
    ...
    if (1) { if (!((p_cb->handler == 
# 587 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 3 4
   0
# 587 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
   ) && (p_xfer_desc->type == NRFX_TWI_XFER_TXRX))) { } else { assert_nrf_callback((uint16_t)587, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"); } };
    if (1) { if (!((p_cb->handler == 
# 588 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c" 3 4
   0
# 588 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
   ) && (p_xfer_desc->type == NRFX_TWI_XFER_TXTX))) { } else { assert_nrf_callback((uint16_t)588, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"); } };

    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Transfer type: %s.", (uint32_t)((p_xfer_desc->type == NRFX_TWI_XFER_TX ? "XFER_TX" : (p_xfer_desc->type == NRFX_TWI_XFER_RX ? "XFER_RX" : (p_xfer_desc->type == NRFX_TWI_XFER_TXRX ? "XFER_TXRX" : (p_xfer_desc->type == NRFX_TWI_XFER_TXTX ? "XFER_TXTX" : "UNKNOWN TRANSFER TYPE")))))); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Transfer buffers length: primary: %d, secondary: %d.", (uint32_t)(p_xfer_desc->primary_length), (uint32_t)(p_xfer_desc->secondary_length)); } }

                                                ;
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Primary buffer data:"); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_hexdump((((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16)), ((p_xfer_desc->p_primary_buf)), ((p_xfer_desc->primary_length * sizeof(p_xfer_desc->p_primary_buf[0])))); } }
                                                                                               ;
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Secondary buffer data:"); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_hexdump((((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16)), ((p_xfer_desc->p_secondary_buf)), ((p_xfer_desc->secondary_length * sizeof(p_xfer_desc->p_secondary_buf[0])))); } }
                                                                                                   ;
...
# 612 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"
                                         no_stop)
{
    nrfx_twi_xfer_desc_t xfer = { .type = NRFX_TWI_XFER_TX, .address = address, .primary_length = length, .p_primary_buf = (uint8_t*)p_data, };

    return nrfx_twi_xfer(p_instance, &xfer, no_stop ? (1UL << 5) : 0);
}
...
nrfx_err_t nrfx_twi_rx(nrfx_twi_t const * p_instance,
                       ...
                       size_t length)
{
    nrfx_twi_xfer_desc_t xfer = { .type = NRFX_TWI_XFER_RX, .address = address, .primary_length = length, .p_primary_buf = p_data, };
...
{
    if (1) { if (p_cb->handler) { } else { assert_nrf_callback((uint16_t)640, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_twi.c"); } };
        ...
        p_cb->p_curr_buf == p_cb->xfer_desc.p_primary_buf)
    {
        ...
        p_cb->curr_no_stop = (p_cb->flags & (1UL << 5));
    ...
    else
    {
        ...
        if (p_cb->error)
        {
            ...
            if (errorsrc & NRF_TWI_ERROR_ADDRESS_NACK)
            {
                ...
                if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Event: %s.", (uint32_t)((NRFX_TWI_EVT_ADDRESS_NACK == NRFX_TWI_EVT_DONE ? "EVT_DONE" : (NRFX_TWI_EVT_ADDRESS_NACK == NRFX_TWI_EVT_ADDRESS_NACK ? "EVT_ADDRESS_NACK" : (NRFX_TWI_EVT_ADDRESS_NACK == NRFX_TWI_EVT_DATA_NACK ? "EVT_DATA_NACK" : "UNKNOWN ERROR"))))); } };
            }
            else if (errorsrc & NRF_TWI_ERROR_DATA_NACK)
            {
                event.type = NRFX_TWI_EVT_DATA_NACK;
                if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Event: %s.", (uint32_t)((NRFX_TWI_EVT_DATA_NACK == NRFX_TWI_EVT_DONE ? "EVT_DONE" : (NRFX_TWI_EVT_DATA_NACK == NRFX_TWI_EVT_ADDRESS_NACK ? "EVT_ADDRESS_NACK" : (NRFX_TWI_EVT_DATA_NACK == NRFX_TWI_EVT_DATA_NACK ? "EVT_DATA_NACK" : "UNKNOWN ERROR"))))); } };
            }
        }
        else
        {
            event.type = NRFX_TWI_EVT_DONE;
            if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TWI_logs_data_dynamic.module_id << 16), "Event: %s.", (uint32_t)((NRFX_TWI_EVT_DONE == NRFX_TWI_EVT_DONE ? "EVT_DONE" : (NRFX_TWI_EVT_DONE == NRFX_TWI_EVT_ADDRESS_NACK ? "EVT_ADDRESS_NACK" : (NRFX_TWI_EVT_DONE == NRFX_TWI_EVT_DATA_NACK ? "EVT_DATA_NACK" : "UNKNOWN ERROR"))))); } };
        }
...
void SPIM1_SPIS1_TWIM1_TWIS1_SPI1_TWI1_IRQHandler(void)
{
    twi_irq_handler(((NRF_TWI_Type *) 0x40004000UL), &m_cb[NRFX_TWI1_INST_IDX]);
}
