...
# 31 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c" 2
...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c" 2
# 1 "../../../../../../external/freertos/source/include/event_groups.h" 1
# 37 "../../../../../../external/freertos/source/include/event_groups.h"
# 1 "../../../../../../external/freertos/source/include/timers.h" 1
# 38 "../../../../../../external/freertos/source/include/event_groups.h" 2
# 82 "../../../../../../external/freertos/source/include/event_groups.h"
typedef void * EventGroupHandle_t;
# 92 "../../../../../../external/freertos/source/include/event_groups.h"
typedef TickType_t EventBits_t;
# 147 "../../../../../../external/freertos/source/include/event_groups.h"
 EventGroupHandle_t xEventGroupCreate( void ) ;
# 295 "../../../../../../external/freertos/source/include/event_groups.h"
EventBits_t xEventGroupWaitBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait ) ;
# 352 "../../../../../../external/freertos/source/include/event_groups.h"
EventBits_t xEventGroupClearBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToClear ) ;
# 408 "../../../../../../external/freertos/source/include/event_groups.h"
 BaseType_t xEventGroupClearBitsFromISR( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet ) ;
# 485 "../../../../../../external/freertos/source/include/event_groups.h"
EventBits_t xEventGroupSetBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet ) ;
# 560 "../../../../../../external/freertos/source/include/event_groups.h"
 BaseType_t xEventGroupSetBitsFromISR( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, BaseType_t *pxHigherPriorityTaskWoken ) ;
# 689 "../../../../../../external/freertos/source/include/event_groups.h"
EventBits_t xEventGroupSync( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait ) ;
# 725 "../../../../../../external/freertos/source/include/event_groups.h"
EventBits_t xEventGroupGetBitsFromISR( EventGroupHandle_t xEventGroup ) ;
# 739 "../../../../../../external/freertos/source/include/event_groups.h"
...
# 143 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"
 ...
 EventGroup_t *pxEventBits;
  ...
  if( pxEventBits != 
# 150 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c" 3 4
                    0 
# 150 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"
                         )
  {
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if (1) { if (( uxBitsToWaitFor & 0xff000000UL ) == 0) { } else { assert_nrf_callback((uint16_t)184, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
 if (1) { if (uxBitsToWaitFor != 0) { } else { assert_nrf_callback((uint16_t)185, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };

 {
  if (1) { if (!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) )) { } else { assert_nrf_callback((uint16_t)188, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
 }
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if (1) { if (xEventGroup) { } else { assert_nrf_callback((uint16_t)306, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
 if (1) { if (( uxBitsToWaitFor & 0xff000000UL ) == 0) { } else { assert_nrf_callback((uint16_t)307, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
 if (1) { if (uxBitsToWaitFor != 0) { } else { assert_nrf_callback((uint16_t)308, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };

 {
  if (1) { if (!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) )) { } else { assert_nrf_callback((uint16_t)311, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
 }
...
EventBits_t uxReturn;
 ...
 if (1) { if (xEventGroup) { } else { assert_nrf_callback((uint16_t)454, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
 if (1) { if (( uxBitsToClear & 0xff000000UL ) == 0) { } else { assert_nrf_callback((uint16_t)455, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
...
BaseType_t xMatchFound = ( ( BaseType_t ) 0 );
 ...
 if (1) { if (xEventGroup) { } else { assert_nrf_callback((uint16_t)516, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
 if (1) { if (( uxBitsToSet & 0xff000000UL ) == 0) { } else { assert_nrf_callback((uint16_t)517, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
...
const List_t *pxTasksWaitingForBits = &( pxEventBits->xTasksWaitingForBits );
 ...
 vTaskSuspendAll();
 {
  ...
  while( ( ( pxTasksWaitingForBits )->uxNumberOfItems ) > ( UBaseType_t ) 0 )
  {
   ...
   if (1) { if (pxTasksWaitingForBits->xListEnd.pxNext != ( const ListItem_t * ) &( pxTasksWaitingForBits->xListEnd )) { } else { assert_nrf_callback((uint16_t)612, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\event_groups.c"); } };
