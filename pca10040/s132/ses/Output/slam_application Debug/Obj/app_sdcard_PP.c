...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c" 2


# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.h" 1
...
# 54 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.h" 2
# 68 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.h"
typedef enum {
    SDC_SUCCESS = 0,
...
# 167 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.h" 3 4
_Bool 
# 167 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.h"
    app_sdc_busy_check(void);
# 182 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.h"
...
# 46 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
...
# 647 "../../../../../../modules/nrfx/hal/nrf_spim.h"
static inline void nrf_spim_frequency_set(NRF_SPIM_Type * p_reg,
                                            nrf_spim_frequency_t frequency)
{
...
enum {
# 80 "../../../../../../modules/nrfx/drivers/include/nrfx_spim.h"
...
# 153 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
typedef enum
{
...
# 236 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
typedef struct
{
    uint8_t const * p_tx_buffer;
    uint8_t tx_length;
...
# 279 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
typedef enum
{
...
# 477 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
static inline
void nrf_drv_spi_uninit(nrf_drv_spi_t const * p_instance)
{
    if (
# 480 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
       0
# 480 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
                           )
    {
        nrfx_spim_uninit(&p_instance->u.spim);
    }
    else if ((!
# 484 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
            0
# 484 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
            ))
    {
                                ...
                                uint8_t rx_buffer_length)
{
    ret_code_t result = 0;
    if (
# 498 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
       0
# 498 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
                           )
    {
...
# 511 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
            0
# 511 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
            ))
    {
                            ...
                            uint32_t flags)
{
    ret_code_t result = 0;
    if (
# 533 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
       0
# 533 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
                           )
    {
...
# 546 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
            0
# 546 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
            ))
    {
...
uint32_t nrf_drv_spi_start_task_get(nrf_drv_spi_t const * p_instance)
{
    uint32_t result = 0;
    if (
# 566 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
       0
# 566 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
                           )
    {
        result = nrfx_spim_start_task_get(&p_instance->u.spim);
    }
    else if ((!
# 570 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
            0
# 570 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
            ))
    {
        if (1) { if (
# 572 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
       0
# 572 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
       ) { } else { assert_nrf_callback((uint16_t)572, (uint8_t *)"../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"); } };
        result = 0;
    }
    return result;
}
...
uint32_t nrf_drv_spi_end_event_get(nrf_drv_spi_t const * p_instance)
{
    uint32_t result = 0;
    if (
# 582 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
       0
# 582 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
                           )
    {
        result = nrfx_spim_end_event_get(&p_instance->u.spim);
    }
    else if ((!
# 586 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
            0
# 586 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
            ))
    {
        if (1) { if (
# 588 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
       0
# 588 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
       ) { } else { assert_nrf_callback((uint16_t)588, (uint8_t *)"../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"); } };
        result = 0;
    }
    return result;
}
...
{
    if (
# 597 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
       0
# 597 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
                           )
    {
        nrfx_spim_abort(&p_instance->u.spim);
    }
    else if ((!
# 601 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h" 3 4
            0
# 601 "../../../../../../integration/nrfx/legacy/nrf_drv_spi.h"
            ))
    {
...
# 1 "../../../../../../external/protothreads/nrf_pt.h" 1
# 43 "../../../../../../external/protothreads/nrf_pt.h"
# 1 "../../../../../../external/protothreads/pt-1.4/pt.h" 1
# 52 "../../../../../../external/protothreads/pt-1.4/pt.h"
# 1 "../../../../../../external/protothreads/pt-1.4/lc.h" 1
# 126 "../../../../../../external/protothreads/pt-1.4/lc.h"
# 1 "../../../../../../external/protothreads/pt-1.4/lc-switch.h" 1
# 64 "../../../../../../external/protothreads/pt-1.4/lc-switch.h"
typedef unsigned short lc_t;
# 127 "../../../../../../external/protothreads/pt-1.4/lc.h" 2
# 53 "../../../../../../external/protothreads/pt-1.4/pt.h" 2

struct pt {
  lc_t lc;
};
# 44 "../../../../../../external/protothreads/nrf_pt.h" 2

typedef struct pt pt_t;
# 50 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c" 2
# 148 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
static const nrf_drv_spi_t m_spi = { 0, { .spi = { .p_reg = ((NRF_SPI_Type *) 0x40003000UL), .drv_inst_idx = NRFX_SPI0_INST_IDX, } }, 
# 148 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c" 3 4
                                  0 
# 148 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
                                  };
...
typedef struct {
    ...
    volatile sdc_op_t op;
    sdc_bus_state_t bus_state;
    uint8_t rsp_len;
} sdc_state_t;
...
static sdc_cb_t m_cb;
# 233 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
static inline void sdc_spi_transfer(uint8_t const * const p_txb,
                                      uint8_t tx_len,
                                      uint8_t * const p_rxb,
                                      uint8_t rx_len)
{
    do { nrf_gpio_pin_clear(m_cb.cs_pin); } while (0);
    ret_code_t err_code = nrf_drv_spi_transfer(&m_spi, p_txb, tx_len, p_rxb, rx_len);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 240, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
}
...
static inline void sdc_spi_hispeed(void)
{

    nrf_spi_frequency_set(m_spi.u.spi.p_reg,
                          (nrf_spi_frequency_t) 1073741824);
...
static ret_code_t sdc_cmd(uint8_t cmd, uint32_t arg, sdc_response_t rsp_type)
{
    ...
    m_cb.cmd_buf[0 + offset] = cmd & 0x7F;
    m_cb.cmd_buf[1 + offset] = (uint8_t)(arg >> 24);
    m_cb.cmd_buf[1 + 1 + offset] = (uint8_t)(arg >> 16);
    m_cb.cmd_buf[1 + 2 + offset] = (uint8_t)(arg >> 8);
    m_cb.cmd_buf[1 + 3 + offset] = (uint8_t)(arg);
    ...
    m_cb.cmd_buf[5 + offset] = crc;

    switch (rsp_type)
    {
        case SDC_R3:
            m_cb.state.rsp_len = 5;
            break;
        case SDC_R7:
            m_cb.state.rsp_len = 5;
            break;
        default:
            m_cb.state.rsp_len = 1;
            break;
    }

    uint8_t response_len = (((cmd) & 0x80)) ? 1 : m_cb.state.rsp_len;
...
# 392 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
static char sdc_pt_sub_data_read(uint8_t * p_rx_data, uint8_t rx_length, uint16_t block_len, sdc_result_t * p_exit_code)



{
    { char PT_YIELD_FLAG = 1; switch((&m_cb.state.pt_sub)->lc) { case 0:;
    while (1)
    {
        if (1) { if (block_len) { } else { assert_nrf_callback((uint16_t)400, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
        if (1) { if (m_cb.state.rw_op.block_count) { } else { assert_nrf_callback((uint16_t)401, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
        ...
        while (m_cb.state.rw_op.blocks_left)
        {
            ...
            while (m_cb.state.bus_state == SDC_BUS_DATA_WAIT)
            {
                ...
                if (m_cb.state.retry_count > 20000)
                {
                    do { *p_exit_code = (SDC_ERROR_TIMEOUT); do { (&m_cb.state.pt_sub)->lc = 0;; return 2; } while(0); } while (0);
                }


                while (rx_length && p_rx_data[0] == 0xFF)
                {
                    ++p_rx_data;
                    --rx_length;
                }
                ...
                if (rx_length)
                {
                    ...
                    else
                    {
                        ...
                        do { *p_exit_code = (SDC_ERROR_DATA); do { (&m_cb.state.pt_sub)->lc = 0;; return 2; } while(0); } while (0);
                    }
                }
                else
                {

                    sdc_spi_transfer(m_cb.cmd_buf, 1, m_cb.rsp_buf, 16);
                    do { PT_YIELD_FLAG = 0; (&m_cb.state.pt_sub)->lc = 455; case 455:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                }
            }
            ...
            while (m_cb.state.rw_op.position < block_len)
            {
                ...
                do { PT_YIELD_FLAG = 0; (&m_cb.state.pt_sub)->lc = 473; case 473:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            }
            ...
            sdc_spi_transfer(m_cb.cmd_buf, 1,
                 m_cb.rsp_buf, 2);
            do { PT_YIELD_FLAG = 0; (&m_cb.state.pt_sub)->lc = 480; case 480:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
        ...
        sdc_spi_transfer(m_cb.cmd_buf, 1,
                         m_cb.rsp_buf, 2);
        do { PT_YIELD_FLAG = 0; (&m_cb.state.pt_sub)->lc = 492; case 492:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);

        m_cb.state.bus_state = SDC_BUS_IDLE;
        do { *p_exit_code = (SDC_SUCCESS); do { (&m_cb.state.pt_sub)->lc = 0;; return 2; } while(0); } while (0);
    }
    }; PT_YIELD_FLAG = 0; (&m_cb.state.pt_sub)->lc = 0;; return 3; }
}
# 510 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
static char sdc_pt_identification(uint8_t * p_rx_data, uint8_t rx_length, sdc_result_t * p_exit_code)
...

{
    ...
    { char PT_YIELD_FLAG = 1; switch((&m_cb.state.pt)->lc) { case 0:;
    while (1)
    {
        err_code = sdc_cmd((0x40 | 0), 0, SDC_R1);
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 527, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
        do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 528; case 528:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
        err_code = sdc_cmd((0x40 | 0), 0, SDC_R1);
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 530, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
        do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 531; case 531:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);

        do { if ((r1) & ~(0x01 | 0x02)) { do { *p_exit_code = (SDC_ERROR_COMMUNICATION); do { ((&m_cb.state.pt))->lc = 0;; return 2; } while(0); } while (0); } } while (0);

        err_code = sdc_cmd((0x40 | 8), 0x1AA, SDC_R7);
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 536, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
        do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 537; case 537:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
        ...
        m_cb.state.retry_count = 0;
        arg = (m_cb.info.type.version == SDC_TYPE_SDV2) ? (1uL << 30) : 0;
        err_code = sdc_cmd((0x80 | 0x40 | 41), arg, SDC_R3);
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 549, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
        do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 550; case 550:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
        ...
        if (r1 & 0x04)
        {
            ...
            {
                ++m_cb.state.retry_count;
                if (m_cb.state.retry_count > 2000)
                {
                    do { *p_exit_code = (SDC_ERROR_TIMEOUT); do { (&m_cb.state.pt)->lc = 0;; return 2; } while(0); } while (0);
                }

                err_code = sdc_cmd((0x40 | 1), 0, SDC_R3);
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 567, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
                do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 568; case 568:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                do { if ((r1) & ~(0x01 | 0x02)) { do { *p_exit_code = (SDC_ERROR_COMMUNICATION); do { ((&m_cb.state.pt))->lc = 0;; return 2; } while(0); } while (0); } } while (0);
            }
            while (r1 & 0x01);
        }
        else
        {
            ...
            while (r1 & 0x01)
            {
                ...
                arg = (m_cb.info.type.version == SDC_TYPE_SDV2) ? (1uL << 30) : 0;
                err_code = sdc_cmd((0x80 | 0x40 | 41), arg, SDC_R3);
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 588, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
                do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 589; case 589:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                do { if ((r1) & ~(0x01 | 0x02)) { do { *p_exit_code = (SDC_ERROR_COMMUNICATION); do { ((&m_cb.state.pt))->lc = 0;; return 2; } while(0); } while (0); } } while (0);
            }

            err_code = sdc_cmd((0x40 | 58), 0, SDC_R3);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 594, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
            do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 595; case 595:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            do { if ((r1) & ~(0x01 | 0x02)) { do { *p_exit_code = (SDC_ERROR_COMMUNICATION); do { ((&m_cb.state.pt))->lc = 0;; return 2; } while(0); } while (0); } } while (0);
        ...
        if (m_cb.info.type.version != SDC_TYPE_SDV2)
        {
            ...
            err_code = sdc_cmd((0x40 | 16), 512, SDC_R1);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 608, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
            do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 609; case 609:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            do { if ((r1) & ~(0x01 | 0x02)) { do { *p_exit_code = (SDC_ERROR_COMMUNICATION); do { ((&m_cb.state.pt))->lc = 0;; return 2; } while(0); } while (0); } } while (0);
        }
        ...
        err_code = sdc_cmd((0x40 | 9), 0, SDC_R1);
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 618, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
        do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 619; case 619:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
        do { if ((r1) & ~(0x01 | 0x02)) { do { *p_exit_code = (SDC_ERROR_COMMUNICATION); do { ((&m_cb.state.pt))->lc = 0;; return 2; } while(0); } while (0); } } while (0);

        p_rx_data += 1;
        rx_length -= 1;
        do { ((&m_cb.state.pt_sub))->lc = 0;; do { ((((&m_cb.state.pt))))->lc = 624; case 624:; if(!(!((((sdc_pt_sub_data_read(p_rx_data, rx_length, 16, &sub_exit_code))) < 2)))) { return 0; } } while(0); } while(0)
                                                                              ;
        do { if ((sub_exit_code) != SDC_SUCCESS) { do { *p_exit_code = (sub_exit_code); do { ((&m_cb.state.pt))->lc = 0;; return 2; } while(0); } while (0); } } while (0);;

        m_cb.info.num_blocks = sdc_calculate_size(m_cb.work_buf);
        m_cb.info.block_len = 512;

        do { *p_exit_code = (SDC_SUCCESS); do { (&m_cb.state.pt)->lc = 0;; return 2; } while(0); } while (0);
    }
    }; PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 0;; return 3; }
}
# 646 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
static char sdc_pt_read(uint8_t * p_rx_data, uint8_t rx_length, sdc_result_t * p_exit_code)
...

{
    ...
    while (1)
    {
        ...
        do { ((&m_cb.state.pt_sub))->lc = 0;; do { ((((&m_cb.state.pt))))->lc = 664; case 664:; if(!(!((((sdc_pt_sub_data_read(p_rx_data, rx_length, 512, &sub_exit_code))) < 2)))) { return 0; } } while(0); } while(0)
        ...
        if (m_cb.state.rw_op.block_count > 1)
        {
            ...
            err_code = sdc_cmd((0x40 | 12), 0, SDC_R1);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 673, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
            do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 674; case 674:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
        }
...
# 692 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
static char sdc_pt_write(uint8_t * rx_data, uint8_t rx_length, sdc_result_t * p_exit_code)
...

{
    ...
    while (1)
    {
        ...
        {
            err_code = sdc_cmd((0x40 | 25), m_cb.state.rw_op.address, SDC_R1);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 706, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
            do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 707; case 707:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            r1 = rx_data[0];
            do { if ((r1) & ~(0x01 | 0x02)) { do { *p_exit_code = (SDC_ERROR_COMMUNICATION); do { ((&m_cb.state.pt))->lc = 0;; return 2; } while(0); } while (0); } } while (0);
        }
        ...
        while (m_cb.state.rw_op.blocks_left)
        {
            ...
            m_cb.cmd_buf[0] = 0xFF;
            m_cb.cmd_buf[1] = (m_cb.state.rw_op.block_count > 1) ? 0xFC
                                                           : 0xFE;
            sdc_spi_transfer(m_cb.cmd_buf, 2, m_cb.rsp_buf, 2);
            do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 723; case 723:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);


            while (m_cb.state.rw_op.position < 512)
            {
                {
                    uint16_t chunk_size = 512 - m_cb.state.rw_op.position;
                    if (chunk_size > 240)
                    {
                        chunk_size = 240;
                    }
                ...
                do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 740; case 740:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            }
            m_cb.state.rw_op.buffer += 512;


            m_cb.state.bus_state = SDC_BUS_DATA_WAIT;
            sdc_spi_transfer(m_cb.cmd_buf, 1,
                             m_cb.rsp_buf, 3);
            do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 748; case 748:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);

            {
                uint8_t token = m_cb.rsp_buf[2] & 0x1F;
                if (token != 0x05)
                {
                    if (token == 0x0B
                        || token == 0x0D)
                    {
                        do { *p_exit_code = (SDC_ERROR_DATA); do { (&m_cb.state.pt)->lc = 0;; return 2; } while(0); } while (0);
                    }
                    else
                    {
                        do { *p_exit_code = (SDC_ERROR_COMMUNICATION); do { (&m_cb.state.pt)->lc = 0;; return 2; } while(0); } while (0);
                    }
                }
            }
            ...
            while (m_cb.state.bus_state == SDC_BUS_DATA_WAIT)
            {
                ...
                sdc_spi_transfer(m_cb.cmd_buf, 1,
                                 m_cb.rsp_buf, 16);
                do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 778; case 778:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
        ...
        if (m_cb.state.rw_op.block_count > 1)
        {
            ...
            sdc_spi_transfer(m_cb.cmd_buf, 2,
                             m_cb.rsp_buf, 3);
            do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 800; case 800:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            ...
            while (m_cb.state.bus_state == SDC_BUS_DATA_WAIT)
            {
                ...
                sdc_spi_transfer(m_cb.cmd_buf, 1,
                                 m_cb.rsp_buf, 16);
                do { PT_YIELD_FLAG = 0; (&m_cb.state.pt)->lc = 816; case 816:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                        ...
                        void * p_context)
{
    ...
    if (!m_cb.state.rw_op.blocks_left)
    {
        ...
        do { nrf_gpio_pin_set(m_cb.cs_pin); } while (0);
    }

    if (m_cb.state.bus_state == SDC_BUS_ACMD || m_cb.state.bus_state == SDC_BUS_CMD)
    {

        if (1) { if (rx_length > 6) { } else { assert_nrf_callback((uint16_t)855, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
        rx_length -= 6;
        rx_data += 6;

        if (p_event->data.done.p_tx_buffer[0] == (0x40 | 12))
        {
        ...
        while (rx_length && rx_data[0] == 0xFF)
        {
            --rx_length;
            ++rx_data;
        }
...
# 884 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
        ...
        if (!rx_data && m_cb.state.op != SDC_OP_RESET)
        {
            ...
            switch (m_cb.state.op)
            {
                ...
                case SDC_OP_IDENTIFICATION:
                    ...
                    do { const uint32_t LOCAL_ERR_CODE = (app_sdc_uninit()); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 899, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
                    break;
                case SDC_OP_READ:
                ...
                case SDC_OP_WRITE:
                    ...
                    break;
                default:
                    do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 3)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 908, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
                    break;
            }
        ...
        if (m_cb.state.bus_state == SDC_BUS_ACMD)
        {
            ...
            if (!(r1 & (~0x01)))
            {
                sdc_spi_transfer(m_cb.cmd_buf + 6, 6,
                                 m_cb.rsp_buf, 6 + 8 + m_cb.state.rsp_len);
                return;
            }
        }
        m_cb.state.bus_state = SDC_BUS_IDLE;
    ...
    switch (m_cb.state.op)
    {
        ...
        case SDC_OP_IDENTIFICATION:
            if (!((sdc_pt_identification(rx_data, rx_length, &exit_code)) < 2))
            {
                evt.type = SDC_EVT_INIT;
                ...
                if (exit_code != SDC_SUCCESS)
                {
                    ...
                    do { const uint32_t LOCAL_ERR_CODE = (app_sdc_uninit()); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 951, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
                }
                sdc_spi_hispeed();
                m_cb.handler(&evt);
            }
            break;
        case SDC_OP_READ:
            if (!((sdc_pt_read(rx_data, rx_length, &exit_code)) < 2))
            {
                evt.type = SDC_EVT_READ;
                evt.result = exit_code;
                m_cb.state.op = SDC_OP_IDLE;
            ...
            break;
        case SDC_OP_WRITE:
            if (!((sdc_pt_write(rx_data, rx_length, &exit_code)) < 2))
            {
                evt.type = SDC_EVT_WRITE;
                evt.result = exit_code;
                m_cb.state.op = SDC_OP_IDLE;
            ...
            break;
        default:
            do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 3)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 984, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
            break;
    }
...
ret_code_t app_sdc_block_read(uint8_t * p_buf, uint32_t block_address, uint16_t block_count)
{
    if (1) { if (p_buf) { } else { assert_nrf_callback((uint16_t)994, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
    ...
    {
        m_cb.state.rw_op.address = block_address * 512;
    }
    else
    {
    ...
    (&m_cb.state.pt)->lc = 0;;
    uint8_t command = (block_count > 1) ? (0x40 | 18) : (0x40 | 17);
    ret_code_t err_code = sdc_cmd(command, m_cb.state.rw_op.address, SDC_R1);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1026, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
...
ret_code_t app_sdc_block_write(uint8_t const * p_buf, uint32_t block_address, uint16_t block_count)
{
    if (1) { if (p_buf) { } else { assert_nrf_callback((uint16_t)1034, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
    ...
    if (block_count == 1)
    {
        err_code = sdc_cmd((0x40 | 24), m_cb.state.rw_op.address, SDC_R1);

        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1069, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
        return ((0x0) + 0);
    }
    ...
    else
    {
        ...
        err_code = sdc_cmd((0x80 | 0x40 | 23), block_count, SDC_R1);
    }

    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1084, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
    return ((0x0) + 0);
}
...
ret_code_t app_sdc_init(app_sdc_config_t const * const p_config, sdc_event_handler_t event_handler)
{
    ...
    if ((!event_handler)
        || (p_config->cs_pin == 0xFF)
        || (p_config->miso_pin == 0xFF)
        || (p_config->mosi_pin == 0xFF)
        || (p_config->sck_pin == 0xFF))
    {
        return ((0x0) + 7);
    }

    ret_code_t err_code;
    if (1) { if (p_config->cs_pin && p_config->miso_pin && p_config->mosi_pin && p_config->sck_pin) { } else { assert_nrf_callback((uint16_t)1105, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } }
                                                      ;
    ...
    const nrf_drv_spi_config_t spi_cfg = {
                            ...
                            .irq_priority = 7,
                            .orc = 0xFF,
                            .frequency = (nrf_drv_spi_frequency_t) 67108864,
...
# 1124 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1125, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
    ...
    err_code = nrf_drv_spi_transfer(&m_spi, m_cb.cmd_buf, 1,
                                            m_cb.rsp_buf, 10);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1137, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } while (0); } } while (0);
