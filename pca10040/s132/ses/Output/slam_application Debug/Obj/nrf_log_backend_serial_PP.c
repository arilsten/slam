...
# 59 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\experimental_log\\src\\nrf_log_backend_serial.c"
    ...
    nrf_memobj_read(p_msg, &header, (sizeof(nrf_log_header_t)/sizeof(uint32_t) - (0 ? 0 : 1))*sizeof(uint32_t), memobj_offset);
    ...
    if (header.base.generic.type == 1U)
    {
    ...
    else if (header.base.generic.type == 2U)
    {
