...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_sdh_soc_logs_data_dynamic;
...
# 60 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_soc.c" 2
const nrf_log_module_const_data_t m_nrf_log_nrf_sdh_soc_logs_data_const __attribute__ ((section("." "log_const_data_nrf_sdh_soc"))) __attribute__((used)) = { .p_module_name = "nrf_sdh_soc", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(3), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_sdh_soc_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_nrf_sdh_soc"))) __attribute__((used));



extern nrf_sdh_soc_evt_observer_t * __start_sdh_soc_observers; extern void * __stop_sdh_soc_observers; static nrf_section_set_t const sdh_soc_observers = { .section = { .p_start = &__start_sdh_soc_observers, .p_end = &__stop_sdh_soc_observers, }, .item_size = sizeof(nrf_sdh_soc_evt_observer_t), };
...
# 77 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_soc.c"
              )
    {
        ...
        if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_soc_logs_data_dynamic.module_id << 16), "SoC event: 0x%x.", (uint32_t)(evt_id)); } };
...
# 92 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_soc.c"
    ...
    if (ret_code != ((0x0) + 5))
    {
        do { app_error_handler((ret_code), 107, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_soc.c"); } while (0);
    }
}


_Static_assert(1, "NRF_SDH_ENABLED not set!"); _Static_assert(0 < 2, "Priority level unavailable."); static nrf_sdh_stack_observer_t const m_nrf_sdh_soc_evts_poll __attribute__ ((section("." "sdh_stack_observers0"))) __attribute__((used)) =
{
