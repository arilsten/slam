...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_SPI_logs_data_dynamic;
...
const nrf_log_module_const_data_t m_nrf_log_SPI_logs_data_const __attribute__ ((section("." "log_const_data_SPI"))) __attribute__((used)) = { .p_module_name = "SPI", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_SPI_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_SPI"))) __attribute__((used));
# 56 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c" 2
...
nrfx_err_t nrfx_spi_init(nrfx_spi_t const * const p_instance,
                         ...
                         void * p_context)
{
    if (1) { if (p_config) { } else { assert_nrf_callback((uint16_t)83, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_SPI_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
    ...
    if (p_config->miso_pin != 0xFF)
    {
        miso_pin = p_config->miso_pin;
        nrf_gpio_cfg_input(miso_pin, (nrf_gpio_pin_pull_t)0);
    }
    else
    {
        miso_pin = 0xFFFFFFFF;
    ...
    if (p_cb->handler)
    {
        _NRFX_IRQ_PRIORITY_SET(nrfx_get_irq_number(p_instance->p_reg), p_config->irq_priority)
                                   ;
...
# 194 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
    ...
    err_code = ((0x0) + 0);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_SPI_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}
...
{
    spi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)205, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
...
# 251 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c" 3 4
      _Bool 
# 251 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
           transfer_byte(NRF_SPI_Type * p_spi, spi_control_block_t * p_cb)
{
                     ...
                     nrfx_spi_xfer_desc_t const * p_xfer_desc)
{
    ...
    else
    {
        do {
            ...
            nrf_spi_event_clear(p_spi, NRF_SPI_EVENT_READY);
            if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_SPI_logs_data_dynamic.module_id << 16), "SPI: Event: NRF_SPI_EVENT_READY."); } };
...
{
    spi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)356, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
    if (1) { if (p_xfer_desc->p_tx_buffer != 
# 357 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c" 3 4
   0 
# 357 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
   || p_xfer_desc->tx_length == 0) { } else { assert_nrf_callback((uint16_t)357, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
    if (1) { if (p_xfer_desc->p_rx_buffer != 
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c" 3 4
   0 
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
   || p_xfer_desc->rx_length == 0) { } else { assert_nrf_callback((uint16_t)358, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
...
{
    spi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)403, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
    p_cb->abort = 
# 404 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c" 3 4
                 1
# 404 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
...
{
    if (1) { if (p_cb->handler) { } else { assert_nrf_callback((uint16_t)409, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };

    nrf_spi_event_clear(p_spi, NRF_SPI_EVENT_READY);
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_SPI_logs_data_dynamic.module_id << 16), "Event: NRF_SPI_EVENT_READY."); } };
...
void SPIM0_SPIS0_TWIM0_TWIS0_SPI0_TWI0_IRQHandler(void)
{
    irq_handler(((NRF_SPI_Type *) 0x40003000UL), &m_cb[NRFX_SPI0_INST_IDX]);
}
# 435 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
void SPIM2_SPIS2_SPI2_IRQHandler(void)
{
    irq_handler(((NRF_SPI_Type *) 0x40023000UL), &m_cb[NRFX_SPI2_INST_IDX]);
}
