...
# 1 "../../../../../../components/libraries/util/app_util.h" 1
# 48 "../../../../../../components/libraries/experimental_section_vars/nrf_section_iter.h" 2
...
{
    if (1) { if (p_iter) { } else { assert_nrf_callback((uint16_t)196, (uint8_t *)"../../../../../../components/libraries/experimental_section_vars/nrf_section_iter.h"); } };
...
# 1 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h" 1
# 52 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
# 1 "../../../../../../components/softdevice/s132/headers/nrf_svc.h" 1
# 53 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h" 2
# 1 "../../../../../../components/softdevice/s132/headers/nrf_error.h" 1
# 54 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h" 2
# 1 "../../../../../../components/softdevice/s132/headers/nrf_error_sdm.h" 1
# 55 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h" 2
...
# 955 "../../../../../../components/softdevice/s132/headers/nrf_soc.h"
 ;
# 56 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h" 2
# 182 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
enum NRF_SD_SVCS
{
...
# 229 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
typedef struct
{
  uint8_t source;
  uint8_t rc_ctiv;
...
# 257 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
  uint8_t accuracy;

} nrf_clock_lf_cfg_t;
# 277 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
typedef void (*nrf_fault_handler_t)(uint32_t id, uint32_t pc, uint32_t info);
# 313 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
...
# 337 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
#pragma GCC diagnostic push
# 337 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_sdh_logs_data_dynamic;
...
# 64 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c" 2
const nrf_log_module_const_data_t m_nrf_log_nrf_sdh_logs_data_const __attribute__ ((section("." "log_const_data_nrf_sdh"))) __attribute__((used)) = { .p_module_name = "nrf_sdh", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(3), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_sdh_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_nrf_sdh"))) __attribute__((used));
# 83 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"
extern nrf_sdh_req_observer_t * __start_sdh_req_observers; extern void * __stop_sdh_req_observers; static nrf_section_set_t const sdh_req_observers = { .section = { .p_start = &__start_sdh_req_observers, .p_end = &__stop_sdh_req_observers, }, .item_size = sizeof(nrf_sdh_req_observer_t), };


extern nrf_sdh_state_observer_t * __start_sdh_state_observers; extern void * __stop_sdh_state_observers; static nrf_section_set_t const sdh_state_observers = { .section = { .p_start = &__start_sdh_state_observers, .p_end = &__stop_sdh_state_observers, }, .item_size = sizeof(nrf_sdh_state_observer_t), };


extern nrf_sdh_stack_observer_t * __start_sdh_stack_observers; extern void * __stop_sdh_stack_observers; static nrf_section_set_t const sdh_stack_observers = { .section = { .p_start = &__start_sdh_stack_observers, .p_end = &__stop_sdh_stack_observers, }, .item_size = sizeof(nrf_sdh_stack_observer_t), };
...
static ret_code_t sdh_request_observer_notify(nrf_sdh_req_evt_t req)
{
    ...
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_logs_data_dynamic.module_id << 16), "State request: 0x%08X", (uint32_t)(req)); } };

    for (nrf_section_iter_init(&iter, &sdh_req_observers);
         nrf_section_iter_get(&iter) != 
# 108 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c" 3 4
                                       0
# 108 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"
                                           ;
         nrf_section_iter_next(&iter))
    {
        ...
        {
            if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_logs_data_dynamic.module_id << 16), "Notify observer 0x%08X => ready", (uint32_t)(p_observer)); } };
        }
        else
        {

            if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_logs_data_dynamic.module_id << 16), "Notify observer 0x%08X => blocking", (uint32_t)(p_observer)); } };
            return ((0x0) + 17);
        }
    }
    return ((0x0) + 0);
...
static void sdh_state_observer_notify(nrf_sdh_state_evt_t evt)
{
    ...
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_logs_data_dynamic.module_id << 16), "State change: 0x%08X", (uint32_t)(evt)); } };
...
static void softdevices_evt_irq_enable(void)
{
    ...
    ret_code_t ret_code = sd_nvic_EnableIRQ((IRQn_Type)(SWI2_EGU2_IRQn));
    do { const uint32_t LOCAL_ERR_CODE = (ret_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 161, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"); } while (0); } } while (0);
...
static void softdevice_evt_irq_disable(void)
{
    ...
    ret_code_t ret_code = sd_nvic_DisableIRQ((IRQn_Type)(SWI2_EGU2_IRQn));
    do { const uint32_t LOCAL_ERR_CODE = (ret_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 173, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"); } while (0); } } while (0);
...
static void swi_interrupt_priority_workaround(void)
{
    ...
    ret_code_t ret_code;
    ret_code = sd_nvic_SetPriority((SWI2_EGU2_IRQn), APP_IRQ_PRIORITY_LOWEST);
    do { const uint32_t LOCAL_ERR_CODE = (ret_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 191, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"); } while (0); } } while (0);
    ret_code = sd_nvic_SetPriority((SWI1_EGU1_IRQn), APP_IRQ_PRIORITY_LOWEST);
    do { const uint32_t LOCAL_ERR_CODE = (ret_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 193, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"); } while (0); } } while (0);
...
# 212 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"
    ...
    if (sdh_request_observer_notify(NRF_SDH_EVT_ENABLE_REQUEST) == ((0x0) + 17))
    {
    ...
    m_nrf_sdh_enabled = (ret_code == ((0x0) + 0));
...
# 275 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"
    ...
    if (sdh_request_observer_notify(NRF_SDH_EVT_DISABLE_REQUEST) == ((0x0) + 17))
    {
...
void nrf_sdh_resume(void)
{
    ...
    ret_code_t ret_code = sd_nvic_SetPendingIRQ((IRQn_Type)(SWI2_EGU2_IRQn));
    do { const uint32_t LOCAL_ERR_CODE = (ret_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 354, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh.c"); } while (0); } } while (0);
