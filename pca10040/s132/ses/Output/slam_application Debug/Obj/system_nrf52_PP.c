...
# 88 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\mdk\\nrf.h" 2
# 97 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\mdk\\nrf.h"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\mdk\\compiler_abstraction.h" 1
...
# 85 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\mdk\\system_nrf52.c"
    ...
    if (errata_182()){
        *(volatile uint32_t *) 0x4000173C |= (0x1 << 10);
        ...
        if ((((NRF_UICR_Type *) 0x10001000UL)->NFCPINS & (0x1UL << (0UL))) == ((1UL) << (0UL))){
            ((NRF_NVMC_Type *) 0x4001E000UL)->CONFIG = (1UL) << (0UL);
            while (((NRF_NVMC_Type *) 0x4001E000UL)->READY == (0UL)){}
            ((NRF_UICR_Type *) 0x10001000UL)->NFCPINS &= ~(0x1UL << (0UL));
            while (((NRF_NVMC_Type *) 0x4001E000UL)->READY == (0UL)){}
