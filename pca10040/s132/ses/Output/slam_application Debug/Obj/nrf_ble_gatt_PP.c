...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_ble_gatt_logs_data_dynamic;
...
# 48 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c" 2
const nrf_log_module_const_data_t m_nrf_log_nrf_ble_gatt_logs_data_const __attribute__ ((section("." "log_const_data_nrf_ble_gatt"))) __attribute__((used)) = { .p_module_name = "nrf_ble_gatt", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(3), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_ble_gatt_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_nrf_ble_gatt"))) __attribute__((used));
...
_Static_assert(27 < 252, "unspecified message");



static void link_init(nrf_ble_gatt_link_t * p_link)
{
    p_link->att_mtu_desired = 23;
...
# 64 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
                                             ;
    p_link->att_mtu_exchange_requested = 
# 65 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c" 3 4
                                        0
# 65 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
                                             ;

    p_link->data_length_desired = 27;
    p_link->data_length_effective = 27;
...
{
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "Updating data length to %u on connection 0x%x.", (uint32_t)(data_length), (uint32_t)(conn_handle)); } }
                                           ;
    ...
    if (err_code != ((0x0) + 0))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "sd_ble_gap_data_length_update() (request) on connection 0x%x returned %s.", (uint32_t)(conn_handle), (uint32_t)(nrf_strerror_get(err_code))); } }
                                                              ;

        if ( (dll.tx_payload_limited_octets != 0)
            || (dll.rx_payload_limited_octets != 0))
        {
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "The requested TX/RX packet length is too long by %u/%u octets.", (uint32_t)(dll.tx_payload_limited_octets), (uint32_t)(dll.rx_payload_limited_octets)); } }
                                                                                       ;
        }

        if (dll.tx_rx_time_limited_us != 0)
        {
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "The requested combination of TX and RX packet lengths " "is too long by %u microseconds.", (uint32_t)(dll.tx_rx_time_limited_us)); } }
...
static void on_connected_evt(nrf_ble_gatt_t * p_gatt, ble_evt_t const * p_ble_evt)
{
    ...
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "Requesting to update ATT MTU to %u bytes on connection 0x%x.", (uint32_t)(p_link->att_mtu_desired), (uint32_t)(conn_handle)); } }
                                                           ;
...
# 164 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
                                                  ;
            if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "sd_ble_gattc_exchange_mtu_request()" " on connection 0x%x returned busy, will retry.", (uint32_t)(conn_handle)); } }
                                                                                        ;
        }
        else
        {
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "sd_ble_gattc_exchange_mtu_request() returned %s.", (uint32_t)(nrf_strerror_get(err_code))); } }
                                                     ;
        }
    }
...
static void on_exchange_mtu_rsp_evt(nrf_ble_gatt_t * p_gatt, ble_evt_t const * p_ble_evt)
{
    ...
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "ATT MTU updated to %u bytes on connection 0x%x (response).", (uint32_t)(p_link->att_mtu_effective), (uint32_t)(conn_handle)); } }
                                                         ;



    if ((p_gatt->evt_handler != 
# 218 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c" 3 4
                               0
# 218 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
                                   ) && (p_link->att_mtu_exchange_requested))
...
static void on_exchange_mtu_request_evt(nrf_ble_gatt_t * p_gatt, ble_evt_t const * p_ble_evt)
{
    ...
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "Peer on connection 0x%x requested an ATT MTU of %u bytes.", (uint32_t)(conn_handle), (uint32_t)(client_mtu)); } }
                                          ;
...
# 253 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
    ...
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "Updating ATT MTU to %u bytes (desired: %u) on connection 0x%x.", (uint32_t)(p_link->att_mtu_effective), (uint32_t)(p_link->att_mtu_desired), (uint32_t)(conn_handle)); } }
                                                                                  ;
    ...
    if (err_code != ((0x0) + 0))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "sd_ble_gatts_exchange_mtu_reply() returned %s.", (uint32_t)(nrf_strerror_get(err_code))); } };
    }
...
static void on_data_length_update_evt(nrf_ble_gatt_t * p_gatt, ble_evt_t const * p_ble_evt)
{
    ...
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "Data length updated to %u on connection 0x%0x.", (uint32_t)(p_gatt->links[conn_handle].data_length_effective), (uint32_t)(conn_handle)); } }

                              ;

    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "max_rx_octets: %u", (uint32_t)(gap_evt.params.data_length_update.effective_params.max_rx_octets)); } }
                                                                                   ;
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "max_tx_octets: %u", (uint32_t)(gap_evt.params.data_length_update.effective_params.max_tx_octets)); } }
                                                                                   ;
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "max_rx_time: %u", (uint32_t)(gap_evt.params.data_length_update.effective_params.max_rx_time_us)); } }
                                                                                    ;
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "max_tx_time: %u", (uint32_t)(gap_evt.params.data_length_update.effective_params.max_tx_time_us)); } }
                                                                                    ;
...
static void on_data_length_update_request_evt(nrf_ble_gatt_t * p_gatt, ble_evt_t const * p_ble_evt)
{
    ...
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "Peer on connection 0x%x requested a data length of %u bytes.", (uint32_t)(p_gap_evt->conn_handle), (uint32_t)(data_length_requested)); } }
                                                                ;

    uint8_t const data_length_effective = ((p_link->data_length_desired) < (data_length_requested) ? (p_link->data_length_desired) : (data_length_requested));
...
# 369 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
    ...
    p_gatt->att_mtu_desired_periph = 23;
    p_gatt->att_mtu_desired_central = 23;
...
# 387 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
    ...
    if ((desired_mtu < 23) || (desired_mtu > 23))
    {
        return ((0x0) + 7);
    }
...
void nrf_ble_gatt_on_ble_evt(ble_evt_t const * p_ble_evt, void * p_context)
{
    ...
    if (p_gatt->links[conn_handle].att_mtu_exchange_pending)
    {
        ...
        if (err_code == ((0x0) + 0))
        {
            p_gatt->links[conn_handle].att_mtu_exchange_pending = 
# 536 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c" 3 4
                                                                   0
# 536 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
                                                                        ;
            p_gatt->links[conn_handle].att_mtu_exchange_requested = 
# 537 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c" 3 4
                                                                   1
# 537 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_gatt\\nrf_ble_gatt.c"
                                                                       ;

            if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_ble_gatt_logs_data_dynamic.module_id << 16), "Requesting to update ATT MTU to %u bytes on connection 0x%x (retry).", (uint32_t)(p_gatt->links[conn_handle].att_mtu_desired), (uint32_t)(conn_handle)); } }
                                                                                  ;
        }
        else if (err_code != ((0x0) + 17))
        {
