...
# 49 "../../../../../../components/softdevice/s132/headers/ble_gattc.h"
...
# 50 "../../../../../../components/softdevice/s132/headers/ble_gattc.h" 2
...
# 54 "../../../../../../components/libraries/atomic/nrf_atomic.h"
...
# 55 "../../../../../../components/libraries/atomic/nrf_atomic.h" 2
...
uint32_t ble_conn_state_for_each_set_user_flag(ble_conn_state_user_flag_id_t flag_id,
                                               ...
                                               void * p_context);
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c" 2




# 1 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h" 1
# 65 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"
typedef volatile uint32_t nrf_atflags_t;
# 115 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"
...
# 131 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"

# 131 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h" 3 4
_Bool 
# 131 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"
    nrf_atflags_fetch_set(nrf_atflags_t * p_flags, uint32_t flag_index);
...
# 147 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"

# 147 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h" 3 4
_Bool 
# 147 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"
    nrf_atflags_fetch_clear(nrf_atflags_t * p_flags, uint32_t flag_index);
# 156 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"

# 156 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h" 3 4
_Bool 
# 156 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"
    nrf_atflags_get(nrf_atflags_t const * p_flags, uint32_t flag_index);
# 165 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"
uint32_t nrf_atflags_find_and_set_flag(nrf_atflags_t * p_flags, uint32_t flag_count);
# 174 "../../../../../../components/libraries/atomic_flags/nrf_atflags.h"
...
# 53 "../../../../../../components/softdevice/common/nrf_sdh_ble.h"
# 1 "../../../../../../components/libraries/util/app_util.h" 1
# 54 "../../../../../../components/softdevice/common/nrf_sdh_ble.h" 2
...
# 1 "../../../../../../components/libraries/util/sdk_errors.h" 1
# 58 "../../../../../../components/softdevice/common/nrf_sdh_ble.h" 2
...
typedef struct
{
    nrf_atflags_t valid_flags;
    nrf_atflags_t connected_flags;
    nrf_atflags_t central_flags;
    nrf_atflags_t encrypted_flags;
    nrf_atflags_t mitm_protected_flags;
    nrf_atflags_t user_flags[24];
...
typedef struct
{
    nrf_atflags_t acquired_flags;
    union
    {
        ble_conn_state_flag_collections_t flags;
        nrf_atflags_t flag_array[(5 + 24)];
    };
} ble_conn_state_t;
...
static ble_conn_state_t m_bcs = {0};
...
# 140 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"
static 
# 140 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c" 3 4
      _Bool 
# 140 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"
           record_activate(uint16_t conn_handle)
{
    if (conn_handle >= (20))
    {
        return 
...
static void record_purge_disconnected()
{
    ...
    ((void)(nrf_atomic_u32_and(&disconnected_flags, m_bcs.flags.valid_flags)));
...
# 199 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c" 3 4
      _Bool 
# 199 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"
           user_flag_is_acquired(ble_conn_state_user_flag_id_t flag_id)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            ...
            if ( !record_activate(conn_handle) )
            {
                ...
                do { app_error_handler((((0x0) + 4)), 227, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"); } while (0);
            }
            else if ((p_ble_evt->evt.gap_evt.params.connected.role != 0x1))
            {
...
# 243 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c" 3 4
           _Bool 
# 243 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"
                encrypted = (p_ble_evt->evt.gap_evt.params.conn_sec_update.conn_sec.sec_mode.lv > 1);
            
# 244 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c" 3 4
           _Bool 
# 244 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"
                mitm = (p_ble_evt->evt.gap_evt.params.conn_sec_update.conn_sec.sec_mode.lv > 2);
...
_Static_assert(1, "NRF_SDH_BLE_ENABLED not set!"); _Static_assert(0 < 4, "Priority level unavailable."); static nrf_sdh_ble_evt_observer_t m_ble_evt_observer __attribute__ ((section("." "sdh_ble_observers0"))) __attribute__((used)) = { .handler = ble_evt_handler, .p_context = 
# 268 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c" 3 4
0 
# 268 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"
};
...
# 288 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c" 3 4
       _Bool 
# 288 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"
            central = nrf_atflags_get(&m_bcs.flags.central_flags, conn_handle);
        role = central ? 0x2 : 0x1;
...
# 305 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c" 3 4
       _Bool 
# 305 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_conn_state.c"
            connected = nrf_atflags_get(&m_bcs.flags.connected_flags, conn_handle);
...
uint32_t ble_conn_state_central_conn_count(void)
{
    ...
    ((void)(nrf_atomic_u32_and(&central_conn_flags, m_bcs.flags.connected_flags)));
...
uint32_t ble_conn_state_peripheral_conn_count(void)
{
    ...
    ((void)(nrf_atomic_u32_and(&peripheral_conn_flags, m_bcs.flags.connected_flags)));
