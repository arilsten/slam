...
# 31 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c" 2
...
# 138 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c" 3 4
                                                  0
# 138 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"
                                                      ;
...
# 261 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"
 ...
 if (1) { if (xReturn) { } else { assert_nrf_callback((uint16_t)272, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
 return xReturn;
}
         ...
         Timer_t *pxNewTimer )
{
 ...
 if (1) { if (( xTimerPeriodInTicks > 0 )) { } else { assert_nrf_callback((uint16_t)361, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
DaemonTaskMessage_t xMessage;
 ...
 if (1) { if (xTimer) { } else { assert_nrf_callback((uint16_t)387, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
TaskHandle_t xTimerGetTimerDaemonTaskHandle( void )
{
 ...
 if (1) { if (( xTimerTaskHandle != 
# 429 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c" 3 4
0 
# 429 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"
)) { } else { assert_nrf_callback((uint16_t)429, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
Timer_t *pxTimer = ( Timer_t * ) xTimer;
 ...
 if (1) { if (xTimer) { } else { assert_nrf_callback((uint16_t)438, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
TickType_t xReturn;
 ...
 if (1) { if (xTimer) { } else { assert_nrf_callback((uint16_t)448, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
Timer_t *pxTimer = ( Timer_t * ) xTimer;
 ...
 if (1) { if (xTimer) { } else { assert_nrf_callback((uint16_t)458, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
# 484 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"
                                                                                             , ( TickType_t ) 0U );
   if (1) { if (xResult) { } else { assert_nrf_callback((uint16_t)485, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
   ( void ) xResult;
  }
  else
  {
 ...
 while( xQueueReceive( xTimerQueue, &xMessage, ( TickType_t ) 0U ) != ( ( ( BaseType_t ) 0 ) ) )
 {

  {
   ...
   if( xMessage.xMessageID < ( BaseType_t ) 0 )
   {
    ...
    if (1) { if (pxCallback) { } else { assert_nrf_callback((uint16_t)708, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
# 765 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"
                                                                                                                                                          , ( TickType_t ) 0U );
       if (1) { if (xResult) { } else { assert_nrf_callback((uint16_t)766, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
       ( void ) xResult;
      }
      else
      {
    ...
    case ( ( BaseType_t ) 9 ) :
     ...
     if (1) { if (( pxTimer->xTimerPeriodInTicks > 0 )) { } else { assert_nrf_callback((uint16_t)789, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
# 878 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"
                                                                                              , ( TickType_t ) 0U );
    if (1) { if (xResult) { } else { assert_nrf_callback((uint16_t)879, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
    ( void ) xResult;
   }
  }
  else
...
# 919 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"
   {
    xTimerQueue = xQueueGenericCreate( ( ( UBaseType_t ) 32 ), ( sizeof( DaemonTaskMessage_t ) ), ( ( ( uint8_t ) 0U ) ) );
   }
...
Timer_t *pxTimer = ( Timer_t * ) xTimer;
 ...
 if (1) { if (xTimer) { } else { assert_nrf_callback((uint16_t)951, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
void *pvReturn;
 ...
 if (1) { if (xTimer) { } else { assert_nrf_callback((uint16_t)972, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
...
Timer_t * const pxTimer = ( Timer_t * ) xTimer;
 ...
 if (1) { if (xTimer) { } else { assert_nrf_callback((uint16_t)988, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
 ...
 BaseType_t xReturn;
  ...
  if (1) { if (xTimerQueue) { } else { assert_nrf_callback((uint16_t)1032, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\timers.c"); } };
