...
# 635 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.h" 3 4
       0
# 635 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.h"
       ) { } else { assert_nrf_callback((uint16_t)635, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.h"); } };
        result = 0;
    }
    else if ((!
# 638 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.h" 3 4
...
# 657 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.h" 3 4
       0
# 657 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.h"
       ) { } else { assert_nrf_callback((uint16_t)657, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.h"); } };
        result = 0;
    }
    return result;
}
...
# 44 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.c" 2
# 78 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.c"
static nrf_drv_twi_evt_handler_t m_handlers[2];
static void * m_contexts[2];

static void twi_clear_bus(nrf_drv_twi_config_t const * p_config)
{
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[p_config->scl] = ( ((0UL) << (16UL)) | ((6UL) << (8UL)) | ((3UL) << (2UL)) | ((0UL) << (1UL)) | ((0UL) << (0UL)));
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[p_config->sda] = ( ((0UL) << (16UL)) | ((6UL) << (8UL)) | ((3UL) << (2UL)) | ((0UL) << (1UL)) | ((0UL) << (0UL)));

    nrf_gpio_pin_set(p_config->scl);
    nrf_gpio_pin_set(p_config->sda);

    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[p_config->scl] = ( ((0UL) << (16UL)) | ((6UL) << (8UL)) | ((3UL) << (2UL)) | ((0UL) << (1UL)) | ((1UL) << (0UL)));
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[p_config->sda] = ( ((0UL) << (16UL)) | ((6UL) << (8UL)) | ((3UL) << (2UL)) | ((0UL) << (1UL)) | ((1UL) << (0UL)));

    nrfx_coredep_delay_us(4);
...
# 177 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.c"
                           )
    {
        result = nrfx_twim_init(&p_instance->u.twim,
                                (nrfx_twim_config_t const *)p_config,
                                event_handler ? twim_evt_handler : 
# 181 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.c" 3 4
                                                                  0
# 181 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_twi.c"
                                                                      ,
