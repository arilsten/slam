...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_GPIOTE_logs_data_dynamic;
...
const nrf_log_module_const_data_t m_nrf_log_GPIOTE_logs_data_const __attribute__ ((section("." "log_const_data_GPIOTE"))) __attribute__((used)) = { .p_module_name = "GPIOTE", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_GPIOTE_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_GPIOTE"))) __attribute__((used));
# 50 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c" 2
# 98 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"
typedef struct
{
    ...
    uint8_t configured_pins[(((32))+7) / 8];
...
nrfx_err_t nrfx_gpiote_init(void)
{
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_GPIOTE_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
    ...
    _NRFX_IRQ_PRIORITY_SET(GPIOTE_IRQn, 7);
    ...
    err_code = ((0x0) + 0);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_GPIOTE_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}
...
void nrfx_gpiote_uninit(void)
{
    if (1) { if (m_cb.state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)275, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_GPIOTE_logs_data_dynamic.module_id << 16), "Uninitialized."); } };
}
...
nrfx_err_t nrfx_gpiote_out_init(nrfx_gpiote_pin_t pin,
                                nrfx_gpiote_out_config_t const * p_config)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)301, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (m_cb.state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)302, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (p_config) { } else { assert_nrf_callback((uint16_t)303, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_out_uninit(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)357, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)358, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_out_set(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)377, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)378, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (!pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)379, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_out_clear(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)387, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)388, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (!pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)389, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_out_toggle(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)397, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)398, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (!pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)399, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_out_task_enable(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)407, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)408, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)409, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_out_task_disable(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)417, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)418, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)419, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
uint32_t nrfx_gpiote_out_task_addr_get(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)427, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)428, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
uint32_t nrfx_gpiote_set_task_addr_get(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)438, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)439, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
uint32_t nrfx_gpiote_clr_task_addr_get(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)451, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)452, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_out_task_force(nrfx_gpiote_pin_t pin, uint8_t state)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)463, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)464, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)465, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_out_task_trigger(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)475, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)476, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)477, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_set_task_trigger(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)487, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)488, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)489, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_clr_task_trigger(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)501, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use(pin)) { } else { assert_nrf_callback((uint16_t)502, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)503, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
nrfx_err_t nrfx_gpiote_in_init(nrfx_gpiote_pin_t pin,
                               ...
                               nrfx_gpiote_evt_handler_t evt_handler)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)516, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    nrfx_err_t err_code = ((0x0) + 0);
...
# 562 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"
                                                            int_enable)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)564, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_gpiote(pin)) { } else { assert_nrf_callback((uint16_t)565, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void nrfx_gpiote_in_event_disable(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)609, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_gpiote(pin)) { } else { assert_nrf_callback((uint16_t)610, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (pin_in_use_by_port(pin))
    {
...
void nrfx_gpiote_in_uninit(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)626, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_gpiote(pin)) { } else { assert_nrf_callback((uint16_t)627, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
# 643 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"
    nrfx_gpiote_in_is_set(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)645, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
uint32_t nrfx_gpiote_in_event_addr_get(nrfx_gpiote_pin_t pin)
{
    if (1) { if (pin < (32)) { } else { assert_nrf_callback((uint16_t)652, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
    if (1) { if (pin_in_use_by_port(pin) || pin_in_use_by_te(pin)) { } else { assert_nrf_callback((uint16_t)653, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"); } };
...
void GPIOTE_IRQHandler(void)
{
    ...
    if (status & (NRF_GPIOTE_INT_IN0_MASK | NRF_GPIOTE_INT_IN1_MASK | NRF_GPIOTE_INT_IN2_MASK | NRF_GPIOTE_INT_IN3_MASK | NRF_GPIOTE_INT_IN4_MASK | NRF_GPIOTE_INT_IN5_MASK | NRF_GPIOTE_INT_IN6_MASK | NRF_GPIOTE_INT_IN7_MASK))
    {
        ...
        for (i = 0; i < 8; i++)
        {
            if (mask & status)
            {
                ...
                if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_GPIOTE_logs_data_dynamic.module_id << 16), "Event in number: %d.", (uint32_t)(i)); } };
                nrf_gpiote_polarity_t polarity = nrf_gpiote_event_polarity_get(i);
                nrfx_gpiote_evt_handler_t handler = channel_handler_get(i);
                if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_GPIOTE_logs_data_dynamic.module_id << 16), "Pin: %d, polarity: %d.", (uint32_t)(pin), (uint32_t)(polarity)); } };
                if (handler)
                {
    ...
    if (status & (uint32_t)NRF_GPIOTE_INT_PORT_MASK)
    {
        ...
        uint32_t port_idx;
        uint8_t repeat = 0;
        uint32_t toggle_mask[1] = {0};
        uint32_t pins_to_check[1];


        for (port_idx = 0; port_idx < 1; port_idx++)
        {
            ...
            for (i = 0; i < 4; i++)
            {
                    ...
                    && nrf_bitmask_bit_is_set(pin, pins_to_check))
                {
                    ...
                    if (handler || (polarity == NRF_GPIOTE_POLARITY_TOGGLE))
                    {
                        ...
                        {
                            if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_GPIOTE_logs_data_dynamic.module_id << 16), "PORT event for pin: %d, polarity: %d.", (uint32_t)(pin), (uint32_t)(polarity)); } };
                            if (polarity == NRF_GPIOTE_POLARITY_TOGGLE)
                            {
...
# 791 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_gpiote.c"
                                              ;
                nrf_gpio_ports_read(0, 1, new_input);
