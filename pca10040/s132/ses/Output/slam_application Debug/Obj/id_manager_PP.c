...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 2
...
# 1 "../../../../../../components/libraries/util/sdk_errors.h" 1
# 45 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.h" 2
...
static 
# 84 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
      _Bool 
# 84 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
                                       m_module_initialized;
static im_connection_t m_connections[(20)];
static ble_conn_state_user_flag_id_t m_conn_state_user_flag_id;

static uint8_t m_wlisted_peer_cnt;
static pm_peer_id_t m_wlisted_peers[(8)];
...
static void internal_state_reset()
{
    ...
    {
        m_connections[i].conn_handle = 0xFFFF;
    }
}
...
# 176 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    ...
    {
        ble_conn_state_user_flag_set(conn_handle, m_conn_state_user_flag_id, 
# 178 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
                                                                            1
# 178 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
                                                                                );
        ...
        if (conn_index != (0xFF))
        {
            ...
            m_connections[conn_index].peer_id = 0xFFFF;
...
_Bool 
# 206 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    is_valid_irk(ble_gap_irk_t const * p_irk)
{
    (void)(p_irk != 
# 208 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
   0
...
_Bool 
# 231 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    addr_compare(ble_gap_addr_t const * p_addr1, ble_gap_addr_t const * p_addr2)
{
...
# 242 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    ...
    return (memcmp(p_addr1->addr, p_addr2->addr, (6)) == 0);
}
...
void im_ble_evt_handler(ble_evt_t const * ble_evt)
{
    ...
    bonded_matching_peer_id = 0xFFFF;
...
# 312 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    ...
    if (bonded_matching_peer_id != 0xFFFF)
    {
...
# 343 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    im_is_duplicate_bonding_data(pm_peer_data_bonding_t const * p_bonding_data1,
                                  pm_peer_data_bonding_t const * p_bonding_data2)
{
    (void)(p_bonding_data1 != 
# 346 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
   0
# 346 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
   );
    (void)(p_bonding_data2 != 
# 347 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
   0
# 347 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
   );
...
# 352 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
   _Bool 
# 352 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
        duplicate_irk = ((memcmp(p_bonding_data1->peer_ble_id.id_info.irk,
...
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
   _Bool 
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
        duplicate_addr = addr_compare(p_addr1, p_addr2);

    
# 360 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
   _Bool 
# 360 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
        id_addrs = ((p_addr1->addr_type != 0x02)
                    && (p_addr1->addr_type != 0x03)
                    && (p_addr2->addr_type != 0x02)
                    && (p_addr2->addr_type != 0x03));
...
# 460 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    ...
    return (memcmp(p_master_id1->rand, p_master_id2->rand, 8) == 0);
}
...
ret_code_t im_peer_free(pm_peer_id_t peer_id)
{
    ...
    if ((conn_handle != 0xFFFF) && (ret == ((0x0) + 0)))
    {
        peer_id_set(conn_handle, 0xFFFF);
    }
    return ret;
}
...
# 605 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    ...
    for (uint32_t i = 0; i < peer_cnt; i++)
    {
        ...
        if (copy_irks)
        {
            memcpy(&p_gap_irks[i], bond_data.peer_ble_id.id_info.irk, 16);
            (*p_irk_cnt)++;
        }
    }
                                         ...
                                         uint32_t peer_cnt)
{
    ...
    ble_gap_id_key_t keys[(8)];
    ble_gap_id_key_t const * key_ptrs[(8)];
...
# 669 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    ...
    return sd_ble_gap_device_identities_set(key_ptrs, 
# 708 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
                                                     0
# 708 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
                                                         , peer_cnt);
...
# 750 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
                       0
# 750 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
                           ) && (m_wlisted_peer_cnt > *p_addr_cnt)) ||
        ((p_irk_cnt != 
# 751 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
                       0
# 751 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
                           ) && (m_wlisted_peer_cnt > *p_irk_cnt)))
    {
...
# 777 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
                       ) || (peer_cnt == 0))
    {
        ...
        return sd_ble_gap_whitelist_set(
# 784 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
                                       0
# 784 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
                                           , 0);
    ...
    ble_gap_addr_t const * addr_ptrs[(8)];
    ble_gap_addr_t addrs[(8)];

    memset(addrs, 0x00, sizeof(addrs));


    ret = peers_id_keys_get(p_peers, peer_cnt, addrs, &wlist_addr_cnt, 
# 802 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c" 3 4
                                                                      0
# 802 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
                                                                          , 
...
void ah(uint8_t const * p_k, uint8_t const * p_r, uint8_t * p_local_hash)
{
    ...
    for (uint32_t i = 0; i < (16); i++)
    {
        ecb_hal_data.key[i] = p_k[(16) - 1 - i];
    }

    memset(ecb_hal_data.cleartext, 0, (16) - (3));

    for (uint32_t i = 0; i < (3); i++)
    {
        ecb_hal_data.cleartext[(16) - 1 - i] = p_r[i];
    }
    ...
    for (uint32_t i = 0; i < (3); i++)
    {
        p_local_hash[i] = ecb_hal_data.ciphertext[(16) - 1 - i];
    }
}
...
# 881 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\id_manager.c"
    ...
    memcpy(hash, p_addr->addr, (3));
    memcpy(prand, &p_addr->addr[(3)], (3));
    ah(p_irk->irk, prand, local_hash);

    return (memcmp(hash, local_hash, (3)) == 0);
}
