...
# 56 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
    ...
    if ((p_qwr->initialized == 0xDE))
    {
        return ((0x0) + 8);
    }

    p_qwr->error_handler = p_qwr_init->error_handler;
    p_qwr->initialized = 0xDE;
    p_qwr->conn_handle = 0xFFFF;
# 73 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
    return ((0x0) + 0);
}
# 156 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
...
# 159 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
    ...
    do { if (!(((p_qwr->initialized == 0xDE)))) { return ((0x0) + 8); } } while (0);
...
static void user_mem_reply(nrf_ble_qwr_t * p_qwr)
{
    if (p_qwr->is_user_mem_reply_pending)
    {
        ...
        err_code = sd_ble_user_mem_reply(p_qwr->conn_handle, 
# 176 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c" 3 4
                                                            0
# 176 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
                                                                );
        ...
        if (err_code == ((0x0) + 0))
        {
            p_qwr->is_user_mem_reply_pending = 
# 182 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c" 3 4
                                              0
# 182 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
                                                   ;
...
{
    if ((p_common_evt->params.user_mem_request.type == 0x01) &&
                                    ...
                                    ble_gatts_evt_t const * p_gatts_evt)
{
    ...
    if ((p_auth_req->request.write.op != 0x04) &&
        (p_auth_req->request.write.op != 0x06) &&
        (p_auth_req->request.write.op != 0x05))
    {
        return;
    }
    ...
    if (p_auth_req->request.write.op == 0x05)
    {
...
# 448 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
    ...
    do { if (!((((p_qwr->initialized == 0xDE))))) { return ; } } while (0);
