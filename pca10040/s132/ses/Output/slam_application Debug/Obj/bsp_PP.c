...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c" 2
...
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp_config.h" 1
# 48 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c" 2
...
static 
# 57 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c" 3 4
      _Bool 
# 57 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
                       m_leds_clear = 
# 57 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c" 3 4
    ...
    if (button < 4)
    {
        switch (button_action)
        {
            case 1:
                ...
                {
                    err_code = app_timer_start(m_bsp_button_tmr, (uint32_t)(((((1000))*1000) + ((1000) / 2)) / (1000)), (void*)&current_long_push_pin_no);
                    if (err_code == ((0x0) + 0))
                    {
...
# 220 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
    ...
    switch (indicate)
    {
        ...
        case BSP_INDICATE_ADVERTISING:
            ...
            m_stable_state = indicate;
            err_code = app_timer_start(m_bsp_leds_tmr, (uint32_t)((((next_delay)*1000) + ((1000) / 2)) / (1000)), 
# 250 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c" 3 4
                                                                                         0
# 250 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
                                                                                             );
...
# 314 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
        ...
        case BSP_INDICATE_BONDING:
            ...
            m_stable_state = indicate;
            err_code =
                app_timer_start(m_bsp_leds_tmr, (uint32_t)((((100)*1000) + ((1000) / 2)) / (1000)), 
# 323 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c" 3 4
                                                                                  0
# 323 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
                                                                                      );
...
# 333 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
            ...
            err_code = app_timer_start(m_bsp_leds_tmr, (uint32_t)((((100)*1000) + ((1000) / 2)) / (1000)), 
# 335 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c" 3 4
                                                                                         0
# 335 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
                                                                                             );
...
# 340 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
                              ;
            bsp_board_led_invert(1);
            err_code = app_timer_start(m_bsp_leds_tmr, (uint32_t)((((500)*1000) + ((1000) / 2)) / (1000)), 
# 342 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c" 3 4
                                                                                            0
# 342 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\bsp\\bsp.c"
                                                                                                );
            ...
            if (next_delay && (err_code == ((0x0) + 0)))
            {
                if (next_delay > 1)
                {
                    err_code = app_timer_start(m_bsp_alert_tmr,
                                               (uint32_t)((((((uint16_t)next_delay * 200))*1000) + ((1000) / 2)) / (1000)),
