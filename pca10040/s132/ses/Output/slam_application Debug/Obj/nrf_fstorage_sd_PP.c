...
# 49 "../../../../../../components/libraries/atomic_fifo/nrf_atfifo.h"
...
_Bool 
# 118 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
    nrf_fstorage_sdh_req_handler(nrf_sdh_req_evt_t, void *);
...
static nrf_fstorage_sd_op_t m_fifo_data[(4)+1]; const nrf_log_module_const_data_t m_nrf_log_atfifo_m_fifo_logs_data_const __attribute__ ((section("." "log_const_data_atfifo_m_fifo"))) __attribute__((used)) = { .p_module_name = "atfifo.m_fifo", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0 ? 3 : NRF_LOG_SEVERITY_NONE), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_atfifo_m_fifo_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_atfifo_m_fifo"))) __attribute__((used)); static nrf_atfifo_t m_fifo_inst = { .p_buf = 
# 136 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c" 3 4
0
# 136 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
, .p_log = &m_nrf_log_atfifo_m_fifo_logs_data_dynamic, }; static nrf_atfifo_t * const m_fifo = &m_fifo_inst;


_Static_assert(1, "NRF_SDH_SOC_ENABLED not set!"); _Static_assert(0 < 2, "Priority level unavailable."); static nrf_sdh_soc_evt_observer_t m_sys_obs __attribute__ ((section("." "sdh_soc_observers0"))) __attribute__((used)) = { .handler = nrf_fstorage_sys_evt_handler, .p_context = 
# 139 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c" 3 4
0 
# 139 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
};
...
_Static_assert(1, "NRF_SDH_ENABLED not set!"); _Static_assert(0 < 2, "Priority level unavailable."); nrf_sdh_req_observer_t const m_req_obs __attribute__ ((section("." "sdh_req_observers0"))) __attribute__((used)) =
{
    .handler = nrf_fstorage_sdh_req_handler,
};


_Static_assert(1, "NRF_SDH_ENABLED not set!"); _Static_assert(0 < 2, "Priority level unavailable."); static nrf_sdh_state_observer_t const m_state_obs __attribute__ ((section("." "sdh_state_observers0"))) __attribute__((used)) =
{
...
static uint32_t write_execute(nrf_fstorage_sd_op_t const * p_op)
{
    ...
    chunk_len = ((p_op->write.len - p_op->write.offset) < (4096) ? (p_op->write.len - p_op->write.offset) : (4096));
    chunk_len = ((1) < (chunk_len / m_flash_info.program_unit) ? (chunk_len / m_flash_info.program_unit) : (1));
...
# 246 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
    ...
    switch (rc)
    {
        case ((0x0) + 0):
        {
            ...
            {
                nrf_fstorage_sys_evt_handler(NRF_EVT_FLASH_OPERATION_SUCCESS, 
# 277 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c" 3 4
                                                                             0
# 277 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
                                                                                 );
...
# 314 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c" 3 4
      _Bool 
# 314 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
           on_operation_success(nrf_fstorage_sd_op_t * const p_op)
{
    ...
    switch (p_op->op_code)
    {
        case NRF_FSTORAGE_OP_WRITE:
        {
            ...
            uint32_t const chunk_len = ((p_op->write.len - p_op->write.offset) < (4096) ? (p_op->write.len - p_op->write.offset) : (4096))
                                                                          ;
...
# 356 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c" 3 4
      _Bool 
# 356 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
           on_operation_failure(nrf_fstorage_sd_op_t const * p_op)
{
    ((void)(p_op));

    m_flags.retries++;

    if (m_flags.retries > 8)
    {
...
static ret_code_t init(nrf_fstorage_t * p_fs, void * p_param)
{
    ...
    if (!nrf_atomic_flag_set_fetch(&m_flags.initialized))
    {
        ...
        (void) nrf_atfifo_init( m_fifo, m_fifo_data, sizeof(m_fifo_data), sizeof(m_fifo_data[0]) );
    }
...
_Bool 
# 582 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
    nrf_fstorage_sdh_req_handler(nrf_sdh_req_evt_t req, void * p_context)
{
    ((void)(req));
    ((void)(p_context));
