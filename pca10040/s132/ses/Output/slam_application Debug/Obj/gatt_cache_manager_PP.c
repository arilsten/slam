...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 2
...
# 1 "../../../../../../components/libraries/util/sdk_errors.h" 1
# 45 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.h" 2
...
static 
# 68 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
      _Bool 
# 68 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
                                     m_module_initialized;
static uint8_t m_db_update_in_progress_mutex;
static ble_conn_state_user_flag_id_t m_flag_local_db_update_pending;
static ble_conn_state_user_flag_id_t m_flag_local_db_apply_pending;
static ble_conn_state_user_flag_id_t m_flag_service_changed_pending;
static ble_conn_state_user_flag_id_t m_flag_service_changed_sent;


    _Static_assert(1 || !1, "PM_SERVICE_CHANGED_ENABLED should be enabled if NRF_SDH_BLE_SERVICE_CHANGED is enabled.")
                                                                                                           ;
# 86 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
...
# 110 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
      _Bool 
# 110 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
           cccd_written(ble_gatts_evt_write_t const * p_write_evt)
{
    return ( (p_write_evt->op == 0x01)
             && (p_write_evt->uuid.type == 0x01)
             && (p_write_evt->uuid.uuid == 0x2902)
           );
}
...
# 204 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
static inline void local_db_update(uint16_t conn_handle, 
# 204 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
                                                          _Bool 
# 204 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
                                                               update)
...
# 218 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
      _Bool 
# 218 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
           local_db_update_in_evt(uint16_t conn_handle)
{
...
{
    ((void)(ble_conn_state_for_each_set_user_flag(m_flag_local_db_apply_pending, apply_pending_handle, 
# 332 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
   0
# 332 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
   )))
...
{
    ((void)(ble_conn_state_for_each_set_user_flag(m_flag_local_db_update_pending, db_update_pending_handle, 
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
   0
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
   )))
...
{
    ((void)(ble_conn_state_for_each_set_user_flag(m_flag_service_changed_pending, sc_send_pending_handle, 
# 377 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
   0
# 377 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
   )))
...
void gcm_im_evt_handler(pm_evt_t * p_event)
{
    switch (p_event->evt_id)
    {
        case PM_EVT_BONDED_PEER_CONNECTED:
            ...
            {
                ble_conn_state_user_flag_set(p_event->conn_handle, m_flag_service_changed_pending, 
# 398 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
                                                                                                  1
# 398 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
                                                                                                      );
            ...
            case PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING:
            {
                ...
                if (err_code == ((0x0) + 0))
                {
                    if (*peer_data.p_service_changed_pending)
                    {
                        ...
                        if (conn_handle != 0xFFFF)
                        {
                            ble_conn_state_user_flag_set(conn_handle, m_flag_service_changed_pending, 
# 448 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
                                                                                                     1
# 448 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
                                                                                                         );
...
void gcm_ble_evt_handler(ble_evt_t const * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GATTS_EVT_SC_CONFIRM:
        {
            ...
            ble_conn_state_user_flag_set(conn_handle, m_flag_service_changed_sent, 
# 526 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
                                                                                  0
# 526 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
                                                                                       );
...
void gcm_local_database_has_changed(void)
{
    ...
    {
        if (im_peer_id_get_by_conn_handle(conn_handles.conn_handles[i]) == 0xFFFF)
        {
            ble_conn_state_user_flag_set(conn_handles.conn_handles[i], m_flag_service_changed_pending, 
# 571 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c" 3 4
                                                                                                      1
# 571 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\gatt_cache_manager.c"
                                                                                                          );
