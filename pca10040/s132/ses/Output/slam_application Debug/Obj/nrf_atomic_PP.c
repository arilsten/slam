...
static inline 
# 293 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic\\nrf_atomic_internal.h" 3 4
             _Bool 
# 293 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic\\nrf_atomic_internal.h"
                  nrf_atomic_internal_cmp_exch(nrf_atomic_u32_t * p_data,
                                                uint32_t * p_expected,
                                                uint32_t value)
{
...
uint32_t nrf_atomic_u32_fetch_store(nrf_atomic_u32_t * p_data, uint32_t value)
{
    ...
    uint32_t old_val;
    uint32_t new_val;
    { uint32_t str_res; __asm volatile( "1:     ldrex   %[""old_val""], [%[""p_data""]]\n" "mov %[""new_val""], %[""value""]\n" "       strex   %[str_res], %[""new_val""], [%[""p_data""]]\n" "       teq     %[str_res], #0\n" "       bne.n     1b" : [old_val]"=&r" (old_val), [new_val]"=&r" (new_val), [str_res]"=&r" (str_res) : [p_data]"r" (p_data), [value]"r" (value) : "cc"); ((void)(str_res)); };
