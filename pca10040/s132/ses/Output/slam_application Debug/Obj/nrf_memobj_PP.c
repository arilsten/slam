...
# 56 "../../../../../../components/libraries/balloc/nrf_balloc.h"
# 1 "../config/sdk_config.h" 1
# 57 "../../../../../../components/libraries/balloc/nrf_balloc.h" 2
...
_Static_assert(sizeof(memobj_header_t) == sizeof(uint32_t), "unspecified message");
...
nrf_memobj_t * nrf_memobj_alloc(nrf_memobj_pool_t const * p_pool,
                                size_t size)
{
    uint32_t bsize = (uint32_t)((nrf_balloc_t const *)p_pool)->block_size - sizeof(memobj_header_t);
    uint8_t num_of_chunks = (uint8_t)(((size + sizeof(memobj_head_header_t)) + (bsize) - 1) / (bsize));
                          ...
                          read)
{
    ...
    uint8_t chunks_expected = ((((offset + sizeof(memobj_head_header_fields_t) + len)) + (space_in_chunk) - 1) / (space_in_chunk))
                                                      ;
    ((void)(chunks_expected));
    if (1) { if (p_head->head_header.data.fields.chunk_cnt >= chunks_expected) { } else { assert_nrf_callback((uint16_t)186, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\experimental_memobj\\nrf_memobj.c"); } };
                      ...
                      uint32_t offset)
{
    ...
    memobj_op(p_obj, p_data, len, offset, 
# 222 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\experimental_memobj\\nrf_memobj.c" 3 4
                                         0
# 222 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\experimental_memobj\\nrf_memobj.c"
                                              );
