...
# 596 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.h" 3 4
       0
# 596 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.h"
       ) { } else { assert_nrf_callback((uint16_t)596, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.h"); } };
    }
    else if ((!(nrf_drv_uart_use_easy_dma[p_instance->inst_idx])))
    {
...
# 609 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.h" 3 4
       0
# 609 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.h"
       ) { } else { assert_nrf_callback((uint16_t)609, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.h"); } };
    }
    else if ((!(nrf_drv_uart_use_easy_dma[p_instance->inst_idx])))
    {
...
static nrf_uart_event_handler_t m_handlers[1];
static void * m_contexts[1];
                             ...
                             nrf_uart_event_handler_t event_handler)
{
    ...
    if ((nrf_drv_uart_use_easy_dma[p_instance->inst_idx]))
    {
        result = nrfx_uarte_init(&p_instance->uarte,
                                 ...
                                 event_handler ? uarte_evt_handler : 
# 126 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.c" 3 4
                                                                    0
# 126 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.c"
                                                                        );
    ...
    else if ((!(nrf_drv_uart_use_easy_dma[p_instance->inst_idx])))
    {
        result = nrfx_uart_init(&p_instance->uart,
                                ...
                                event_handler ? uart_evt_handler : 
# 132 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.c" 3 4
                                                                  0
# 132 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_uart.c"
                                                                      );
