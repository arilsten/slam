...
# 7 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\software\\DebugFunctions.c" 2
...
static void ir_task(void *arg) {
    ...
    for (;;) {
        ...
        sprintf(strIR2, "ir2: %i", sensor2);
        display_text_on_line(3, strIR2);
        sprintf(strIR3, "ir3: %i", sensor3);
        display_text_on_line(4, strIR3);
        sprintf(strIR4, "ir4: %i", sensor4);
...
# 148 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\software\\DebugFunctions.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
            ...
            xQueueGenericSend( ( queue_microsd ), ( &write ), ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
