...
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
# 40 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.h" 1
...
# 53 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.h" 2
...
# 150 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.h" 3 4
   _Bool 
# 150 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.h"
                                include_appearance;
    uint8_t flags;
...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c" 2
# 1 "../../../../../../components/softdevice/s132/headers/ble_gap.h" 1
# 42 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c" 2
                                         ...
                                         uint16_t max_size)
{
    ...
    if (((*p_offset) + ((1UL + 1UL) + ((6) + 1UL))) > max_size)
    {
        return ((0x0) + 12);
    }
    ...
    p_encoded_data[*p_offset] = (uint8_t)(1UL +
                                               ((6) + 1UL));
    *p_offset += 1UL;
    p_encoded_data[*p_offset] = 0x1B;
    *p_offset += 1UL;
    memcpy(&p_encoded_data[*p_offset], &device_addr.addr[0], (6));
    *p_offset += (6);
    if (0x00 == device_addr.addr_type)
    {
        p_encoded_data[*p_offset] = 0UL;
    }
    else
    {
        p_encoded_data[*p_offset] = 1UL;
    }
    *p_offset += 1UL;
                              ...
                              uint16_t max_size)
{
    ...
    if ( (((*p_offset) + (1UL + 1UL)) > max_size) ||
         ( (BLE_ADVDATA_SHORT_NAME == p_advdata->name_type) &&
           (((*p_offset) + (1UL + 1UL) + p_advdata->short_name_len) > max_size)))
    {
        return ((0x0) + 12);
    }

    rem_adv_data_len = max_size - (*p_offset) - (1UL + 1UL);
    actual_length = rem_adv_data_len;


    err_code = sd_ble_gap_device_name_get(&p_encoded_data[(*p_offset) + (1UL + 1UL)],
                                          &actual_length);
    do { uint32_t _err_code = (uint32_t) (err_code); if (_err_code != ((0x0) + 0)) { return _err_code; } } while(0);
    ...
    if (actual_length > (0x00FF - 1UL))
    {
        return ((0x0) + 12);
    }


    p_encoded_data[*p_offset] = (uint8_t)(1UL + actual_length);
    *p_offset += 1UL;
                                    ...
                                    uint16_t max_size)
{
    ...
    if (((*p_offset) + ((1UL + 1UL) + 2UL)) > max_size)
    {
        return ((0x0) + 12);
    }
    ...
    p_encoded_data[*p_offset] = (uint8_t)(1UL + 2UL);
    *p_offset += 1UL;
    p_encoded_data[*p_offset] = 0x19;
    *p_offset += 1UL;
                               ...
                               uint16_t max_size)
{
    ...
    if (((*p_offset) + ((1UL + 1UL) + 1UL)) > max_size)
    {
        return ((0x0) + 12);
    }


    p_encoded_data[*p_offset] = (uint8_t)(1UL + 1UL);
    *p_offset += 1UL;
    p_encoded_data[*p_offset] = 0x01;
    *p_offset += 1UL;
...
# 254 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c" 3 4
   _Bool 
# 254 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
            is_heading_written = 
# 254 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c" 3 4
...
# 265 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
        ...
        {
            uint8_t heading_bytes = (is_heading_written) ? 0 : (1UL + 1UL);
                                  ...
                                  uint16_t max_size)
{
    ...
    if (((*p_offset) + ((1UL + 1UL) + 4UL)) > max_size)
    {
        return ((0x0) + 12);
    }
    ...
    p_encoded_data[*p_offset] = (uint8_t)(1UL + 4UL);
    *p_offset += 1UL;
    p_encoded_data[*p_offset] = 0x12;
    *p_offset += 1UL;
...
static ret_code_t manuf_specific_data_encode(const ble_advdata_manuf_data_t * p_manuf_sp_data,
                                             ...
                                             uint16_t max_size)
{
    uint32_t data_size = 2UL + p_manuf_sp_data->data.size;


    if (((*p_offset) + (1UL + 1UL) + data_size) > max_size)
    {
        return ((0x0) + 12);
    }


    if (data_size > (0x00FF - 1UL))
    {
        return ((0x0) + 12);
    }


    p_encoded_data[*p_offset] = (uint8_t)(1UL + data_size);
    *p_offset += 1UL;
    p_encoded_data[*p_offset] = 0xFF;
    *p_offset += 1UL;
    ...
    *p_offset += uint16_encode(p_manuf_sp_data->company_identifier, &p_encoded_data[*p_offset]);
    ...
    {
        if (p_manuf_sp_data->data.p_data == 
# 441 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c" 3 4
                                           0
# 441 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
                                               )
                                      ...
                                      uint16_t max_size)
{
    ...
    if (p_advdata->p_service_data_array == 
# 461 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c" 3 4
                                          0
# 461 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
                                              )
    ...
    for (i = 0; i < p_advdata->service_data_count; i++)
    {
        ...
        data_size = 2UL + p_service_data->data.size;
...
# 581 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
    ...
    if (p_advdata->p_manuf_specific_data != 
# 588 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c" 3 4
                                           0
# 588 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
                                               )
...
# 770 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\common\\ble_advdata.c"
    ...
    for (uint8_t i = 0; (i < 2) && (data_offset == 0); i++)
    {
                                 ...
                                 uint16_t const * p_target_appearance)
{
    ...
    appearance_len = ble_advdata_search(p_encoded_data, data_len, &data_offset, 0x19);
