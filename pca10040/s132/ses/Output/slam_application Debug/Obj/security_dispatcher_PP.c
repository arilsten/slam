...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 2
...
# 1 "../../../../../../components/libraries/util/sdk_errors.h" 1
# 45 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.h" 2
...
# 52 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 2
# 60 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
_Static_assert((0 == 0) || 0, "Peer Manager Central operation must be enabled when using central links.")
                                                                                          ;
...
static 
# 73 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
      _Bool 
# 73 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
...
# 84 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
               _Bool 
# 84 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                    sec_procedure(uint16_t conn_handle)
{
...
# 99 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
               _Bool 
# 99 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                    peer_created(uint16_t conn_handle)
{
...
# 104 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
               _Bool 
# 104 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                    allow_repairing(uint16_t conn_handle)
{
                             ...
                             uint8_t error_src)
{
    ...
    ble_conn_state_user_flag_set(conn_handle, m_flag_sec_proc, 
# 193 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
                                                              0
# 193 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                                                                   );
                            ...
                            uint8_t error_src)
{
    ...
    if (peer_created(conn_handle))
    {
        ...
        err_code = im_peer_free(peer_id);
        ((void)(err_code));
    }
    else if(peer_id != 0xFFFF)
    {
...
# 244 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
static inline void encryption_failure(uint16_t conn_handle,
                                        pm_sec_error_code_t error,
                                        uint8_t error_src)
{
                           ...
                           pm_conn_sec_procedure_t procedure)
{
    ...
    if (success)
    {
        ...
        ble_conn_state_user_flag_set(conn_handle, m_flag_sec_proc_new_peer, 
# 297 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
                                                                           0
# 297 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                                                                                );
...
# 320 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
    ...
    else
    {
        if (new_peer_created)
        {
            ret_code_t err_code = im_peer_free(peer_id);
            ((void)(err_code));
        }
    }
}
...
# 359 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
    ...
    err_code = sd_ble_gap_sec_info_reply(p_gap_evt->conn_handle, p_enc_info, 
# 379 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
                                                                            0
# 379 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                                                                                , 
...
# 379 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
    ...
    if (err_code != ((0x0) + 0))
    {
        sec_proc_housekeeping(p_gap_evt->conn_handle, peer_id, 
# 383 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
                                                              0
# 383 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                                                                   , 
...
static void disconnect_process(ble_gap_evt_t const * p_gap_evt)
{
    pm_sec_error_code_t error = (p_gap_evt->params.disconnected.reason
                                        == 0x3D)
                                ? (0x1000 + 0x3D) : (0x1000 + 0x100);

    link_secure_failure(p_gap_evt->conn_handle, error, 0x00);
}
# 445 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
...
{
    if (ble_conn_state_role(p_gap_evt->conn_handle) == 0x1)
    {
        sec_proc_start(p_gap_evt->conn_handle,
...
# 498 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
    ...
    {
        pm_peer_id_t duplicate_peer_id = 0xFFFF;
        data_stored = 
# 503 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
                     1
# 503 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
...
# 541 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
        ...
        if ((duplicate_peer_id != 0xFFFF) && peer_created(conn_handle))
        {
...
# 628 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
            ...
            evt.params.conn_sec_succeeded.data_stored = 
# 635 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
                                                       0
# 635 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                                                            ;
                            ...
                            ble_gap_lesc_p256_pk_t * p_public_key)
{
    ...
    ret_code_t err_code = ((0x0) + 0);
    uint8_t sec_status = 0x00;
    
# 762 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
   _Bool 
# 762 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                        new_peer_created = peer_created(conn_handle);
...
# 801 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
        ...
        else if (role == 0x1 && !allow_repairing(conn_handle))
        {
        ...
        if ((sec_status != 0x85) && (err_code == ((0x0) + 0)))
        {
    ...
    if (err_code == ((0x0) + 0))
    {
        ...
        {
            err_code = sd_ble_gap_sec_params_reply(conn_handle, sec_status, 
# 836 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c" 3 4
                                                                           0
# 836 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\peer_manager\\security_dispatcher.c"
                                                                               , &sec_keyset);
    ...
    sec_proc_housekeeping(conn_handle,
                          peer_id,
                          (err_code == ((0x0) + 0)) && (sec_status == 0x00),
                          new_peer_created);
