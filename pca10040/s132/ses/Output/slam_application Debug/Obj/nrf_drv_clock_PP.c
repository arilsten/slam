...
# 53 "../../../../../../components/softdevice/common/nrf_sdh_soc.h"
...
# 54 "../../../../../../components/softdevice/common/nrf_sdh_soc.h" 2
...
{
# 121 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
    if (1) { if (!nrf_sdh_is_enabled()) { } else { assert_nrf_callback((uint16_t)121, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
# 186 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_clock_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)((uint32_t)__func__), (uint32_t)((uint32_t)nrf_strerror_get(err_code))); } }
...
void nrf_drv_clock_lfclk_request(nrf_drv_clock_handler_item_t * p_handler_item)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)231, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    ...
    if (1) { if (m_clock_cb.lfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)259, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
}

void nrf_drv_clock_lfclk_release(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)264, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    if (1) { if (m_clock_cb.lfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)265, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
# 276 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
    nrf_drv_clock_lfclk_is_running(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)278, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
void nrf_drv_clock_hfclk_request(nrf_drv_clock_handler_item_t * p_handler_item)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)292, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    ...
    if (1) { if (m_clock_cb.hfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)320, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
}

void nrf_drv_clock_hfclk_release(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)325, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    if (1) { if (m_clock_cb.hfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)326, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
# 337 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
    nrf_drv_clock_hfclk_is_running(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)339, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
# 409 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
    ...
    ((void)(handler));
    err_code = ((0x0) + 15);
    if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_clock_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)((uint32_t)__func__), (uint32_t)((uint32_t)nrf_strerror_get(err_code))); } }
...
_Static_assert(1, "NRF_SDH_SOC_ENABLED not set!"); _Static_assert(0 < 2, "Priority level unavailable."); static nrf_sdh_soc_evt_observer_t m_soc_evt_observer __attribute__ ((section("." "sdh_soc_observers0"))) __attribute__((used)) = { .handler = soc_evt_handler, .p_context = 
# 548 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c" 3 4
0 
# 548 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
};
...
# 573 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
        ...
        case NRF_SDH_EVT_STATE_DISABLED:
            ...
            if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)579, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
            nrfx_clock_enable();
...
_Static_assert(1, "NRF_SDH_ENABLED not set!"); _Static_assert(0 < 2, "Priority level unavailable."); static nrf_sdh_state_observer_t const m_sd_state_observer __attribute__ ((section("." "sdh_state_observers0"))) __attribute__((used)) =
{
