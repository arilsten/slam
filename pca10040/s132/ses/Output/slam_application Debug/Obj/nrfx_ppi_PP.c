...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_PPI_logs_data_dynamic;
...
const nrf_log_module_const_data_t m_nrf_log_PPI_logs_data_const __attribute__ ((section("." "log_const_data_PPI"))) __attribute__((used)) = { .p_module_name = "PPI", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_PPI_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_PPI"))) __attribute__((used));
# 49 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c" 2


static uint32_t m_channels_allocated;
static uint8_t m_groups_allocated;
# 62 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
...
# 76 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c" 3 4
               _Bool 
# 76 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
                    is_programmable_app_channel(nrf_ppi_channel_t channel)
{
    return ((((uint32_t)0x000FFFFFuL & ~((0xFFFE0000uL | 0uL | 0uL))) & nrfx_ppi_channel_to_mask(channel)) != 0);
}
# 90 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
static inline 
# 90 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c" 3 4
               _Bool 
# 90 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
                    are_app_channels(uint32_t channel_mask)
{

    return ((~(((uint32_t)0xFFFFFFFFuL & ~((0xFFFE0000uL | 0uL | 0uL)))) & channel_mask) == 0);
}
# 105 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
static inline 
# 105 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c" 3 4
               _Bool 
# 105 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
                    is_app_channel(nrf_ppi_channel_t channel)
{
...
# 120 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c" 3 4
               _Bool 
# 120 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
                    is_app_group(nrf_ppi_channel_group_t group)
{
    return (((((1uL << 6) - 1) & ~((0x0000000CuL))) & group_to_mask(group)) != 0);
}
# 134 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
static inline 
# 134 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c" 3 4
               _Bool 
# 134 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
                    is_allocated_channel(nrf_ppi_channel_t channel)
{
...
{
    m_channels_allocated &= ~((uint32_t)0xFFFFFFFFuL & ~((0xFFFE0000uL | 0uL | 0uL)));
}
# 179 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
static inline 
# 179 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c" 3 4
               _Bool 
# 179 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
                    is_allocated_group(nrf_ppi_channel_group_t group)
{
...
static inline void group_allocated_clr_all()
{
    m_groups_allocated &= ~(((1uL << 6) - 1) & ~((0x0000000CuL)));
}


void nrfx_ppi_free_all(void)
{
    uint32_t mask = (((1uL << 6) - 1) & ~((0x0000000CuL)));
    nrf_ppi_channel_group_t group;


    nrf_ppi_channels_disable(((uint32_t)0xFFFFFFFFuL & ~((0xFFFE0000uL | 0uL | 0uL))));
...
nrfx_err_t nrfx_ppi_channel_alloc(nrf_ppi_channel_t * p_channel)
{
    ...
    mask = ((uint32_t)0x000FFFFFuL & ~((0xFFFE0000uL | 0uL | 0uL)));
         ...
         mask &= ~nrfx_ppi_channel_to_mask(channel), channel++)
    {
        ...
        if (err_code == ((0x0) + 0))
        {
            if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_PPI_logs_data_dynamic.module_id << 16), "Allocated channel: %d.", (uint32_t)(channel)); } };
            break;
        }
    }

    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_PPI_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}
...
# 291 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_ppi.c"
    ...
    {
        nrf_ppi_channel_endpoint_setup(channel, eep, tep);
        if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_PPI_logs_data_dynamic.module_id << 16), "Assigned channel: %d, event end point: %x, task end point: %x.", (uint32_t)(channel), (uint32_t)(eep), (uint32_t)(tep)); } }
...
nrfx_err_t nrfx_ppi_channel_fork_assign(nrf_ppi_channel_t channel, uint32_t fork_tep)
{
    ...
    {
        nrf_ppi_fork_endpoint_setup(channel, fork_tep);
        if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_PPI_logs_data_dynamic.module_id << 16), "Fork assigned channel: %d, task end point: %d.", (uint32_t)(channel), (uint32_t)(fork_tep)); } };
    }
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_PPI_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
...
nrfx_err_t nrfx_ppi_group_alloc(nrf_ppi_channel_group_t * p_group)
{
    ...
    for (group = NRF_PPI_CHANNEL_GROUP0; mask != 0; mask &= ~group_to_mask(group), group++)
    {
        ...
        if (err_code == ((0x0) + 0))
        {
            if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_PPI_logs_data_dynamic.module_id << 16), "Allocated group: %d.", (uint32_t)(group)); } };
            break;
        }
    }
