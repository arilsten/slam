...
# 45 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c" 2

# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.h" 1
...
# 611 "../../../../../../components/softdevice/s132/headers/ble.h"
 ;
# 76 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.h" 2
...
# 120 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.h" 3 4
   _Bool 
# 120 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.h"
...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_ble_bas_logs_data_dynamic;
...
# 60 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c" 2
const nrf_log_module_const_data_t m_nrf_log_ble_bas_logs_data_const __attribute__ ((section("." "log_const_data_ble_bas"))) __attribute__((used)) = { .p_module_name = "ble_bas", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_ble_bas_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_ble_bas"))) __attribute__((used));
# 71 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c"
static void on_write(ble_bas_t * p_bas, ble_evt_t const * p_ble_evt)
{
    ...
    if ( (p_evt_write->handle == p_bas->battery_level_handles.cccd_handle)
        && (p_evt_write->len == 2))
    {
        if (p_bas->evt_handler == 
# 83 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c" 3 4
                                 0
# 83 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c"
                                     )
        {
...
# 165 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c"
                                   ;
    char_md.p_cccd_md = (p_bas->is_notification_supported) ? &cccd_md : 
# 166 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c" 3 4
                                                                               0
# 166 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c"
                                                                                   ;
...
# 167 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c"
    ...
    do { ble_uuid.type = 0x01; ble_uuid.uuid = 0x2A19;} while(0);
...
# 199 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c"
    ...
    {
        p_bas->report_ref_handle = 0x0000;
    }
...
# 244 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c"
    ...
    p_bas->battery_level_last = 255;


    do { ble_uuid.type = 0x01; ble_uuid.uuid = 0x180F;} while(0);

    err_code = sd_ble_gatts_service_add(0x01, &ble_uuid, &p_bas->service_handle);
                                            ...
                                            uint16_t conn_handle)
{
    ...
    if (err_code == ((0x0) + 0))
    {
        if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_ble_bas_logs_data_dynamic.module_id << 16), "Battery notification has been sent using conn_handle: 0x%04X", (uint32_t)(conn_handle)); } };
    }
    else
    {
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_ble_bas_logs_data_dynamic.module_id << 16), "Error: 0x%08X while sending notification with conn_handle: 0x%04X", (uint32_t)(err_code), (uint32_t)(conn_handle)); } }
...
# 298 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_bas\\ble_bas.c"
    ...
    if (battery_level != p_bas->battery_level_last)
    {
        ...
        err_code = sd_ble_gatts_value_set(0xFFFF,
                                          p_bas->battery_level_handles.value_handle,
                                          &gatts_value);
        if (err_code == ((0x0) + 0))
        {
            if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_ble_bas_logs_data_dynamic.module_id << 16), "Battery level has been updated: %d%%", (uint32_t)(battery_level)); } }
        ...
        {
            if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_ble_bas_logs_data_dynamic.module_id << 16), "Error during battery level update: 0x%08X", (uint32_t)(err_code)); } }
                ...
                for (uint32_t i = 0; i < conn_handles.len; i++)
                {
                    if (ble_conn_state_status(conn_handles.conn_handles[i]) == BLE_CONN_STATUS_CONNECTED)
                    {
                        ...
                        else
                        {
                            ...
                            ((void)(battery_notification_send(&hvx_params, conn_handles.conn_handles[i])))
                                                                                                        ;
                        }
                    }
                }
