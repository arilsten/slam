...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c" 2
...
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer.h" 1
# 70 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer.h"
# 1 "../../../../../../components/libraries/util/app_error.h" 1
# 71 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer.h" 2
...
# 82 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c" 3 4
   _Bool 
# 82 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
                               active;
}app_timer_info_t;
# 92 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
_Static_assert(sizeof(app_timer_info_t) <= sizeof(app_timer_t), "unspecified message");
# 102 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
static void app_timer_callback(TimerHandle_t xTimer)
{
    app_timer_info_t * pinfo = (app_timer_info_t*)(pvTimerGetTimerID(xTimer));
    if (1) { if (pinfo->osHandle == xTimer) { } else { assert_nrf_callback((uint16_t)105, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"); } };
    if (1) { if (pinfo->func != 
# 106 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c" 3 4
   0
# 106 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
   ) { } else { assert_nrf_callback((uint16_t)106, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"); } };
...
# 136 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
                              )
    {
        ...
        if (mode == APP_TIMER_MODE_SINGLE_SHOT)
            timer_mode = ( ( BaseType_t ) 0 );
        else
            timer_mode = ( ( BaseType_t ) 1 );
...
# 167 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
    ...
    if (pinfo->active && (xTimerIsTimerActive(hTimer) != ( ( BaseType_t ) 0 )))
    {
    ...
    if (__get_IPSR() != 0)
    {
        BaseType_t yieldReq = ( ( BaseType_t ) 0 );
        if (xTimerGenericCommand( ( hTimer ), ( ( BaseType_t ) 9 ), ( timeout_ticks ), ( &yieldReq ), 0U ) != ( ( ( BaseType_t ) 1 ) ))
        {
            return ((0x0) + 4);
        }

        if ( xTimerGenericCommand( ( hTimer ), ( ( BaseType_t ) 6 ), ( xTaskGetTickCountFromISR() ), ( &yieldReq ), 0U ) != ( ( ( BaseType_t ) 1 ) ) )
        {
            return ((0x0) + 4);
        }

        if ( (yieldReq) != ( ( BaseType_t ) 0 ) ) do { ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICSR = (1UL << 28U); __SEV(); __DSB(); __ISB(); }while (0);
    }
    else
    {
        if (xTimerGenericCommand( ( hTimer ), ( ( BaseType_t ) 4 ), ( timeout_ticks ), 
# 196 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c" 3 4
           0
# 196 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
           , ( 2 ) ) != ( ( ( BaseType_t ) 1 ) ))
        ...
        if (xTimerGenericCommand( ( hTimer ), ( ( BaseType_t ) 1 ), ( xTaskGetTickCount() ), 
# 201 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c" 3 4
           0
# 201 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
           , ( 2 ) ) != ( ( ( BaseType_t ) 1 ) ))
...
# 216 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\timer\\app_timer_freertos.c"
    ...
    {
        BaseType_t yieldReq = ( ( BaseType_t ) 0 );
        if (xTimerGenericCommand( ( hTimer ), ( ( BaseType_t ) 8 ), 0, ( &yieldReq ), 0U ) != ( ( ( BaseType_t ) 1 ) ))
        {
            return ((0x0) + 4);
        }
        if ( (yieldReq) != ( ( BaseType_t ) 0 ) ) do { ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICSR = (1UL << 28U); __SEV(); __DSB(); __ISB(); }while (0);
