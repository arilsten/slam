                      ...
                      uint32_t FormatFlags)
{
    ...
    if ((((FormatFlags & (1u << 1)) == 0u) || (NumDigits != 0u)) &&
        ((FormatFlags & (1u << 0)) == 0u))
    {
        if (FieldWidth != 0u)
        {
    ...
    if (((FormatFlags & (1u << 1)) == (1u << 1)) &&
        ((FormatFlags & (1u << 0)) == 0u) && (NumDigits == 0u))
    {
        if (FieldWidth != 0u)
        {
            while ((FieldWidth != 0u) && (Width < FieldWidth))
...
{
    if (1) { if (p_ctx != 
# 318 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c" 3 4
   0
# 318 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c"
   ) { } else { assert_nrf_callback((uint16_t)318, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c"); } };

    if (1) { if (p_ctx->fwrite != 
# 320 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c" 3 4
   0
# 320 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c"
   ) { } else { assert_nrf_callback((uint16_t)320, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c"); } };
    if (1) { if (p_ctx->p_io_buffer != 
# 321 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c" 3 4
   0
# 321 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c"
   ) { } else { assert_nrf_callback((uint16_t)321, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c"); } };
    if (1) { if (p_ctx->io_buffer_size > 0) { } else { assert_nrf_callback((uint16_t)322, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fprintf\\nrf_fprintf_format.c"); } };
