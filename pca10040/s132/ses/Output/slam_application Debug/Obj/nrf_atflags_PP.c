...
# 44 "../../../../../../components/toolchain/cmsis/include/core_cm4.h"
...
# 45 "../../../../../../components/toolchain/cmsis/include/core_cm4.h" 2
...
# 54 "../../../../../../components/libraries/util/sdk_common.h"
...
void nrf_atflags_set(nrf_atflags_t * p_flags, uint32_t flag_index)
{
    uint32_t new_value = nrf_atomic_u32_or(&p_flags[((flag_index) / (sizeof(nrf_atflags_t) * 8))], (1UL << ((flag_index) % (sizeof(nrf_atflags_t) * 8))));
    ((void)(new_value));
}
...
# 72 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_flags\\nrf_atflags.c"
    nrf_atflags_fetch_set(nrf_atflags_t * p_flags, uint32_t flag_index)
{
    return (nrf_atomic_u32_fetch_or(&p_flags[((flag_index) / (sizeof(nrf_atflags_t) * 8))], (1UL << ((flag_index) % (sizeof(nrf_atflags_t) * 8))))
            & (1UL << ((flag_index) % (sizeof(nrf_atflags_t) * 8)))) != 0;
}


void nrf_atflags_clear(nrf_atflags_t * p_flags, uint32_t flag_index)
{
    uint32_t new_value = nrf_atomic_u32_and(&p_flags[((flag_index) / (sizeof(nrf_atflags_t) * 8))], ~(1UL << ((flag_index) % (sizeof(nrf_atflags_t) * 8))));
    ((void)(new_value));
}
...
# 86 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_flags\\nrf_atflags.c"
    nrf_atflags_fetch_clear(nrf_atflags_t * p_flags, uint32_t flag_index)
{
    return (nrf_atomic_u32_fetch_and(&p_flags[((flag_index) / (sizeof(nrf_atflags_t) * 8))], ~(1UL << ((flag_index) % (sizeof(nrf_atflags_t) * 8))))
            & (1UL << ((flag_index) % (sizeof(nrf_atflags_t) * 8)))) != 0;
}
...
# 93 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_flags\\nrf_atflags.c"
    nrf_atflags_get(nrf_atflags_t const * p_flags, uint32_t flag_index)
{
    return (p_flags[((flag_index) / (sizeof(nrf_atflags_t) * 8))] & (1UL << ((flag_index) % (sizeof(nrf_atflags_t) * 8)))) != 0;
}


uint32_t nrf_atflags_init(nrf_atflags_t * p_flags, uint32_t flags_array_len, uint32_t flag_count)
{
    uint32_t required_flags_array_len = ((flag_count - 1) / (sizeof(nrf_atflags_t) * 8)) + 1;
...
uint32_t nrf_atflags_find_and_set_flag(nrf_atflags_t * p_flags, uint32_t flag_count)
{
    for (uint32_t i = 0; i < ((flag_count - 1) / (sizeof(nrf_atflags_t) * 8)) + 1; i++)
    {

        uint32_t first_zero = __builtin_clz(__RBIT(~p_flags[i]));
        while (first_zero < 32)
        {
            ...
            first_zero = __builtin_clz(__RBIT(~p_flags[i]));
        }
    }
...
uint32_t nrf_atflags_find_and_clear_flag(nrf_atflags_t * p_flags, uint32_t flag_count)
{
    for (uint32_t i = 0; i < ((flag_count - 1) / (sizeof(nrf_atflags_t) * 8)) + 1; i++)
    {
        ...
        uint32_t first_one = __builtin_clz(__RBIT(p_flags[i]));
        while (first_one < 32)
        {
            ...
            first_one = __builtin_clz(__RBIT(p_flags[i]));
        }
    }
