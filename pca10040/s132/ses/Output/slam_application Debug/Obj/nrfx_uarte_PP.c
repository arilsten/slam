...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_UARTE_logs_data_dynamic;
...
const nrf_log_module_const_data_t m_nrf_log_UARTE_logs_data_const __attribute__ ((section("." "log_const_data_UARTE"))) __attribute__((used)) = { .p_module_name = "UARTE", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_UARTE_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_UARTE"))) __attribute__((used));
# 55 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c" 2
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
typedef struct
{
...
nrfx_err_t nrfx_uarte_init(nrfx_uarte_t const * p_instance,
                           ...
                           nrfx_uarte_event_handler_t event_handler)
{
    if (1) { if (p_config) { } else { assert_nrf_callback((uint16_t)188, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
# 260 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
                       ;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16), "Instance uninitialized: %d.", (uint32_t)(p_instance->drv_inst_idx)); } };
}
...
{
    uarte_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)269, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (p_data) { } else { assert_nrf_callback((uint16_t)270, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (length > 0) { } else { assert_nrf_callback((uint16_t)271, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (((((p_instance->drv_inst_idx) == NRFX_UARTE0_INST_IDX) && (((length) < (1U << 8)) && ((0) < (1U << 8)))) || 0)) { } else { assert_nrf_callback((uint16_t)272, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16), "Transfer tx_len: %d.", (uint32_t)(p_cb->tx_buffer_length)); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16), "Tx data:"); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_hexdump((((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16)), ((p_cb->p_tx_buffer)), ((p_cb->tx_buffer_length * sizeof(p_cb->p_tx_buffer[0])))); } }
                                                                                 ;
...
# 313 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}
                         ...
                         size_t length)
{
    ...
    if (1) { if (m_cb[p_instance->drv_inst_idx].state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)343, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (p_data) { } else { assert_nrf_callback((uint16_t)344, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (length > 0) { } else { assert_nrf_callback((uint16_t)345, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (((((p_instance->drv_inst_idx) == NRFX_UARTE0_INST_IDX) && (((length) < (1U << 8)) && ((0) < (1U << 8)))) || 0)) { } else { assert_nrf_callback((uint16_t)346, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
...
# 383 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16), "Transfer rx_len: %d.", (uint32_t)(length)); } };
...
# 490 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16), "TX transaction aborted."); } };
}

void nrfx_uarte_rx_abort(nrfx_uarte_t const * p_instance)
{
    nrf_uarte_task_trigger(p_instance->p_reg, NRF_UARTE_TASK_STOPRX);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UARTE_logs_data_dynamic.module_id << 16), "RX transaction aborted."); } };
}
...
void nrfx_uarte_0_irq_handler(void)
{
    uarte_irq_handler(((NRF_UARTE_Type *) 0x40002000UL), &m_cb[NRFX_UARTE0_INST_IDX]);
}
