...
StackType_t *pxPortInitialiseStack( StackType_t *pxTopOfStack, TaskFunction_t pxCode, void *pvParameters )
{
    ...
    *pxTopOfStack = (((xPSR_Type){.b.T = 1}).w);
    pxTopOfStack--;
...
static void prvTaskExitError( void )
{
    ...
    if (1) { if (uxCriticalNesting == ~0UL) { } else { assert_nrf_callback((uint16_t)158, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"); } };
    __set_BASEPRI(2 << (8 - 3));
    for ( ;; );
}
...
BaseType_t xPortStartScheduler( void )
{
    ...
    if (1) { if (2) { } else { assert_nrf_callback((uint16_t)173, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"); } };


    if (1) { if (((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CPUID == ( 0x410FC241UL )) { } else { assert_nrf_callback((uint16_t)176, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"); } };


    {
        volatile uint32_t ulOriginalPriority;
        volatile uint8_t * const pucFirstUserPriorityRegister = &((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->IP[0];
        ...
        *pucFirstUserPriorityRegister = ( ( uint8_t ) 0xff );
        ...
        ucMaxSysCallPriority = 2 & ucMaxPriorityValue;



        ulMaxPRIGROUPValue = (7UL << 8U) >> 8U;
    ...
    ((FPU_Type *) ((0xE000E000UL) + 0x0F30UL) )->FPCCR |= (1UL << 31U) | (1UL << 30U);


    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (1UL << 4U);
...
void vPortEndScheduler( void )
{
    ...
    if (1) { if (uxCriticalNesting == 1000UL) { } else { assert_nrf_callback((uint16_t)257, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"); } };
}
...
void vPortEnterCritical( void )
{
    ...
    {
        if (1) { if (( ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICSR & (0x1FFUL ) ) == 0) { } else { assert_nrf_callback((uint16_t)273, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"); } };
    }
}
...
{
    if (1) { if (uxCriticalNesting) { } else { assert_nrf_callback((uint16_t)280, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"); } };
    uxCriticalNesting--;
...
static void vPortEnableVFP( void )
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CPACR |= 0xf << 20;
}
    ...
    IPSR_Type ipsr;
        ...
        if ( ulCurrentInterrupt >= ( 16 ) )
        {
            ...
            ucCurrentPriority = ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->IP[ ulCurrentInterrupt - ( 16 ) ];
# 338 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"
            if (1) { if (ucCurrentPriority >= ucMaxSysCallPriority) { } else { assert_nrf_callback((uint16_t)338, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"); } };
        }
# 354 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"
        if (1) { if (NVIC_GetPriorityGrouping() <= ulMaxPRIGROUPValue) { } else { assert_nrf_callback((uint16_t)354, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\portable\\CMSIS\\nrf52\\port_cmsis.c"); } };
    }
