# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\software\\KalmanFilter.c"
...
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\software\\kalmanFilter.h" 1
...
# 12 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\software\\kalmanFilter.h" 2
...
# 9 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\software\\KalmanFilter.c" 2
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\software\\matrix_operations.h" 1
...
int kf_step(float* Z){
 ...
 mulmat(Phi, X, temp5, N, N, 1);
 zeros(X,N,1);
 accum(X,temp5,N,1);



 mulmat(Phi, P, temp1, N, N,N);
 transpose(Phi,temp0,N,N);
 mulmat(temp1, temp0,P, N , N, N);
 accum(P, Q, N, N);



 transpose(H,temp2,M,N);


 mulmat(H, P,temp3,M,N,N);
 mulmat(temp3,temp2,TEMP_HPH,M,N,M);
 accum(TEMP_HPH,R,M,M);
 mulmat(P,temp2,temp3,N,N,M);

 if (cholsl(TEMP_HPH, TEMP_INVERSE, temp5, M)){
        return 0;
         }
 mulmat(temp3,TEMP_INVERSE,temp2,N,M,M);



 mulmat(H, X,temp4, M , N, 1);
 sub(Z,temp4,temp4,M);
 mulmat(temp2, temp4,temp5,N,M,1);
 accum(X, temp5,N,1);




 mulmat(temp2,H,temp1,N,M,N);
 negate(temp1, N, N);
 mat_addeye(temp1,N);
 mulmat(temp1,P,temp0,N,N,N );
 zeros(P,N,N);
        accum(P,temp0,N,N);
