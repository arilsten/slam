...
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"
# 40 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.h" 1
...
# 44 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.h" 2
# 65 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.h"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\pca10040.h" 1
# 66 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.h" 2
# 107 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.h"

# 107 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.h" 3 4
_Bool 
# 107 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.h"
...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c" 2
...
static const uint8_t m_board_led_list[4] = { 17, 18, 19, 20 };



static const uint8_t m_board_btn_list[4] = { 13, 14, 15, 16 };




# 56 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c" 3 4
_Bool 
# 56 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"
    bsp_board_led_state_get(uint32_t led_idx)
{
    if (1) { if (led_idx < 4) { } else { assert_nrf_callback((uint16_t)58, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"); } };
...
void bsp_board_led_on(uint32_t led_idx)
{
        if (1) { if (led_idx < 4) { } else { assert_nrf_callback((uint16_t)65, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"); } };
        nrf_gpio_pin_write(m_board_led_list[led_idx], 0 ? 1 : 0);
}

void bsp_board_led_off(uint32_t led_idx)
{
    if (1) { if (led_idx < 4) { } else { assert_nrf_callback((uint16_t)71, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"); } };
...
void bsp_board_led_invert(uint32_t led_idx)
{
    if (1) { if (led_idx < 4) { } else { assert_nrf_callback((uint16_t)95, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"); } };
...
uint32_t bsp_board_led_idx_to_pin(uint32_t led_idx)
{
    if (1) { if (led_idx < 4) { } else { assert_nrf_callback((uint16_t)149, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"); } };
...
# 170 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"
    bsp_board_button_state_get(uint32_t button_idx)
{
    if (1) { if (button_idx < 4) { } else { assert_nrf_callback((uint16_t)172, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"); } };
...
uint32_t bsp_board_button_idx_to_pin(uint32_t button_idx)
{
    if (1) { if (button_idx < 4) { } else { assert_nrf_callback((uint16_t)203, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\boards\\boards.c"); } };
