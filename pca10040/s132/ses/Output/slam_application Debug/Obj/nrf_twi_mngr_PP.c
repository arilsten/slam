...
# 55 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
    ...
    uint8_t address = ((p_transfer->operation) >> 1);
    ...
    if ((p_transfer->flags & 0x01) &&
        !((p_transfer->operation) & 1) &&

        ((current_transfer_idx + 1) < p_cb->p_current_transaction->number_of_transfers) &&
        (((p_transfer->operation) >> 1) ==
        ((p_cb->p_current_transaction-> p_transfers[current_transfer_idx + 1].operation) >> 1)
                                                                            ))
    {
        ...
        xfer_desc.type = ((p_second_transfer->operation) & 1) ?
                NRF_DRV_TWI_XFER_TXRX : NRF_DRV_TWI_XFER_TXTX;
        flags = (p_second_transfer->flags & 0x01) ? (1UL << 5) : 0;
        p_cb->current_transfer_idx++;
    }
    else
    {
        xfer_desc.type = ((p_transfer->operation) & 1) ? NRF_DRV_TWI_XFER_RX :
                NRF_DRV_TWI_XFER_TX;
        xfer_desc.p_secondary_buf = 
# 101 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
                                   0
# 101 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
                                       ;
        xfer_desc.secondary_length = 0;
        flags = (p_transfer->flags & 0x01) ? (1UL << 5) : 0;
    }
...
# 135 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 135 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)135, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
...
# 142 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
        ...
        {
            if (nrf_queue_generic_pop((p_nrf_twi_mngr->p_queue), ((void *)(&p_cb->p_current_transaction)), 
# 147 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
               0
# 147 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
               )
...
# 168 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
            ...
            if (memcmp(p_cb->p_current_configuration, p_instance_cfg, sizeof(*p_instance_cfg)) != 0)
            {
                ...
                err_code = nrf_drv_twi_init(&p_nrf_twi_mngr->twi,
                                            ...
                                            twi_event_handler,
                                            (void *)p_nrf_twi_mngr);
                if (1) { if (err_code == ((0x0) + 0)) { } else { assert_nrf_callback((uint16_t)180, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
...
# 210 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 210 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)210, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };

    nrf_twi_mngr_t * p_nrf_twi_mngr = (nrf_twi_mngr_t *)p_context;
    ret_code_t result;


    if (1) { if (p_nrf_twi_mngr->p_nrf_twi_mngr_cb->p_current_transaction != 
# 216 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 216 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
    ...
    start_pending_transaction(p_nrf_twi_mngr, 
# 257 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
                                             1
# 257 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
                                                 );
...
# 264 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 264 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)264, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    if (1) { if (p_nrf_twi_mngr->p_queue != 
# 265 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 265 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)265, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    if (1) { if (p_nrf_twi_mngr->p_queue->size > 0) { } else { assert_nrf_callback((uint16_t)266, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    if (1) { if (p_default_twi_config != 
# 267 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 267 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)267, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    ...
    p_nrf_twi_mngr->p_nrf_twi_mngr_cb->p_current_transaction = 
# 279 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
                                                                0
# 279 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
                                                                    ;
...
# 290 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 290 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)290, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
...
# 301 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 301 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)301, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    if (1) { if (p_transaction != 
# 302 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 302 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)302, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    if (1) { if (p_transaction->p_transfers != 
# 303 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 303 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)303, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    if (1) { if (p_transaction->number_of_transfers != 0) { } else { assert_nrf_callback((uint16_t)304, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
...
# 335 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 335 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)335, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    if (1) { if (p_transfers != 
# 336 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c" 3 4
   0
# 336 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)336, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
    if (1) { if (number_of_transfers != 0) { } else { assert_nrf_callback((uint16_t)337, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\twi_mngr\\nrf_twi_mngr.c"); } };
