...
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.h" 1
# 44 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.h"
# 1 "../../../../../../external/fatfs/src/diskio.h" 1
# 12 "../../../../../../external/fatfs/src/diskio.h"
...
# 13 "../../../../../../external/fatfs/src/diskio.h" 2
...
# 45 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.h" 2
...
typedef struct
{
    ...
    volatile 
# 84 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.h" 3 4
            _Bool 
# 84 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.h"
                    busy;
} diskio_blkdev_t;
...
# 42 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c" 2
                              ...
                              nrf_block_dev_event_t const * p_event)
{
    ...
    if (1) { if (drv < m_drives_count) { } else { assert_nrf_callback((uint16_t)63, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
    ...
    switch (p_event->ev_type)
    {
        ...
        case NRF_BLOCK_DEV_EVT_BLK_READ_DONE:
            ...
            m_drives[drv].busy = 
# 72 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c" 3 4
                                0
# 72 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"
                                     ;
            break;
...
DSTATUS disk_initialize(BYTE drv)
{
    if (1) { if (m_drives) { } else { assert_nrf_callback((uint16_t)89, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
    ...
    if (!(m_drives[drv].state & 0x01))
    {

        return m_drives[drv].state;
    }

    if (m_drives[drv].config.wait_func == 
# 107 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c" 3 4
                                         0
# 107 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"
                                             )
...
DSTATUS disk_uninitialize(BYTE drv)
{
    if (1) { if (m_drives) { } else { assert_nrf_callback((uint16_t)134, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DSTATUS disk_status(BYTE drv)
{
    if (1) { if (m_drives) { } else { assert_nrf_callback((uint16_t)179, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DRESULT disk_read(BYTE drv, BYTE *buff, DWORD sector, UINT count)
{
    if (1) { if (m_drives) { } else { assert_nrf_callback((uint16_t)190, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DRESULT disk_write(BYTE drv, const BYTE *buff, DWORD sector, UINT count)
{
    if (1) { if (m_drives) { } else { assert_nrf_callback((uint16_t)229, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DRESULT disk_ioctl(BYTE drv, BYTE cmd, void *buff)
{
    if (1) { if (m_drives) { } else { assert_nrf_callback((uint16_t)272, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
void diskio_blockdev_register(diskio_blkdev_t * diskio_blkdevs, size_t count)
{
    if (1) { if (diskio_blkdevs) { } else { assert_nrf_callback((uint16_t)328, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
