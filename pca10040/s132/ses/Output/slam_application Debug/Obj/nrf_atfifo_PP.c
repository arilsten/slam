...
_Static_assert(__builtin_offsetof (nrf_atfifo_postag_pos_t, wr) == 0, "unspecified message");
_Static_assert(__builtin_offsetof (nrf_atfifo_postag_pos_t, rd) == 2, "unspecified message");
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
static 
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h" 3 4
      _Bool 
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
           nrf_atfifo_wspace_req(nrf_atfifo_t * const p_fifo, nrf_atfifo_postag_t * const p_old_tail);
# 105 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
...
# 118 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h" 3 4
      _Bool 
# 118 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
           nrf_atfifo_rspace_req(nrf_atfifo_t * const p_fifo, nrf_atfifo_postag_t * const p_old_head);
# 143 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
...
# 155 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h" 3 4
      _Bool 
# 155 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
           nrf_atfifo_space_clear(nrf_atfifo_t * const p_fifo);
# 352 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
...
# 354 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
    ...
    __asm volatile(
        ...
        :
            [p_fifo] "r"(p_fifo),
            [offset_tail] "J"(__builtin_offsetof (nrf_atfifo_t, tail)),
            [offset_head_wr] "J"(__builtin_offsetof (nrf_atfifo_t, head) + __builtin_offsetof (nrf_atfifo_postag_pos_t, wr)),
            [offset_item_size]"J"(__builtin_offsetof (nrf_atfifo_t, item_size)),
            [offset_buf_size] "J"(__builtin_offsetof (nrf_atfifo_t, buf_size)),
            [true_val] "I"(
# 398 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h" 3 4
                                 1
# 398 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
...
# 440 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h"
    ...
    __asm volatile(
        ...
        :
            [p_fifo] "r"(p_fifo),
            [offset_head] "J"(__builtin_offsetof (nrf_atfifo_t, head)),
            [offset_tail_rd] "J"(__builtin_offsetof (nrf_atfifo_t, tail) + __builtin_offsetof (nrf_atfifo_postag_pos_t, rd)),
            [offset_item_size]"J"(__builtin_offsetof (nrf_atfifo_t, item_size)),
            [offset_buf_size] "J"(__builtin_offsetof (nrf_atfifo_t, buf_size)),
            [true_val] "I"(
# 484 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo_internal.h" 3 4
...
_Static_assert(sizeof(nrf_atfifo_postag_t) == sizeof(uint32_t), "unspecified message");
...
# 64 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
            == p_buf)
    {
        if (1 && (0 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_ERROR) | (p_fifo->p_log)->module_id << 16), "Initialization failed. p_buf == NULL"); } };
        return ((0x0) + 14);
    }
    if (0 != (buf_size % item_size))
    {
        if (1 && (0 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_ERROR) | (p_fifo->p_log)->module_id << 16), "Initialization failed. Buf_size not multiple of item_size"); } };
        return ((0x0) + 9);
    }
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (p_fifo->p_log)->module_id << 16), "Initialized."); } };
    return ((0x0) + 0);
}
...
# 88 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c" 3 4
   _Bool 
# 88 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
        released = nrf_atfifo_space_clear(p_fifo);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (p_fifo->p_log)->module_id << 16), "Cleared result:%s", (uint32_t)(released ? "success" : "busy")); } };
    return released ? ((0x0) + 0) : ((0x0) + 17);
}


ret_code_t nrf_atfifo_alloc_put(nrf_atfifo_t * const p_fifo, void const * p_var, size_t size, 
# 94 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c" 3 4
                                                                                             _Bool 
# 94 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
                                                                                                  * const p_visible)
...
# 99 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
            == p_data)
    {
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_WARNING) | (p_fifo->p_log)->module_id << 16), "Copying in element (0x%08X) failed - no space.", (uint32_t)(p_var)); } };
        return ((0x0) + 4);
    }
...
# 108 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (p_fifo->p_log)->module_id << 16), "Element (0x%08X) copied in.", (uint32_t)(p_var)); } };
    return ((0x0) + 0);
}
...
void * nrf_atfifo_item_alloc(nrf_atfifo_t * const p_fifo, nrf_atfifo_item_put_t * p_context)
{
    if (nrf_atfifo_wspace_req(p_fifo, &(p_context->last_tail)))
    {
        ...
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (p_fifo->p_log)->module_id << 16), "Allocated  element (0x%08X).", (uint32_t)(p_item)); } };
        return p_item;
    }
    if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_WARNING) | (p_fifo->p_log)->module_id << 16), "Allocation failed - no space."); } };
    return 
# 126 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c" 3 4
          0
# 126 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
    ...
    nrf_atfifo_item_put(nrf_atfifo_t * const p_fifo, nrf_atfifo_item_put_t * p_context)
{
    ...
    {
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (p_fifo->p_log)->module_id << 16), "Put (uninterrupted)"); } };
...
# 136 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (p_fifo->p_log)->module_id << 16), "Put (interrupted!)"); } };
    return 
# 139 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c" 3 4
          0
# 139 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
...
# 148 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
            == p_s)
    {
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_WARNING) | (p_fifo->p_log)->module_id << 16), "Copying out failed - no item in the FIFO."); } };
        return ((0x0) + 5);
    }
...
# 157 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (p_fifo->p_log)->module_id << 16), "Element (0x%08X) copied out.", (uint32_t)(p_var)); } };
    return ((0x0) + 0);
}
...
void * nrf_atfifo_item_get(nrf_atfifo_t * const p_fifo, nrf_atfifo_item_get_t * p_context)
{
    if (nrf_atfifo_rspace_req(p_fifo, &(p_context->last_head)))
    {
        ...
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (p_fifo->p_log)->module_id << 16), "Get element: 0x%08X", (uint32_t)(p_item)); } };
        return p_item;
    }
    if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_WARNING) | (p_fifo->p_log)->module_id << 16), "Get failed - no item in the FIFO."); } };
    return 
# 175 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c" 3 4
          0
# 175 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
    ...
    nrf_atfifo_item_free(nrf_atfifo_t * const p_fifo, nrf_atfifo_item_get_t * p_context)
{
    ...
    {
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (p_fifo->p_log)->module_id << 16), "Free (uninterrupted)"); } };
...
# 185 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (p_fifo->p_log)->module_id << 16), "Free (interrupted)"); } };
    return 
# 188 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c" 3 4
          0
# 188 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\atomic_fifo\\nrf_atfifo.c"
