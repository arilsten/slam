...
# 30 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c" 2
...
# 141 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 ...
 QueueRegistryItem_t xQueueRegistry[ 2 ];
# 167 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (pxQueue) { } else { assert_nrf_callback((uint16_t)252, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
# 359 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 ...
 uint8_t *pucQueueStorage;
  ...
  if (1) { if (uxQueueLength > ( UBaseType_t ) 0) { } else { assert_nrf_callback((uint16_t)365, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
  ...
  if( pxNewQueue != 
# 381 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c" 3 4
                   0 
# 381 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
                        )
  {
...
# 447 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 SEGGER_SYSVIEW_RecordU32x3((32u) + (83u), uxQueueLength, uxItemSize, ucQueueType);
}
...
# 575 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 ...
 Queue_t * const pxMutex = ( Queue_t * ) xMutex;
  ...
  if (1) { if (pxMutex) { } else { assert_nrf_callback((uint16_t)580, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
# 604 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 ...
 Queue_t * const pxMutex = ( Queue_t * ) xMutex;
  ...
  if (1) { if (pxMutex) { } else { assert_nrf_callback((uint16_t)635, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
# 700 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 ...
 QueueHandle_t xHandle;
  ...
  if (1) { if (uxMaxCount != 0) { } else { assert_nrf_callback((uint16_t)704, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
  if (1) { if (uxInitialCount <= uxMaxCount) { } else { assert_nrf_callback((uint16_t)705, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (pxQueue) { } else { assert_nrf_callback((uint16_t)732, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 if (1) { if (!( ( pvItemToQueue == 
# 733 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c" 3 4
0 
# 733 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) { } else { assert_nrf_callback((uint16_t)733, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 if (1) { if (!( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue->uxLength != 1 ) )) { } else { assert_nrf_callback((uint16_t)734, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };

 {
  if (1) { if (!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) )) { } else { assert_nrf_callback((uint16_t)737, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 }
 ...
 for( ;; )
 {
  vPortEnterCritical();
  {
   ...
   {
    SEGGER_SYSVIEW_RecordU32x4((32u) + (58u), SEGGER_SYSVIEW_ShrinkId((unsigned long)pxQueue), (unsigned long)pvItemToQueue, xTicksToWait, xCopyPosition);
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (pxQueue) { } else { assert_nrf_callback((uint16_t)930, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 if (1) { if (!( ( pvItemToQueue == 
# 931 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c" 3 4
0 
# 931 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) { } else { assert_nrf_callback((uint16_t)931, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 if (1) { if (!( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue->uxLength != 1 ) )) { } else { assert_nrf_callback((uint16_t)932, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
# 948 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 ...
 uxSavedInterruptStatus = ulPortRaiseBASEPRI();
 {
  if( ( pxQueue->uxMessagesWaiting < pxQueue->uxLength ) || ( xCopyPosition == ( ( BaseType_t ) 2 ) ) )
  {
   ...
   SEGGER_SYSVIEW_RecordU32x2((32u) + (64u), SEGGER_SYSVIEW_ShrinkId((unsigned long)pxQueue), (unsigned long)pxHigherPriorityTaskWoken);
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (pxQueue) { } else { assert_nrf_callback((uint16_t)1087, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };



 if (1) { if (pxQueue->uxItemSize == 0) { } else { assert_nrf_callback((uint16_t)1091, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };




 if (1) { if (!( ( pxQueue->pcHead == 
# 1096 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c" 3 4
0 
# 1096 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
) && ( pxQueue->pcTail != 
...
0 
# 1096 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
) )) { } else { assert_nrf_callback((uint16_t)1096, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
# 1112 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 vPortValidateInterruptPriority();
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (( pxQueue )) { } else { assert_nrf_callback((uint16_t)1247, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
0 
# 1251 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
) && ( ( pxQueue )->uxItemSize != ( UBaseType_t ) 0U ) )) { } else { assert_nrf_callback((uint16_t)1251, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };



 {
  if (1) { if (!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) )) { } else { assert_nrf_callback((uint16_t)1256, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 }
 ...
 for( ;; )
 {
  vPortEnterCritical();
  {
   ...
   if( uxMessagesWaiting > ( UBaseType_t ) 0 )
   {
    ...
    SEGGER_SYSVIEW_RecordU32x4((32u) + (60u), SEGGER_SYSVIEW_ShrinkId((unsigned long)pxQueue), SEGGER_SYSVIEW_ShrinkId((unsigned long)0), xTicksToWait, 1);
    pxQueue->uxMessagesWaiting = uxMessagesWaiting - ( UBaseType_t ) 1;
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (( pxQueue )) { } else { assert_nrf_callback((uint16_t)1393, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };



 if (1) { if (pxQueue->uxItemSize == 0) { } else { assert_nrf_callback((uint16_t)1397, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };



 {
  if (1) { if (!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) )) { } else { assert_nrf_callback((uint16_t)1402, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 }
...
# 1431 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
   ...
   else
   {
    if( xTicksToWait == ( TickType_t ) 0 )
    {
     ...
     {
      if (1) { if (xInheritanceOccurred == ( ( BaseType_t ) 0 )) { } else { assert_nrf_callback((uint16_t)1474, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
     }
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (( pxQueue )) { } else { assert_nrf_callback((uint16_t)1609, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
0 
# 1613 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
) && ( ( pxQueue )->uxItemSize != ( UBaseType_t ) 0U ) )) { } else { assert_nrf_callback((uint16_t)1613, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };



 {
  if (1) { if (!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) )) { } else { assert_nrf_callback((uint16_t)1618, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 }
 ...
 for( ;; )
 {
  vPortEnterCritical();
  {
   ...
   if( uxMessagesWaiting > ( UBaseType_t ) 0 )
   {
    ...
    prvCopyDataFromQueue( pxQueue, pvBuffer );
    SEGGER_SYSVIEW_RecordU32x4((32u) + (60u), SEGGER_SYSVIEW_ShrinkId((unsigned long)pxQueue), SEGGER_SYSVIEW_ShrinkId((unsigned long)pvBuffer), xTicksToWait, 1);
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (pxQueue) { } else { assert_nrf_callback((uint16_t)1757, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 if (1) { if (!( ( pvBuffer == 
# 1758 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c" 3 4
0 
# 1758 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) { } else { assert_nrf_callback((uint16_t)1758, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
# 1774 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 vPortValidateInterruptPriority();
 ...
 uxSavedInterruptStatus = ulPortRaiseBASEPRI();
 {
  ...
  if( uxMessagesWaiting > ( UBaseType_t ) 0 )
  {
   ...
   SEGGER_SYSVIEW_RecordU32x3((32u) + (66u), SEGGER_SYSVIEW_ShrinkId((unsigned long)pxQueue), SEGGER_SYSVIEW_ShrinkId((unsigned long)pvBuffer), (unsigned long)pxHigherPriorityTaskWoken);
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (pxQueue) { } else { assert_nrf_callback((uint16_t)1849, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 if (1) { if (!( ( pvBuffer == 
# 1850 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c" 3 4
0 
# 1850 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) { } else { assert_nrf_callback((uint16_t)1850, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 if (1) { if (pxQueue->uxItemSize != 0) { } else { assert_nrf_callback((uint16_t)1851, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
# 1867 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 vPortValidateInterruptPriority();
 ...
 uxSavedInterruptStatus = ulPortRaiseBASEPRI();
 {
  ...
  {
   SEGGER_SYSVIEW_RecordU32x2((32u) + (59u), SEGGER_SYSVIEW_ShrinkId((unsigned long)pxQueue), SEGGER_SYSVIEW_ShrinkId((unsigned long)pvBuffer));
...
UBaseType_t uxReturn;
 ...
 if (1) { if (xQueue) { } else { assert_nrf_callback((uint16_t)1900, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
Queue_t *pxQueue;
 ...
 if (1) { if (pxQueue) { } else { assert_nrf_callback((uint16_t)1918, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
UBaseType_t uxReturn;
 ...
 if (1) { if (xQueue) { } else { assert_nrf_callback((uint16_t)1934, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (1) { if (pxQueue) { } else { assert_nrf_callback((uint16_t)1946, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
 SEGGER_SYSVIEW_RecordU32 ((32u) + (63u), SEGGER_SYSVIEW_ShrinkId((unsigned long)pxQueue));
...
# 1981 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 ...
 UBaseType_t uxHighestPriorityOfWaitingTasks;
  ...
  {
   uxHighestPriorityOfWaitingTasks = ( 7 ) - ( ( ( &( pxQueue->xTasksWaitingToReceive ) )->xListEnd ).pxNext->xItemValue );
  }
  else
  {
...
BaseType_t xReturn;
 ...
 if (1) { if (xQueue) { } else { assert_nrf_callback((uint16_t)2283, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
BaseType_t xReturn;
 ...
 if (1) { if (xQueue) { } else { assert_nrf_callback((uint16_t)2322, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"); } };
...
# 2613 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
 ...
 UBaseType_t ux;
  ...
  for( ux = ( UBaseType_t ) 0U; ux < ( UBaseType_t ) 2; ux++ )
  {
...
# 2621 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
                                               )
   {
    ...
    SEGGER_SYSVIEW_RecordU32x2((32u) + (81u), SEGGER_SYSVIEW_ShrinkId((unsigned long)xQueue), (unsigned long)pcQueueName);
    break;
   }
   else
   {
