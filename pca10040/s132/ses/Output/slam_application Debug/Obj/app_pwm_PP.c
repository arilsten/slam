...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c" 2

# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.h" 1
# 64 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.h"
# 1 "../../../../../../components/libraries/util/sdk_errors.h" 1
# 65 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.h" 2
...
# 205 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.h" 3 4
_Bool 
# 205 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.h"
    app_pwm_busy_check(app_pwm_t const * const p_instance);
# 219 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.h"
...
# 73 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
static 
# 73 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c" 3 4
      _Bool 
# 73 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
           m_use_ppi_delay_workaround;
# 83 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
static volatile uint8_t m_pwm_busy[5];
...
static volatile uint32_t m_pwm_target_value[5];
# 101 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
volatile uint8_t m_pwm_ready_counter[5][2];
...
static const app_pwm_t * m_instances[5];
# 126 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
static void pan73_workaround(NRF_TIMER_Type * p_timer, 
# 126 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c" 3 4
                                                      _Bool 
# 126 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
                                                           enable)
...
# 150 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
    ...
    if (busy_state != 0xFF)
    {
        if (busy_state != 0xFE)
        {
            if (nrfx_timer_capture_get(p_instance->p_timer, (nrf_timer_cc_channel_t) busy_state)
                == m_pwm_target_value[p_instance->p_timer->instance_id])
            {
                m_pwm_busy[p_instance->p_timer->instance_id] = 0xFF;
                busy = 
# 159 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c" 3 4
                      0
# 159 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
...
static inline void pwm_irq_enable(app_pwm_t const * const p_instance)
{
    nrfx_timer_compare_int_enable(p_instance->p_timer, 2);
}
...
static inline void pwm_irq_disable(app_pwm_t const * const p_instance)
{
    nrfx_timer_compare_int_disable(p_instance->p_timer, 2);
}
# 227 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
...
static void pwm_dealloc(app_pwm_t const * const p_instance)
{
    ...
    nrfx_ppi_channel_free(p_cb->ppi_channel);
# 281 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
    for (uint8_t ch = 0; ch < 2; ++ch)
    {
        for (uint8_t i = 0; i < 2; ++i)
        {
            if (p_cb->channels_cb[ch].ppi_channels[i] != (nrf_ppi_channel_t)0xFFFFFFFFUL)
            {
                nrfx_ppi_channel_free(p_cb->channels_cb[ch].ppi_channels[i]);
                p_cb->channels_cb[ch].ppi_channels[i] = (nrf_ppi_channel_t)0xFFFFFFFFUL;
            }
        }
        if (p_cb->channels_cb[ch].gpio_pin != 0xFFFFFFFFUL)
        {
            nrfx_gpiote_out_uninit(p_cb->channels_cb[ch].gpio_pin);
            p_cb->channels_cb[ch].gpio_pin = 0xFFFFFFFFUL;
        }
        p_cb->channels_cb[ch].initialized = 0;
    }
    nrfx_timer_uninit(p_instance->p_timer);
    return;
}
# 546 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
                                  ...
                                  uint8_t channel, uint16_t ticks)
{
    ...
    nrfx_ppi_channel_disable(p_cb->ppi_channel);

    if (!ticks)
    {
        nrfx_ppi_channel_disable(p_ch_cb->ppi_channels[1]);
        nrfx_ppi_channel_enable(p_ch_cb->ppi_channels[0]);
        m_pwm_busy[p_instance->p_timer->instance_id] = 0xFF;
    }
    else if (ticks >= p_cb->period)
    {
        ticks = p_cb->period;
        nrfx_ppi_channel_disable(p_ch_cb->ppi_channels[0]);
        nrfx_ppi_channel_enable(p_ch_cb->ppi_channels[1]);
        m_pwm_busy[p_instance->p_timer->instance_id] = 0xFF;
    }
    else
    {
        ...
        {
            nrfx_timer_compare(p_instance->p_timer, (nrf_timer_cc_channel_t)3, p_ch_cb->pulsewidth, 
# 573 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c" 3 4
                                                                                                                             0
# 573 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
                                                                                                                                  );
            nrfx_ppi_channel_assign(p_cb->ppi_channel,
                                       nrfx_timer_compare_event_address_get(p_instance->p_timer, (nrf_timer_cc_channel_t)3),
                                       p_ch_cb->polarity ? nrfx_gpiote_clr_task_addr_get(p_ch_cb->gpio_pin) : nrfx_gpiote_set_task_addr_get(p_ch_cb->gpio_pin));
            nrfx_ppi_channel_enable(p_cb->ppi_channel);
        ...
        nrfx_timer_compare(p_instance->p_timer, pwm_ch_cc, ticks, 
# 586 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c" 3 4
                                                                    0
# 586 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
                                                                         );
                                          ...
                                          uint16_t ticks)
{
    ...
    if (1) { if (channel < 2) { } else { assert_nrf_callback((uint16_t)603, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
    if (1) { if (p_ch_cb->initialized == 1) { } else { assert_nrf_callback((uint16_t)604, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
    ...
    m_pwm_busy[p_instance->p_timer->instance_id] = 0xFE;
...
{
    if (1) { if (channel < 2) { } else { assert_nrf_callback((uint16_t)684, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
    app_pwm_cb_t * p_cb = p_instance->p_cb;
    ...
    nrf_drv_gpiote_out_config_t out_cfg = { .init_state = (( ((p_instance)->p_cb)->channels_cb[(channel)].polarity == APP_PWM_POLARITY_ACTIVE_LOW)?(1):(0)) ? NRF_GPIOTE_INITIAL_VALUE_HIGH : NRF_GPIOTE_INITIAL_VALUE_LOW, .task_pin = 
# 698 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c" 3 4
                                         1
# 698 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
                                         , .action = NRF_GPIOTE_POLARITY_TOGGLE, };
    err_code = nrfx_gpiote_out_init((nrf_drv_gpiote_pin_t)pin,&out_cfg);
    if (err_code != ((0x0) + 0))
    {
        return ((0x0) + 4);
    }
    ...
    for (uint8_t i = 0; i < 2; ++i)
    {
        if (nrfx_ppi_channel_alloc(&p_channel_cb->ppi_channels[i]) != ((0x0) + 0))
        {
            return ((0x0) + 4);
        }
    }

    nrfx_ppi_channel_disable(p_channel_cb->ppi_channels[0]);
    nrfx_ppi_channel_disable(p_channel_cb->ppi_channels[1]);


    uint32_t deactivate_task_addr = polarity ? nrfx_gpiote_clr_task_addr_get(p_channel_cb->gpio_pin) : nrfx_gpiote_set_task_addr_get(p_channel_cb->gpio_pin);
    uint32_t activate_task_addr = polarity ? nrfx_gpiote_set_task_addr_get(p_channel_cb->gpio_pin) : nrfx_gpiote_clr_task_addr_get(p_channel_cb->gpio_pin);

    nrfx_ppi_channel_assign(p_channel_cb->ppi_channels[0],
                               nrfx_timer_compare_event_address_get(p_instance->p_timer, channel),
                               deactivate_task_addr);
    nrfx_ppi_channel_assign(p_channel_cb->ppi_channels[1],
                               nrfx_timer_compare_event_address_get(p_instance->p_timer, 2),
                               activate_task_addr);
# 746 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
    p_channel_cb->initialized = 1;
    m_pwm_ready_counter[p_instance->p_timer->instance_id][channel] = 0;

    return ((0x0) + 0);
}
# 760 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
static inline nrf_timer_frequency_t pwm_calculate_timer_frequency(uint32_t period_us)
{
...
ret_code_t app_pwm_init(app_pwm_t const * const p_instance, app_pwm_config_t const * const p_config,
                        app_pwm_callback_t p_ready_callback)
{
    if (1) { if (p_instance) { } else { assert_nrf_callback((uint16_t)785, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
    ...
    if ((err_code != ((0x0) + 0)) && (err_code != (((0x0) + 0x0080) + 0x0005)))
    {
        return ((0x0) + 4);
    }
...
# 822 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
    ...
    p_cb->ppi_channel = (nrf_ppi_channel_t)0xFFFFFFFFUL;
    ...
    for (uint8_t i = 0; i < 2; ++i)
    {
        p_cb->channels_cb[i].initialized = 0;
        p_cb->channels_cb[i].ppi_channels[0] = (nrf_ppi_channel_t)0xFFFFFFFFUL;
        p_cb->channels_cb[i].ppi_channels[1] = (nrf_ppi_channel_t)0xFFFFFFFFUL;
        p_cb->channels_cb[i].gpio_pin = 0xFFFFFFFFUL;
    }




    if (nrfx_ppi_channel_alloc(&p_cb->ppi_channel) != ((0x0) + 0))
    {
...
# 868 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
    ...
    err_code = nrfx_timer_init(p_instance->p_timer, &timer_cfg,
                                  pwm_ready_tick);
    if (err_code != ((0x0) + 0))
    {
        pwm_dealloc(p_instance);
    ...
    uint32_t ticks = nrfx_timer_us_to_ticks(p_instance->p_timer, p_config->period_us);
    p_cb->period = ticks;
    nrfx_timer_clear(p_instance->p_timer);
    nrfx_timer_extended_compare(p_instance->p_timer, (nrf_timer_cc_channel_t) 2,
...
void app_pwm_enable(app_pwm_t const * const p_instance)
{
    ...
    if (1) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)919, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
    ...
    for (uint32_t channel = 0; channel < 2; ++channel)
    {
        ...
        {
            nrfx_gpiote_out_task_force(p_ch_cb->gpio_pin, (( ((p_instance)->p_cb)->channels_cb[(channel)].polarity == APP_PWM_POLARITY_ACTIVE_LOW)?(1):(0)));
            nrfx_gpiote_out_task_enable(p_ch_cb->gpio_pin);
            p_ch_cb->pulsewidth = 0;
        }
    }
    m_pwm_busy[p_instance->p_timer->instance_id] = 0xFF;

    pan73_workaround(p_instance->p_timer->p_reg, 
# 934 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c" 3 4
                                                1
# 934 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"
                                                    );
    ...
    nrfx_timer_clear(p_instance->p_timer);
    nrfx_timer_enable(p_instance->p_timer);
...
void app_pwm_disable(app_pwm_t const * const p_instance)
{
    ...
    if (1) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)948, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };

    nrfx_timer_disable(p_instance->p_timer);
    ...
    for (uint8_t channel = 0; channel < 2; ++channel)
    {
        ...
        if (p_ch_cb->initialized)
        {
            uint8_t polarity = (( ((p_instance)->p_cb)->channels_cb[(channel)].polarity == APP_PWM_POLARITY_ACTIVE_LOW)?(1):(0));
            if (polarity)
            {
            ...
            nrfx_gpiote_out_task_disable(p_ch_cb->gpio_pin);
            nrfx_ppi_channel_disable(p_ch_cb->ppi_channels[0]);
            nrfx_ppi_channel_disable(p_ch_cb->ppi_channels[1]);
        }
    }
