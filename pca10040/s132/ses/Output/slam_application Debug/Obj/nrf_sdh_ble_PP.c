...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_sdh_ble_logs_data_dynamic;
...
# 60 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c" 2
const nrf_log_module_const_data_t m_nrf_log_nrf_sdh_ble_logs_data_const __attribute__ ((section("." "log_const_data_nrf_sdh_ble"))) __attribute__((used)) = { .p_module_name = "nrf_sdh_ble", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(3), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_sdh_ble_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_nrf_sdh_ble"))) __attribute__((used));



extern nrf_sdh_ble_evt_observer_t * __start_sdh_ble_observers; extern void * __stop_sdh_ble_observers; static nrf_section_set_t const sdh_ble_observers = { .section = { .p_start = &__start_sdh_ble_observers, .p_end = &__stop_sdh_ble_observers, }, .item_size = sizeof(nrf_sdh_ble_evt_observer_t), };
# 75 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c"
...
# 92 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c"
    ...
    *p_app_ram_start = (uint32_t)m_ram_start;
...
# 121 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c"
    ...
    ble_cfg.gap_cfg.role_count_cfg.central_sec_count = ((0) < ((1)) ? (0) : ((1)))
                                                                                                   ;
    ...
    if (ret_code != ((0x0) + 0))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "sd_ble_cfg_set() returned %s when attempting to set BLE_GAP_CFG_ROLE_COUNT.", (uint32_t)(nrf_strerror_get(ret_code))); } }
                                                 ;
    }
# 169 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c"
    memset(&ble_cfg, 0, sizeof(ble_cfg));
    ...
    if (ret_code != ((0x0) + 0))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "sd_ble_cfg_set() returned %s when attempting to set BLE_COMMON_CFG_VS_UUID.", (uint32_t)(nrf_strerror_get(ret_code))); } }
                                                 ;
    }


    memset(&ble_cfg, 0x00, sizeof(ble_cfg));
    ble_cfg.gatts_cfg.attr_tab_size.attr_tab_size = 1408;

    ret_code = sd_ble_cfg_set(BLE_GATTS_CFG_ATTR_TAB_SIZE, &ble_cfg, *p_ram_start);
    if (ret_code != ((0x0) + 0))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "sd_ble_cfg_set() returned %s when attempting to set BLE_GATTS_CFG_ATTR_TAB_SIZE.", (uint32_t)(nrf_strerror_get(ret_code))); } }
                                                 ;
    }
    ...
    if (ret_code != ((0x0) + 0))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "sd_ble_cfg_set() returned %s when attempting to set BLE_GATTS_CFG_SERVICE_CHANGED.", (uint32_t)(nrf_strerror_get(ret_code))); } }
                                                 ;
    }
...
static uint32_t ram_end_address_get(void)
{
    ...
    ram_total_size = ((NRF_FICR_Type *) 0x10000000UL)->INFO.RAM * 1024;
...
ret_code_t nrf_sdh_ble_enable(uint32_t * const p_app_ram_start)
{
    ...
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "Insufficient RAM allocated for the SoftDevice."); } };

        if (1 && (3 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "Change the RAM start location from 0x%x to 0x%x.", (uint32_t)(app_ram_start_link), (uint32_t)(*p_app_ram_start)); } }
                                                             ;
        if (1 && (3 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "Maximum RAM size for application is 0x%x.", (uint32_t)(ram_end_address_get() - (*p_app_ram_start))); } }
                                                                   ;
    }
    else
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "RAM starts at 0x%x", (uint32_t)(app_ram_start_link)); } };
        if (*p_app_ram_start != app_ram_start_link)
        {
            if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "RAM start location can be adjusted to 0x%x.", (uint32_t)(*p_app_ram_start)); } };

            if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "RAM size for application can be adjusted to 0x%x.", (uint32_t)(ram_end_address_get() - (*p_app_ram_start))); } }
                                                                     ;
        }
    }
...
# 250 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c"
    ...
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "sd_ble_enable() returned %s.", (uint32_t)(nrf_strerror_get(ret_code))); } };
    }
...
# 276 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c"
              )
    {
        ...
        __attribute__((aligned(4))) uint8_t evt_buffer[( __builtin_offsetof (ble_evt_t, evt.gattc_evt.params.prim_srvc_disc_rsp.services) + ((23) - 1) / 4 * sizeof(ble_gattc_service_t) )];
        ...
        if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_ble_logs_data_dynamic.module_id << 16), "BLE event: 0x%x.", (uint32_t)(p_ble_evt->header.evt_id)); } };
...
# 298 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c"
    ...
    if (ret_code != ((0x0) + 5))
    {
        do { app_error_handler((ret_code), 313, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_ble.c"); } while (0);
    }
}


_Static_assert(1, "NRF_SDH_ENABLED not set!"); _Static_assert(0 < 2, "Priority level unavailable."); static nrf_sdh_stack_observer_t const m_nrf_sdh_ble_evts_poll __attribute__ ((section("." "sdh_stack_observers0"))) __attribute__((used)) =
{
