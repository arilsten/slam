...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_PRS_logs_data_dynamic;
...
const nrf_log_module_const_data_t m_nrf_log_PRS_logs_data_const __attribute__ ((section("." "log_const_data_PRS"))) __attribute__((used)) = { .p_module_name = "PRS", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_PRS_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_PRS"))) __attribute__((used));
# 48 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c" 2
...
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"
static prs_box_t m_prs_box_4 = { .handler = 
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c" 3 4
0
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"
, .acquired = 
...
0 
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"
}; void UARTE0_UART0_IRQHandler(void) { if (1) { if (m_prs_box_4.handler) { } else { assert_nrf_callback((uint16_t)81, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"); } }; m_prs_box_4.handler(); }
...
{
# 108 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"
    if (((p_base_addr) == ((NRF_UARTE_Type *) 0x40002000UL))) { return &m_prs_box_4; }
    else
...
nrfx_err_t nrfx_prs_acquire(void const * p_base_addr,
                            nrfx_irq_handler_t irq_handler)
{
    if (1) { if (p_base_addr) { } else { assert_nrf_callback((uint16_t)119, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"); } };
...
# 136 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"
        ...
        {
            ret_code = ((0x0) + 17);
            if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_PRS_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(ret_code))); } };
            return ret_code;
        }
    }

    ret_code = ((0x0) + 0);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_PRS_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(ret_code))); } };
    return ret_code;
}

void nrfx_prs_release(void const * p_base_addr)
{
    if (1) { if (p_base_addr) { } else { assert_nrf_callback((uint16_t)155, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"); } };
