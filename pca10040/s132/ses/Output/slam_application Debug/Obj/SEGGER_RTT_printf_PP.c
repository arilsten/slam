...
# 65 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\segger_rtt\\SEGGER_RTT_printf.c" 2
# 78 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\segger_rtt\\SEGGER_RTT_printf.c"
  ...
  do {
    ...
    if (c == '%') {
      ...
      case 'c': {
        char c0;
        v = 
# 416 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\segger_rtt\\SEGGER_RTT_printf.c" 3 4
           __builtin_va_arg
# 416 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\segger_rtt\\SEGGER_RTT_printf.c"
                 (*pParamList, int);
        c0 = (char)v;
