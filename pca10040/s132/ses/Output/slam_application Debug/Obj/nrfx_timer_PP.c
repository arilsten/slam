...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_TIMER_logs_data_dynamic;
...
const nrf_log_module_const_data_t m_nrf_log_TIMER_logs_data_const __attribute__ ((section("." "log_const_data_TIMER"))) __attribute__((used)) = { .p_module_name = "TIMER", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_TIMER_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_TIMER"))) __attribute__((used));
# 55 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c" 2
                           ...
                           nrfx_timer_event_handler_t timer_event_handler)
{
    ...
    if (1) { if (p_instance->p_reg != ((NRF_TIMER_Type *) 0x40008000UL)) { } else { assert_nrf_callback((uint16_t)72, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };

    if (1) { if (p_config) { } else { assert_nrf_callback((uint16_t)74, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (1) { if (timer_event_handler) { } else { assert_nrf_callback((uint16_t)75, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }

                                                             ;
        return err_code;
    }
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
    if (1) { if (( ((p_instance->p_reg == ((NRF_TIMER_Type *) 0x40008000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c" 3 4
   0
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
   )))))) || ((p_instance->p_reg == ((NRF_TIMER_Type *) 0x40009000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c" 3 4
   0
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
   )))))) || ((p_instance->p_reg == ((NRF_TIMER_Type *) 0x4000A000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c" 3 4
   0
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
   )))))) || ((p_instance->p_reg == ((NRF_TIMER_Type *) 0x4001A000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c" 3 4
   0
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
   )))))) || ((p_instance->p_reg == ((NRF_TIMER_Type *) 0x4001B000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c" 3 4
   0
# 95 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
   )))))) )) { } else { assert_nrf_callback((uint16_t)95, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    ...
    _NRFX_IRQ_PRIORITY_SET(nrfx_get_irq_number(p_instance->p_reg), p_config->interrupt_priority)
                                     ;
    _NRFX_IRQ_ENABLE(nrfx_get_irq_number(p_instance->p_reg));
    ...
    err_code = ((0x0) + 0);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
void nrfx_timer_uninit(nrfx_timer_t const * const p_instance)
{
    _NRFX_IRQ_DISABLE(nrfx_get_irq_number(p_instance->p_reg));
...
# 132 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Uninitialized instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}

void nrfx_timer_enable(nrfx_timer_t const * const p_instance)
{
    if (1) { if (m_cb[p_instance->instance_id].state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)143, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_START);
    m_cb[p_instance->instance_id].state = NRFX_DRV_STATE_POWERED_ON;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Enabled instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}

void nrfx_timer_disable(nrfx_timer_t const * const p_instance)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)151, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_SHUTDOWN);
    m_cb[p_instance->instance_id].state = NRFX_DRV_STATE_INITIALIZED;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Disabled instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}
...
# 157 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
    nrfx_timer_is_enabled(nrfx_timer_t const * const p_instance)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)159, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    return (m_cb[p_instance->instance_id].state == NRFX_DRV_STATE_POWERED_ON);
}

void nrfx_timer_resume(nrfx_timer_t const * const p_instance)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)165, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_START);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Resumed instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}

void nrfx_timer_pause(nrfx_timer_t const * const p_instance)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)172, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_STOP);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Paused instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}

void nrfx_timer_clear(nrfx_timer_t const * const p_instance)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)179, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_CLEAR);
}

void nrfx_timer_increment(nrfx_timer_t const * const p_instance)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)185, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (1) { if (nrf_timer_mode_get(p_instance->p_reg) != NRF_TIMER_MODE_TIMER) { } else { assert_nrf_callback((uint16_t)186, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
uint32_t nrfx_timer_capture(nrfx_timer_t const * const p_instance,
                            nrf_timer_cc_channel_t cc_channel)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)194, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (1) { if (cc_channel < p_instance->cc_channel_count) { } else { assert_nrf_callback((uint16_t)195, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
                                                  ...
                                                  enable_int)
{
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Timer id: %d, capture value set: %lu, channel: %d.", (uint32_t)(p_instance->instance_id), (uint32_t)(cc_value), (uint32_t)(cc_channel)); } }
...
{
    nrf_timer_shorts_disable(p_instance->p_reg,
        ((0x1UL << (8UL)) << cc_channel) |
        ((0x1UL << (0UL)) << cc_channel));
...
void nrfx_timer_compare_int_enable(nrfx_timer_t const * const p_instance,
                                   uint32_t channel)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)251, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (1) { if (channel < p_instance->cc_channel_count) { } else { assert_nrf_callback((uint16_t)252, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
void nrfx_timer_compare_int_disable(nrfx_timer_t const * const p_instance,
                                    uint32_t channel)
{
    if (1) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)263, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (1) { if (channel < p_instance->cc_channel_count) { } else { assert_nrf_callback((uint16_t)264, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
                        ...
                        uint8_t channel_count)
{
    ...
    for (i = 0; i < channel_count; ++i)
    {
            ...
            nrf_timer_int_enable_check(p_reg, int_mask))
        {
            ...
            if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_TIMER_logs_data_dynamic.module_id << 16), "Compare event, channel: %d.", (uint32_t)(i)); } };
...
void TIMER1_IRQHandler(void)
{
    irq_handler(((NRF_TIMER_Type *) 0x40009000UL), &m_cb[NRFX_TIMER1_INST_IDX],
        4);
}
...
void TIMER2_IRQHandler(void)
{
    irq_handler(((NRF_TIMER_Type *) 0x4000A000UL), &m_cb[NRFX_TIMER2_INST_IDX],
        4);
}
...
void TIMER3_IRQHandler(void)
{
    irq_handler(((NRF_TIMER_Type *) 0x4001A000UL), &m_cb[NRFX_TIMER3_INST_IDX],
        6);
}
...
void TIMER4_IRQHandler(void)
{
    irq_handler(((NRF_TIMER_Type *) 0x4001B000UL), &m_cb[NRFX_TIMER4_INST_IDX],
        6);
}
