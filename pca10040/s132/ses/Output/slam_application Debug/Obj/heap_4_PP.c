...
# 38 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c" 2
...
# 99 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c" 3 4
                                   0
# 99 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"
                                       ;
  ...
  if( ( xWantedSize & xBlockAllocatedBit ) == 0 )
  {
   ...
   if( xWantedSize > 0 )
   {
    ...
    if( ( xWantedSize & ( 0x0007 ) ) != 0x00 )
    {
     ...
     if (1) { if (( xWantedSize & ( 0x0007 ) ) == 0) { } else { assert_nrf_callback((uint16_t)150, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"); } };
    }
    else
    {
     ;
...
# 168 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"
    ...
    if( pxBlock != pxEnd )
    {
     ...
     if( ( pxBlock->xBlockSize - xWantedSize ) > ( ( size_t ) ( xHeapStructSize << 1 ) ) )
     {
      ...
      if (1) { if (( ( ( size_t ) pxNewBlockLink ) & ( 0x0007 ) ) == 0) { } else { assert_nrf_callback((uint16_t)195, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"); } };
...
# 224 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"
 ...
 ( void ) xTaskResumeAll();
# 259 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"
 if (1) { if (( ( ( size_t ) pvReturn ) & ( size_t ) ( 0x0007 ) ) == 0) { } else { assert_nrf_callback((uint16_t)259, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"); } };
 return pvReturn;
}
...
# 269 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"
               )
 {
  ...
  if (1) { if (( pxLink->xBlockSize & xBlockAllocatedBit ) != 0) { } else { assert_nrf_callback((uint16_t)279, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"); } };
  if (1) { if (pxLink->pxNextFreeBlock == 
# 280 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c" 3 4
 0
# 280 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"
 ) { } else { assert_nrf_callback((uint16_t)280, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_4.c"); } };
