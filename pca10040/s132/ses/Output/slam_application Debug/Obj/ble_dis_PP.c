...
# 45 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c" 2

# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.h" 1
...
# 61 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.h" 2
# 74 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.h"
typedef struct
{
...
{
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_sys_id != 
# 77 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c" 3 4
   0
# 77 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
   ); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 77, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_encoded_buffer != 
# 78 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c" 3 4
   0
# 78 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
   ); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 78, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"); } while (0); } } while (0);
...
static void pnp_id_encode(uint8_t * p_encoded_buffer, ble_dis_pnp_id_t const * p_pnp_id)
{
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_pnp_id != 
# 101 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c" 3 4
   0
# 101 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
   ); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 101, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_encoded_buffer != 
# 102 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c" 3 4
   0
# 102 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
   ); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 102, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (len == 7); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 110, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"); } while (0); } } while (0);
}
# 124 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
                         ...
                         ble_gatts_char_handles_t * p_handles)
{
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_char_value != 
# 135 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c" 3 4
   0
# 135 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
   ); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 135, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (char_len > 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 136, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"); } while (0); } } while (0);
...
# 259 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
    ...
    if (p_dis_init->p_reg_cert_data_list != 
# 274 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c" 3 4
                                           0
# 274 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
                                               )
