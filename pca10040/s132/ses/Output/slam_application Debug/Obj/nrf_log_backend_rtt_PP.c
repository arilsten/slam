...
# 53 "../../../../../../components/libraries/experimental_log/nrf_log_backend_rtt.h" 2
...
# 1 "../../../systemView/SEGGER_RTT_Conf.h" 1
# 71 "../../../systemView/SEGGER_RTT.h" 2
# 90 "../../../systemView/SEGGER_RTT.h"
...
# 91 "../../../systemView/SEGGER_RTT.h" 2
# 110 "../../../systemView/SEGGER_RTT.h"
...
static void nrf_log_backend_rtt_put(nrf_log_backend_t const * p_backend,
                               nrf_log_entry_t * p_msg)
{
    nrf_log_backend_serial_put(p_backend, p_msg, m_string_buff, 64, serial_tx);
}
