...
# 325 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.h" 3 4
   0
# 325 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.h"
   ) { } else { assert_nrf_callback((uint16_t)325, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.h"); } };
...
# 341 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.h" 3 4
   0
# 341 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.h"
   ) { } else { assert_nrf_callback((uint16_t)341, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.h"); } };
...
# 57 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c" 2
# 70 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
extern nrf_balloc_t * __start_nrf_balloc; extern void * __stop_nrf_balloc;
# 230 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
...
# 253 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
    ...
    if (1) { if (p_pool->p_cb) { } else { assert_nrf_callback((uint16_t)255, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
    if (1) { if (p_pool->p_stack_base) { } else { assert_nrf_callback((uint16_t)256, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
    if (1) { if (p_pool->p_stack_limit) { } else { assert_nrf_callback((uint16_t)257, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
    if (1) { if (p_pool->p_memory_begin) { } else { assert_nrf_callback((uint16_t)258, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
    if (1) { if (p_pool->block_size) { } else { assert_nrf_callback((uint16_t)259, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };

    pool_size = p_pool->p_stack_limit - p_pool->p_stack_base;
# 274 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_INFO) | (p_pool->p_log)->module_id << 16), "Initialized (size: %u x %u = %u bytes)", (uint32_t)(pool_size), (uint32_t)(p_pool->block_size), (uint32_t)(pool_size * p_pool->block_size)); } }
...
# 292 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c" 3 4
   0
# 292 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
   ) { } else { assert_nrf_callback((uint16_t)292, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
...
# 320 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (p_pool->p_log)->module_id << 16), "Allocating element: 0x%08X", (uint32_t)(p_block)); } };
...
# 328 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (p_pool->p_log)->module_id << 16), "Freeing element: 0x%08X", (uint32_t)(p_element)); } };
# 359 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
