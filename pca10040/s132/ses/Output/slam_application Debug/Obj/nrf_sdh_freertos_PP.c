...
# 72 "../../../../../../components/libraries/util/sdk_errors.h"
...
# 73 "../../../../../../components/libraries/util/sdk_errors.h" 2
...
# 44 "../../../../../../components/libraries/experimental_section_vars/nrf_section_iter.h"
...
# 45 "../../../../../../components/libraries/experimental_section_vars/nrf_section_iter.h" 2
...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_sdh_freertos_logs_data_dynamic;
...
# 52 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_freertos.c" 2
const nrf_log_module_const_data_t m_nrf_log_nrf_sdh_freertos_logs_data_const __attribute__ ((section("." "log_const_data_nrf_sdh_freertos"))) __attribute__((used)) = { .p_module_name = "nrf_sdh_freertos", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(3), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_nrf_sdh_freertos_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_nrf_sdh_freertos"))) __attribute__((used));
...
void (SWI2_EGU2_IRQHandler)(void)
{
     ...
     {
         if ( (xYieldRequired) != ( ( BaseType_t ) 0 ) ) do { ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICSR = (1UL << 28U); __SEV(); __DSB(); __ISB(); }while (0);
     }
}
...
{
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_freertos_logs_data_dynamic.module_id << 16), "Enter softdevice_task."); } };

    if (m_task_hook != 
# 79 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_freertos.c" 3 4
                      0
# 79 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_freertos.c"
                          )
    {
...
{
    if (1 && (3 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_nrf_sdh_freertos_logs_data_dynamic.module_id << 16), "Creating a SoftDevice task."); } };
    ...
    BaseType_t xReturned = xTaskCreate(softdevice_task,
                                       ...
                                       2,
                                       &m_softdevice_task);
    if (xReturned != ( ( ( BaseType_t ) 1 ) ))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_nrf_sdh_freertos_logs_data_dynamic.module_id << 16), "SoftDevice task not created."); } };
        do { app_error_handler((((0x0) + 4)), 107, (uint8_t*) "C:\\nRF5_SDK_15.0.0_a53641a\\components\\softdevice\\common\\nrf_sdh_freertos.c"); } while (0);
    }
}
