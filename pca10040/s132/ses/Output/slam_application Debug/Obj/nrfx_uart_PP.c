...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_UART_logs_data_dynamic;
...
const nrf_log_module_const_data_t m_nrf_log_UART_logs_data_const __attribute__ ((section("." "log_const_data_UART"))) __attribute__((used)) = { .p_module_name = "UART", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_UART_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_UART"))) __attribute__((used));
# 55 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c" 2
# 63 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
typedef struct
{
                         ...
                         nrfx_uart_config_t const * p_config)
{
    ...
    {
        if (p_config->pselcts != 0xFFFFFFFF)
        {
            nrf_gpio_cfg_input(p_config->pselcts, NRF_GPIO_PIN_NOPULL);
        }
        if (p_config->pselrts != 0xFFFFFFFF)
        {
                              ...
                              uint8_t interrupt_priority)
{
    ...
    _NRFX_IRQ_PRIORITY_SET(nrfx_get_irq_number((void *)p_instance->p_reg), interrupt_priority)
                                             ;
    _NRFX_IRQ_ENABLE(nrfx_get_irq_number((void *)p_instance->p_reg));
}
...
static void interrupts_disable(nrfx_uart_t const * p_instance)
{
    nrf_uart_int_disable(p_instance->p_reg, NRF_UART_INT_MASK_RXDRDY |
                                            ...
                                            NRF_UART_INT_MASK_RXTO);
    _NRFX_IRQ_DISABLE(nrfx_get_irq_number((void *)p_instance->p_reg));
}
...
nrfx_err_t nrfx_uart_init(nrfx_uart_t const * p_instance,
                          ...
                          nrfx_uart_event_handler_t event_handler)
{
    if (1) { if (p_config) { } else { assert_nrf_callback((uint16_t)170, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
# 240 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
                       ;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "Instance uninitialized: %d.", (uint32_t)(p_instance->drv_inst_idx)); } };
}
...
# 252 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c" 3 4
      _Bool 
# 252 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
           tx_blocking(NRF_UART_Type * p_uart, uart_control_block_t * p_cb)
{
...
{
    uart_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)277, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    if (1) { if (p_data) { } else { assert_nrf_callback((uint16_t)278, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    if (1) { if (length > 0) { } else { assert_nrf_callback((uint16_t)279, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
...
# 294 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "Transfer tx_len: %d.", (uint32_t)(p_cb->tx_buffer_length)); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "Tx data:"); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_hexdump((((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_UART_logs_data_dynamic.module_id << 16)), ((p_cb->p_tx_buffer)), ((p_cb->tx_buffer_length * sizeof(p_cb->p_tx_buffer[0])))); } }
                                                                                 ;
...
# 308 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}
                        ...
                        size_t length)
{
    ...
    if (1) { if (m_cb[p_instance->drv_inst_idx].state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)361, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    if (1) { if (p_data) { } else { assert_nrf_callback((uint16_t)362, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    if (1) { if (length > 0) { } else { assert_nrf_callback((uint16_t)363, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
...
# 389 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "Transfer rx_len: %d.", (uint32_t)(length)); } };
...
void nrfx_uart_rx_enable(nrfx_uart_t const * p_instance)
{
    ...
    {
        rx_enable(p_instance);
        m_cb[p_instance->drv_inst_idx].rx_enabled = 
# 484 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c" 3 4
                                                   1
# 484 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
                                                       ;
...
# 531 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "TX transaction aborted."); } };
}
...
void nrfx_uart_rx_abort(nrfx_uart_t const * p_instance)
{
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "RX transaction aborted."); } };
}
                             ...
                             uart_control_block_t * p_cb)
{
        ...
        nrf_uart_event_check(p_uart, NRF_UART_EVENT_ERROR))
    {
        ...
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | m_nrf_log_UART_logs_data_dynamic.module_id << 16), "Event: %s.", (uint32_t)((NRF_UART_EVENT_ERROR == NRF_UART_EVENT_ERROR ? "NRF_UART_EVENT_ERROR" : "UNKNOWN EVENT"))); } };
...
void nrfx_uart_0_irq_handler(void)
{
    uart_irq_handler(((NRF_UART_Type *) 0x40002000UL), &m_cb[NRFX_UART0_INST_IDX]);
}
