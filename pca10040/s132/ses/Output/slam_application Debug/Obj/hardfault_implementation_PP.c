...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c" 2

# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault.h" 1
...
extern nrf_log_module_reduced_dynamic_data_t m_nrf_log_hardfault_logs_data_dynamic;
...
# 216 "../../../../../../components/libraries/experimental_log/nrf_log_ctrl.h"
                                                     dynamic);
# 52 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c" 2
const nrf_log_module_const_data_t m_nrf_log_hardfault_logs_data_const __attribute__ ((section("." "log_const_data_hardfault"))) __attribute__((used)) = { .p_module_name = "hardfault", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(3), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_reduced_dynamic_data_t m_nrf_log_hardfault_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_hardfault"))) __attribute__((used));
# 61 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c"
volatile HardFault_stack_t * HardFault_p_stack;



__attribute__((weak)) void HardFault_process(HardFault_stack_t * p_stack)
{
...
# 88 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c"
    ...
    static const char *cfsr_msgs[] = {
        ...
        [2] = 
# 92 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c" 3 4
              0
# 92 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c"
                  ,
...
# 113 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c"
    ...
    uint32_t cfsr = ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CFSR;


    if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_hardfault_logs_data_dynamic.module_id << 16), "HARD FAULT at 0x%08X", (uint32_t)(p_stack->pc)); } };
    if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_4(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_hardfault_logs_data_dynamic.module_id << 16), "  R0:  0x%08X  R1:  0x%08X  R2:  0x%08X  R3:  0x%08X", (uint32_t)(p_stack->r0), (uint32_t)(p_stack->r1), (uint32_t)(p_stack->r2), (uint32_t)(p_stack->r3)); } }
                                                                            ;
    if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_hardfault_logs_data_dynamic.module_id << 16), "  R12: 0x%08X  LR:  0x%08X  PSR: 0x%08X", (uint32_t)(p_stack->r12), (uint32_t)(p_stack->lr), (uint32_t)(p_stack->psr)); } }
                                                                 ;

    if (((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->HFSR & (1UL << 1U))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_hardfault_logs_data_dynamic.module_id << 16), "Cause: BusFault on a vector table read during exception processing."); } };
    }

    for (uint32_t i = 0; i < sizeof(cfsr_msgs) / sizeof(cfsr_msgs[0]); i++)
    {
        if (((cfsr & (1 << i)) != 0) && (cfsr_msgs[i] != 
# 134 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c" 3 4
                                                        0
# 134 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\hardfault\\hardfault_implementation.c"
                                                            ))
        {
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_hardfault_logs_data_dynamic.module_id << 16), "Cause: %s.", (uint32_t)((uint32_t)cfsr_msgs[i])); } };
        }
    }

    if (cfsr & (1 << (0 + 7)))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_hardfault_logs_data_dynamic.module_id << 16), "MemManage Fault Address: 0x%08X", (uint32_t)(((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->MMFAR)); } };
    }

    if (cfsr & (1 << (8 + 7)))
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_hardfault_logs_data_dynamic.module_id << 16), "Bus Fault Address: 0x%08X", (uint32_t)(((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->BFAR)); } };
    }
