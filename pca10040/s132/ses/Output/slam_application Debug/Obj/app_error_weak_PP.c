...
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error_weak.c"
# 40 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error_weak.c"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error.h" 1
...
# 54 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error.h" 2
...
# 57 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error.h" 2
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\sdk_errors.h" 1
# 73 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\sdk_errors.h"
# 1 "../../../../../../components/softdevice/s132/headers/nrf_error.h" 1
# 74 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\sdk_errors.h" 2
# 158 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\sdk_errors.h"
typedef uint32_t ret_code_t;
# 58 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error.h" 2
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\nordic_common.h" 1
# 59 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error.h" 2
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error_weak.h" 1
...
# 41 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\util\\app_error_weak.c" 2
...
# 54 "../../../../../../components/softdevice/s132/headers/nrf_sdm.h"
...
__attribute__((weak)) void app_error_fault_handler(uint32_t id, uint32_t pc, uint32_t info)
{
    __disable_irq();
    ...
    switch (id)
    {
        ...
        case (0x00000000 + 1):
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "SOFTDEVICE: ASSERTION FAILED"); } };
            break;
        case (0x00001000 + 1):
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "SOFTDEVICE: INVALID MEMORY ACCESS"); } };
            break;

        case ((0x00004000) + 2):
        {
            assert_info_t * p_info = (assert_info_t *)info;
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "ASSERTION FAILED at %s:%u", (uint32_t)(p_info->p_file_name), (uint32_t)(p_info->line_num)); } }
        ...
        case ((0x00004000) + 1):
        {
            ...
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_5(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "ERROR %u [%s] at %s:%u\r\nPC at: 0x%08x", (uint32_t)(p_info->err_code), (uint32_t)(nrf_strerror_get(p_info->err_code)), (uint32_t)(p_info->p_file_name), (uint32_t)(p_info->line_num), (uint32_t)(pc)); } }




                             ;
             if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "End of error report"); } };
            break;
        }
        default:
            if (1 && (3 >= NRF_LOG_SEVERITY_ERROR) && (NRF_LOG_SEVERITY_ERROR <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_ERROR) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_ERROR) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "UNKNOWN FAULT at 0x%08X", (uint32_t)(pc)); } };
            break;
    }


    do { if (((CoreDebug_Type *) (0xE000EDF0UL))->DHCSR & (1UL )) { __asm__("BKPT 0");; } }while (0);
