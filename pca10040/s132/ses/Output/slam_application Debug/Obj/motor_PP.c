...
# 1 "<command-line>"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\drivers\\motor.c"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\drivers\\motor.h" 1
...
# 2 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\drivers\\motor.c" 2
...
# 35 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\drivers\\motor.c"
 ...
 nrfx_gpiote_out_init(1, &ina_config);
 nrfx_gpiote_out_init(0, &inb_config);

 app_pwm_config_t pwm1_cfg = { .pins = {2, 5}, .pin_polarity = {APP_PWM_POLARITY_ACTIVE_LOW, APP_PWM_POLARITY_ACTIVE_LOW}, .num_of_channels = 2, .period_us = 5000L };
...
void motor_forward(int duty) {
 ...
 nrfx_gpiote_out_clear(4);
 nrfx_gpiote_out_set(1);
 nrfx_gpiote_out_clear(0);
 duty = SATURATE_DUTY(duty);
 while (app_pwm_channel_duty_set(&PWM1, 0, duty) == ((0x0) + 17));
...
void motor_backward(int duty) {
 nrfx_gpiote_out_clear(3);
 nrfx_gpiote_out_set(4);
 nrfx_gpiote_out_clear(1);
...
void motor_stop() {
 ...
 while (app_pwm_channel_duty_set(&PWM1, 1, 0) == ((0x0) + 17));
}
