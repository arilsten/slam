...
# 1 "<command-line>"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\drivers\\microsd.c"
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\drivers\\microsd.h" 1
...
# 18 "../../../../../../external/fatfs/src/integer.h"
typedef int INT;
...
# 29 "../../../../../../external/fatfs/src/ff.h" 2
# 1 "../../../../../../external/fatfs/src/ffconf.h" 1
# 30 "../../../../../../external/fatfs/src/ff.h" 2
# 69 "../../../../../../external/fatfs/src/ff.h"
typedef char TCHAR;
# 85 "../../../../../../external/fatfs/src/ff.h"
...
typedef struct {
 ...
 WORD n_rootdir;
 WORD csize;
# 114 "../../../../../../external/fatfs/src/ff.h"
 DWORD last_clst;
 DWORD free_clst;
# 125 "../../../../../../external/fatfs/src/ff.h"
 DWORD n_fatent;
 DWORD fsize;
 DWORD volbase;
 DWORD fatbase;
...
# 16 "../../../../../../external/fatfs/src/diskio.h"
...
# 45 "../../../../../../external/fatfs/port/diskio_blkdev.h" 2
# 1 "../../../../../../components/libraries/block_dev/nrf_block_dev.h" 1
# 47 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
...
# 48 "../../../../../../components/libraries/block_dev/nrf_block_dev.h" 2
# 1 "../../../../../../components/libraries/util/nrf_assert.h" 1
# 49 "../../../../../../components/libraries/block_dev/nrf_block_dev.h" 2
# 65 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
typedef struct {
    uint32_t blk_id;
    uint32_t blk_count;
    void * p_buff;
} nrf_block_req_t;
# 92 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
typedef enum {
...
# 165 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
typedef enum {
    NRF_BLOCK_DEV_IOCTL_REQ_CACHE_FLUSH = 0,
    NRF_BLOCK_DEV_IOCTL_REQ_INFO_STRINGS,
} nrf_block_dev_ioctl_req_t;
# 182 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
...
# 236 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
static inline ret_code_t nrf_blk_dev_init(nrf_block_dev_t const * p_blk_dev,
                                          nrf_block_dev_ev_handler ev_handler,
                                          void const * p_context)
{
    if (1) { if (p_blk_dev->p_ops->init) { } else { assert_nrf_callback((uint16_t)240, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
    return p_blk_dev->p_ops->init(p_blk_dev, ev_handler, p_context);
}
# 251 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
static inline ret_code_t nrf_blk_dev_uninit(nrf_block_dev_t const * p_blk_dev)
{
    if (1) { if (p_blk_dev->p_ops->uninit) { } else { assert_nrf_callback((uint16_t)253, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
    return p_blk_dev->p_ops->uninit(p_blk_dev);
}
# 271 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
static inline ret_code_t nrf_blk_dev_read_req(nrf_block_dev_t const * p_blk_dev,
                                              nrf_block_req_t const * p_blk)
{
    if (1) { if (p_blk_dev->p_ops->read_req) { } else { assert_nrf_callback((uint16_t)274, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
    if (1) { if (p_blk_dev->p_ops->geometry) { } else { assert_nrf_callback((uint16_t)275, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
...
# 299 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
static inline ret_code_t nrf_blk_dev_write_req(nrf_block_dev_t const * p_blk_dev,
                                               nrf_block_req_t const * p_blk)
{
    if (1) { if (p_blk_dev->p_ops->write_req) { } else { assert_nrf_callback((uint16_t)302, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
    if (1) { if (p_blk_dev->p_ops->geometry) { } else { assert_nrf_callback((uint16_t)303, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
...
# 322 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
static inline ret_code_t nrf_blk_dev_ioctl(nrf_block_dev_t const * p_blk_dev,
                                           nrf_block_dev_ioctl_req_t req,
                                           void * p_data)
{
    if (1) { if (p_blk_dev->p_ops->ioctl) { } else { assert_nrf_callback((uint16_t)326, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
    return p_blk_dev->p_ops->ioctl(p_blk_dev, req, p_data);
}
# 337 "../../../../../../components/libraries/block_dev/nrf_block_dev.h"
static inline nrf_block_dev_geometry_t const *
nrf_blk_dev_geometry(nrf_block_dev_t const * p_blk_dev)
{
    if (1) { if (p_blk_dev->p_ops->geometry) { } else { assert_nrf_callback((uint16_t)340, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
    return p_blk_dev->p_ops->geometry(p_blk_dev);
}
# 46 "../../../../../../external/fatfs/port/diskio_blkdev.h" 2
# 63 "../../../../../../external/fatfs/port/diskio_blkdev.h"
typedef struct
{
    const nrf_block_dev_t * p_block_device;
...
typedef struct
{
    diskio_blkdev_config_t config;
    nrf_block_dev_result_t last_result;
    volatile DSTATUS state;
    volatile 
# 84 "../../../../../../external/fatfs/port/diskio_blkdev.h" 3 4
            _Bool 
# 84 "../../../../../../external/fatfs/port/diskio_blkdev.h"
                    busy;
} diskio_blkdev_t;
# 112 "../../../../../../external/fatfs/port/diskio_blkdev.h"
DSTATUS disk_initialize(BYTE drv);
# 123 "../../../../../../external/fatfs/port/diskio_blkdev.h"
DSTATUS disk_uninitialize(BYTE drv);
# 132 "../../../../../../external/fatfs/port/diskio_blkdev.h"
DSTATUS disk_status(BYTE drv);
# 144 "../../../../../../external/fatfs/port/diskio_blkdev.h"
DRESULT disk_read(BYTE drv, BYTE* buff, DWORD sector, UINT count);
# 156 "../../../../../../external/fatfs/port/diskio_blkdev.h"
DRESULT disk_write(BYTE drv, const BYTE* buff, DWORD sector, UINT count);
# 167 "../../../../../../external/fatfs/port/diskio_blkdev.h"
...
# 53 "../../../../../../components/libraries/sdcard/app_sdcard.h"
...
# 54 "../../../../../../components/libraries/sdcard/app_sdcard.h" 2
# 68 "../../../../../../components/libraries/sdcard/app_sdcard.h"
typedef enum {
    SDC_SUCCESS = 0,
...
# 148 "../../../../../../components/libraries/sdcard/app_sdcard.h"
ret_code_t app_sdc_init(app_sdc_config_t const * const p_config, sdc_event_handler_t event_handler);
# 158 "../../../../../../components/libraries/sdcard/app_sdcard.h"
ret_code_t app_sdc_uninit(void);
# 167 "../../../../../../components/libraries/sdcard/app_sdcard.h"

# 167 "../../../../../../components/libraries/sdcard/app_sdcard.h" 3 4
_Bool 
# 167 "../../../../../../components/libraries/sdcard/app_sdcard.h"
    app_sdc_busy_check(void);
# 182 "../../../../../../components/libraries/sdcard/app_sdcard.h"
ret_code_t app_sdc_block_read(uint8_t * p_buf, uint32_t block_address, uint16_t block_count);
# 197 "../../../../../../components/libraries/sdcard/app_sdcard.h"
...
# 58 "../../../../../../components/libraries/block_dev/sdc/nrf_block_dev_sdc.h" 2
...
# 90 "../../../../../../components/libraries/block_dev/sdc/nrf_block_dev_sdc.h"
typedef struct {
    uint32_t block_size;
...
# 127 "../../../../../../components/libraries/block_dev/sdc/nrf_block_dev_sdc.h"
...
# 47 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam\\drivers\\microsd.c"
    ...
    diskio_blockdev_register(drives, (sizeof(drives) / sizeof((drives)[0])));
    ...
    {
        failed =1;
        if (1 && (3 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "Disk initialization failed. %d", (uint32_t)(disk_state)); } };
        return;
    }
 ...
 uint32_t blocks_per_mb = (1024uL * 1024uL) / m_block_dev_sdc.block_dev.p_ops->geometry(&m_block_dev_sdc.block_dev)->blk_size;
    ...
    if (ff_result)
    { failed = 1;
        if (1 && (3 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "Mount failed."); } };
        return;
    }
    ...
    ff_result = f_open(&file, filename, 0x01 | 0x02 | 0x30);
    if (ff_result != FR_OK)
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "Unable to open or create file %s.", (uint32_t)(filename)); } };
        return;
    }
    ...
    if (ff_result != FR_OK)
    {
        if (1 && (3 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "Write failed\r\n."); } };
    }
    else
    {
